...
URL Source: https://www.palantir.com/docs/foundry/consumer-mode/client-credentials-setup/
...
OAuth clients are now created in Developer Console. Refer to the comprehensive [OAuth client](https://www.palantir.com/docs/foundry/developer-console/oauth-clients/) guide for more information.
...
For TypeScript applications, use the OSDK to generate a custom SDK library for your application. Refer to the [bootstrapping server-side TypeScript applications](https://www.palantir.com/docs/foundry/developer-console/how-to-bootstrapping-server-side-typescript/) guide for more information.
