...
URL Source: https://www.palantir.com/docs/foundry/code-workspaces/security/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workspaces/security/#security)Security
...
*   Data loaded in Code Workspaces is tracked by Foundry. Data downloads and uploads are restricted in Code Workspaces other than [methods governed by Foundry’s data governance and access controls](https://www.palantir.com/docs/foundry/code-workspaces/troubleshooting/#file-download-or-upload-errors).
...
## [](https://www.palantir.com/docs/foundry/code-workspaces/security/#restricted-outputs-mode)Restricted outputs mode

Restricted outputs mode provides enhanced safeguards when working with sensitive data. Restricted outputs mode is a "read-only" mode that restricts write operations and external source connections to ensure that data cannot be exported from the code workspace. In particular, it allows you to load [restricted views](https://www.palantir.com/docs/foundry/code-workspaces/data/#restricted-views) into a workspace.
...
*   **Disables telemetry collection and logs**, as well as data checkpoint uploads, while still preserving [code checkpoints](https://www.palantir.com/docs/foundry/code-workspaces/getting-started/#code-checkpoints).
...
As described in the documentation on [code checkpoints](https://www.palantir.com/docs/foundry/code-workspaces/getting-started/#code-checkpoints), it is your responsibility to ensure that code files you write while in restricted outputs mode do not contain data.
...
[← PREVIOUS Palantir-provided models](https://www.palantir.com/docs/foundry/code-workspaces/palantir-provided-models/)

[NEXT FAQ →](https://www.palantir.com/docs/foundry/code-workspaces/code-workspaces-faq/)
