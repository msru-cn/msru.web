...
URL Source: https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/
...
*   Reading and writing tabular datasets, [Iceberg tables](https://www.palantir.com/docs/foundry/iceberg/jupyter/), and [virtual tables](https://www.palantir.com/docs/foundry/data-integration/virtual-tables/).
...
Code Workspaces currently supports [Dash ↗](https://plotly.com/dash/) and [Streamlit ↗](https://streamlit.io/) for Python applications. Users can create applications directly in Code Workspaces with Foundry’s [version control](https://www.palantir.com/docs/foundry/data-integration/branching/), [branching](https://www.palantir.com/docs/foundry/data-integration/branching/), and [data governance](https://www.palantir.com/docs/foundry/security/data-protection-and-governance/) features built-in.

Code Workspace applications support branching. If you [create a new Workspace branch](https://www.palantir.com/docs/foundry/code-workspaces/getting-started/#branch-your-code-workspace), publishing a new application or synchronizing the changes will publish a new version of the application on that branch. This allows you to preview your application before exposing it to your users. To publish on the master branch, simply merge your branch into master.

![Image 1: JupyterLab® with TensorBoard™](https://www.palantir.com/docs/resources/foundry/code-workspaces/jupyterlab-with-tensor.png)
...
3.   _Optional:_ Configure advanced settings. By default, the application settings will match the settings of the Jupyter® workspace.
...
You can ensure the conda/PyPI environment in your JupyterLab® workspace will be automatically restored in your published Dash application using [managed conda/PyPI environments in Jupyter® Notebooks](https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/#managed-condapypi-environments-in-jupyter-notebooks).
...
2.   _Optional:_ Configure advanced settings. By default, the application settings will match the settings of the JupyterLab® workspace.
...
You can ensure the conda/PyPI environment in your JupyterLab® workspace will be automatically restored in your published Streamlit application using [managed conda/PyPI environments in Jupyter® Notebooks](https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/#managed-condapypi-environments-in-jupyter-notebooks).
...
![Image 2: JupyterLab® with TensorBoard™](https://www.palantir.com/docs/resources/foundry/code-workspaces/jupyterlab-with-tensor.png)
...
![Image 3: The blue build button to the right of the dataset name.](https://www.palantir.com/docs/resources/foundry/code-workspaces/create-notebook-transform.png?width=500)

1.   Follow the interface to configure your transform. Code Workspaces will infer the Jupyter® notebook used along with the inputs added to produce the output dataset. If the inference is wrong, you can manually edit the inputs and outputs.

![Image 4: The Edit Transform panel with options to modify the script file, inputs, and outputs and adjust the CPU and Memory.](https://www.palantir.com/docs/resources/foundry/code-workspaces/notebook-transform-configuration.png?width=300)
...
Once CI checks are completed, your transform is ready for build. You can use other Foundry [data integration](https://www.palantir.com/docs/foundry/data-integration/overview/) tools to manage your transform and the [data pipeline](https://www.palantir.com/docs/foundry/data-integration/data-pipeline/) to which it belongs.

The transform does not automatically use the environment of the Code Workspace. You should install all the libraries needed at runtime at the top of the script file. The code snippet to install a library can be found in the **Libraries** panel. For example, to use `scikit-learn` and `scikit-image` in your transform, add this code snippet to the top of the file:

Copied!

`1!mamba install -y -q scikit-learn scikit-image`

## Managed conda/PyPI environments in Jupyter® Notebooks

Jupyter® conda/PyPI environments can be consistently restored across Jupyter® workspaces, applications, transforms, and model outputs, using the managed environment feature backed by Maestro. Maestro is a Foundry library management tool that lets you install and manage libraries for Jupyter workspaces. It integrates with conda and pip, making library installation easier and helping maintain consistent environments. To convert commands to Maestro, refer to the instructions below for either [conda](https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/#manage-conda-libraries-with-maestro) or [PyPI](https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/#manage-pypi-libraries-with-maestro).
...
1.   `/home/user/repo/.envs/maestro/meta.yaml`: Known as the environment **manifest**, it contains the set of **requested** libraries and versions for your environment. [Learn more about the meta.yaml file](https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/#example-metayaml-file).
2.   `/home/user/repo/.envs/maestro/hawk.lock` - Known as the environment **lock file**, it contains the set of **resolved** libraries and versions for your environment, solved from the constraints specified in the manifest. The `hawk.lock` file replaces `conda.lock`, which has been deprecated. [Learn more about the `hawk.lock` file](https://www.palantir.com/docs/foundry/code-workspaces/jupyterlab/#example-hawklock-file).
...
![Image 5: Dialogue for the managed conda environments advanced feature](https://www.palantir.com/docs/resources/foundry/code-workspaces/managed-conda-toggle-advanced.png?width=500)

Once the feature is enabled, a managed environment named `default` will be available for you to use:

![Image 6: Notebook file launchers using managed environment with name default](https://www.palantir.com/docs/resources/foundry/code-workspaces/managed-default-environment.png?width=500)
...
`1maestro env conda install <library_name>` 
To install a specific version, run the following command:

Copied!

`1maestro env conda install <library_name>==<library_version>` 
*   **Uninstall using the terminal:** To uninstall a library, run the following command in the terminal:

Copied!

`1maestro env uninstall --conda-dependencies <library_names>` 
...
`1maestro env pip install <library_name>` 
To install a specific version, run the following command:

Copied!

`1maestro env pip install <library_name>==<library_version>` 
*   **Uninstall using the terminal:** To uninstall a library, run the following command in the terminal:

Copied!

`1maestro env uninstall --pip-dependencies <library_names>` 
...
![Image 7: List of installed libraries displayed in the Libraries tab](https://www.palantir.com/docs/resources/foundry/code-workspaces/installed-libraries-tab.png?width=500)
...
![Image 8: Dropdown menu in Jupyter interface to show hidden files](https://www.palantir.com/docs/resources/foundry/code-workspaces/managed-conda-show-hidden-file.png?width=500)
...
7    - ipykernel
8    - pip
9    - foundry-transforms-lib-python
10    - pandas
11    - polars
12    - dash
13    - streamlit
...
_TensorBoard and any related marks are trademarks of Google Inc._
