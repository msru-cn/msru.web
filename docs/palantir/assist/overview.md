...
*   **AIP Chatbots:** User-developed, interactive LLM-powered assistants equipped with enterprise-specific information. Refer to [AIP Chatbots in Assist](https://www.palantir.com/docs/foundry/assist/agents-in-aip-assist/) for more information.
...
Refer to [registering custom content sources with AIP Assist](https://www.palantir.com/docs/foundry/assist/aip-assist-registering-content/) for more information.
