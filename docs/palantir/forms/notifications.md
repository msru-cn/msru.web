...
URL Source: https://www.palantir.com/docs/foundry/forms/notifications/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/forms/notifications/#receive-notifications)Receive notifications
...
![Image 2: Open details pane to see followers](https://www.palantir.com/docs/resources/foundry/forms/form-details-followers.png)

3.   Toggle **Subscribe** to receive notifications when updates are made.

When a form receives responses, any user with the correct [permissions](https://www.palantir.com/docs/foundry/forms/permissions/) can access the resulting data within the platform.

[← PREVIOUS Configure forms / Generate primary key](https://www.palantir.com/docs/foundry/forms/generate-primary-key/)

[NEXT Share with other users →](https://www.palantir.com/docs/foundry/forms/share-form/)
