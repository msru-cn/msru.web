...
URL Source: https://www.palantir.com/docs/foundry/forms/faqs/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/forms/faqs/#faqs)FAQs

This page discusses some common questions and debugging steps that may be helpful to reference when using Foundry Forms.

## [](https://www.palantir.com/docs/foundry/forms/faqs/#what-can-i-use-instead-of-foundry-forms)What can I use instead of Foundry Forms?
...
## [](https://www.palantir.com/docs/foundry/forms/faqs/#how-do-i-store-multiple-values)How do I store multiple values?
...
## [](https://www.palantir.com/docs/foundry/forms/faqs/#how-do-i-transform-multiple-values-into-multiple-rows-in-the-destination-dataset)How do I transform multiple values into multiple rows in the destination dataset
...
## [](https://www.palantir.com/docs/foundry/forms/faqs/#how-do-i-produce-a-field-that-is-the-concatenation-of-other-fields)How do I produce a field that is the concatenation of other fields?
...
## [](https://www.palantir.com/docs/foundry/forms/faqs/#how-do-i-debug-a-failing-submission)How do I debug a failing submission?
...
## [](https://www.palantir.com/docs/foundry/forms/faqs/#are-mobile-submissions-supported)Are mobile submissions supported?
...
[← PREVIOUS Integrate with other applications](https://www.palantir.com/docs/foundry/forms/integrate/)

[NEXT Connectivity: SQL & BI / Overview →](https://www.palantir.com/docs/foundry/analytics-connectivity/overview/)
