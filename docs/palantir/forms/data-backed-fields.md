...
URL Source: https://www.palantir.com/docs/foundry/forms/data-backed-fields/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#data-backed-fields)Data-backed fields
...
## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#user-dropdown)User dropdown
...
*   Use the [Code Editor](https://www.palantir.com/docs/foundry/forms/code-editor/) to set `onlyUsersInGroupIds: list<string>`.

## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#object-dropdown)Object dropdown
...
*   Set a `Placeholder`.
*   Use the [Code Editor](https://www.palantir.com/docs/foundry/forms/code-editor/) to set `noResultsText: string` and `displayedProperties: list<string>`.

To be filtered on, properties must be configured with the render hint "Low cardinality" in the Ontology.

## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#object-property-dropdown)Object property dropdown
...
## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#dataset-value-dropdown)Dataset value dropdown
...
To use this field, the dataset must be [indexed into Lime](https://www.palantir.com/docs/foundry/fusion/index-datasets/).

## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#objects-provider)Objects provider
...
*   Use the [Code Editor](https://www.palantir.com/docs/foundry/forms/code-editor/) to set `maxObjects: integer`.

## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#object-property-display)Object property display
...
## [](https://www.palantir.com/docs/foundry/forms/data-backed-fields/#user-properties)User properties
...
[← PREVIOUS Simple fields](https://www.palantir.com/docs/foundry/forms/simple-fields/)

[NEXT Auto-populating fields →](https://www.palantir.com/docs/foundry/forms/auto-populating-fields/)
