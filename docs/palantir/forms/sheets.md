...
URL Source: https://www.palantir.com/docs/foundry/forms/sheets/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/forms/sheets/#sheets)Sheets
...
**Sheets** are wrappers around one or more fields. Each form includes one main sheet plus an optional number of **subsheets**. Like fields, sheets can be affected by [transforms](https://www.palantir.com/docs/foundry/forms/transforms/), offering a convenient way to show, hide, or disable all fields within the sheet at once.
...
*   Configure [multiplicity](https://www.palantir.com/docs/foundry/forms/multiplicity/).
...
[← PREVIOUS Create a form](https://www.palantir.com/docs/foundry/forms/create-a-form/)

[NEXT Simple fields →](https://www.palantir.com/docs/foundry/forms/simple-fields/)
