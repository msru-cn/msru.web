...
URL Source: https://www.palantir.com/docs/foundry/forms/review-edit-responses/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/forms/review-edit-responses/#review-and-edit-responses)Review and edit responses
...
Users who follow a form will receive a [notification](https://www.palantir.com/docs/foundry/forms/notifications/) after each submission. From there, users can review and edit responses by opening the form `results` spreadsheet.

To view and edit responses stored in Fusion spreadsheets, perform the following steps:

1.   First, navigate to the form in Editor mode.
2.   Select the **View entries** button to the left of the green **Save** button in the upper right of the screen.

*   Alternatively, open the corresponding form `results` spreadsheet directly in Fusion.

1.   Select a cell within a response.
2.   Select the **Forms** tab at the top and choose **Open row**. Edits can now be made for this specific response.
3.   Select the green **Save changes** button in the bottom right.

[← PREVIOUS Share with other users](https://www.palantir.com/docs/foundry/forms/share-form/)

[NEXT Integrate with other applications →](https://www.palantir.com/docs/foundry/forms/integrate/)
