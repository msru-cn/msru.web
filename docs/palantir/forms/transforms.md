...
URL Source: https://www.palantir.com/docs/foundry/forms/transforms/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/forms/transforms/#transforms)Transforms
...
## [](https://www.palantir.com/docs/foundry/forms/transforms/#hide-field)Hide field
...
### [](https://www.palantir.com/docs/foundry/forms/transforms/#example)Example

`Hide Field B if Field A has value X.`

## [](https://www.palantir.com/docs/foundry/forms/transforms/#show-field)Show field
...
### [](https://www.palantir.com/docs/foundry/forms/transforms/#example-1)Example

`Show Field B if Field A has value X.`

## [](https://www.palantir.com/docs/foundry/forms/transforms/#disable-field)Disable field
...
### [](https://www.palantir.com/docs/foundry/forms/transforms/#example-2)Example

`Disable Field B if Field A has value X.`

## [](https://www.palantir.com/docs/foundry/forms/transforms/#update-configuration)Update configuration

The `update configuration` transform allows users to update the configuration of a field based on the values of other fields. Almost all options can be changed, excluding those that must remain constant, including`tag`, `uri`, `defaultValue`, `transforms` themselves, and options available in [Attachments](https://www.palantir.com/docs/foundry/forms/attachments-field/) fields.

### [](https://www.palantir.com/docs/foundry/forms/transforms/#example-3)Example

`Add [required validator] to Field B if Field A has value X.`

## [](https://www.palantir.com/docs/foundry/forms/transforms/#change-field-type)Change field type

The `change field type` transform allows users to change the type of a field based on the values of other fields.

### [](https://www.palantir.com/docs/foundry/forms/transforms/#example-4)Example

`Change type of Field B to [Text Area] if Field A has value X.`

## [](https://www.palantir.com/docs/foundry/forms/transforms/#add-transforms)Add transforms
...
![Image 3: Select transform type from menu.](https://www.palantir.com/docs/resources/foundry/forms/transform-types-menu.png?width=200)
...
![Image 4: Configure transform condition.](https://www.palantir.com/docs/resources/foundry/forms/configure-transform.png?width=300)
5.   If using an **update configuration** or **change field type** transform, define the outcome.

6.   Select the green **Save** button.

## [](https://www.palantir.com/docs/foundry/forms/transforms/#create-complex-conditions)Create complex conditions
...
### [](https://www.palantir.com/docs/foundry/forms/transforms/#example-5)Example

`Show Field C if Field A has value X and Field B does not have value Y.`

## [](https://www.palantir.com/docs/foundry/forms/transforms/#define-multiple-transforms)Define multiple transforms
...
### [](https://www.palantir.com/docs/foundry/forms/transforms/#example-6)Example
...
[← PREVIOUS Validators](https://www.palantir.com/docs/foundry/forms/validators/)

[NEXT Multiplicity →](https://www.palantir.com/docs/foundry/forms/multiplicity/)
