...
URL Source: https://www.palantir.com/docs/foundry/forms/attachments-field/

Published Time: Thu, 09 Jul 2026 17:47:54 GMT

# [](https://www.palantir.com/docs/foundry/forms/attachments-field/#attachments-field)Attachments field
...
![Image 3: Form attachments field](https://www.palantir.com/docs/resources/foundry/forms/attachments.png)

![Image 4: Configure attachments field](https://www.palantir.com/docs/resources/foundry/forms/attachments-config.png)
...
`Destination folder` and `Upload mode` cannot be affected by an [update configuration transform](https://www.palantir.com/docs/foundry/forms/transforms/#update-configuration).

[← PREVIOUS Auto-populating fields](https://www.palantir.com/docs/foundry/forms/auto-populating-fields/)

[NEXT Code Editor →](https://www.palantir.com/docs/foundry/forms/code-editor/)
