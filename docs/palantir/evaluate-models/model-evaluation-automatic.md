...
URL Source: https://www.palantir.com/docs/foundry/evaluate-models/model-evaluation-automatic/
...
![Image 1: Setting up managed metric pipelines diagram](https://www.palantir.com/docs/resources/foundry/evaluate-models/info_evaluation-datasets.png)
...
![Image 2: Configure inference and metrics generation](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_inference-metrics-generation.png)
...
![Image 3: add evaluation dataset](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-add-evaluation-ds.png)

The evaluation dataset and the objective itself are required to be in the same Foundry Project as the inference and metrics destinations, or they should be [added to the Foundry Project as a reference](https://www.palantir.com/docs/foundry/contour/project-references/#referencing-a-resource).
...
If you have configured your modeling objective to generate metrics and inference pipelines, the next step is to configure an **evaluation library**. An evaluation library is a published Python package in Foundry that produces a model evaluator. Foundry comes with default model evaluators for [binary classification](https://www.palantir.com/docs/foundry/evaluate-models/evaluator-binary-classification/) and [regression](https://www.palantir.com/docs/foundry/evaluate-models/evaluator-regression/), and also allows you to build a [custom model evaluator](https://www.palantir.com/docs/foundry/evaluate-models/evaluator-custom/). Evaluation libraries are used to measure model performance, model fairness, model robustness, and other metrics.

When configured, an evaluation library will generate one dataset containing a [metric set](https://www.palantir.com/docs/foundry/evaluate-models/metric-sets-reference/) for every configured inference dataset.

![Image 4: Add evaluation library](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-configure-evaluation-libary.png)
...
![Image 5: Add expected model output](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-add-expected-model-output.png)

![Image 6: Configure expected model output](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-configure-expected-model-output.png)
...
![Image 7: add evaluation subset](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-add-evaluation-subset.png)
...
![Image 8: add evaluation subset](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-add-evaluation-subset.png)
...
![Image 9: Add evaluation subset](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-add-multifield-subsets.png)
...
![Image 10: Review evaluation subset](https://www.palantir.com/docs/resources/foundry/evaluate-models/howto_howto-review-evaluation-subset-preview.png)
