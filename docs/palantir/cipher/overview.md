...
URL Source: https://www.palantir.com/docs/foundry/cipher/overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/cipher/overview/#cipher)Cipher
...
*   [Cipher Channels](https://www.palantir.com/docs/foundry/cipher/core-concepts/#channels) reliably manage cryptographic algorithms and keys.
*   [Cipher Licenses](https://www.palantir.com/docs/foundry/cipher/core-concepts/#licenses) allow users to control permissions and apply cryptographic operations to workflows (e.g. bulk encrypt columns of a dataset, decrypt individual values in [Object Explorer](https://www.palantir.com/docs/foundry/object-explorer/overview/), and so on).
...
![Image 2: Workflow of a decryption request with Cipher](https://www.palantir.com/docs/resources/foundry/cipher/decryption_request.gif)

[← PREVIOUS Checkpoints / Add checkpoint configurations to a Marketplace product](https://www.palantir.com/docs/foundry/checkpoints/checkpoints-marketplace/)

[NEXT Core concepts →](https://www.palantir.com/docs/foundry/cipher/core-concepts/)
