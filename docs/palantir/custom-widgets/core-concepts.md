...
URL Source: https://www.palantir.com/docs/foundry/custom-widgets/core-concepts/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/custom-widgets/core-concepts/#core-concepts)Core concepts

### [](https://www.palantir.com/docs/foundry/custom-widgets/core-concepts/#widget-set)Widget set
...
### [](https://www.palantir.com/docs/foundry/custom-widgets/core-concepts/#widget)Widget
...
### [](https://www.palantir.com/docs/foundry/custom-widgets/core-concepts/#parameters)Parameters

Parameters are configurable for each widget, and are designed to allow the host application (such as Workshop) to pass data into the widget. Parameters can currently be passed as primitive values (for example: a string, number, or Boolean) or arrays of primitive values. For a complete list of supported parameter types, see [parameters and events](https://www.palantir.com/docs/foundry/custom-widgets/parameters-and-events/).

### [](https://www.palantir.com/docs/foundry/custom-widgets/core-concepts/#events)Events
...
[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/custom-widgets/overview/)

[NEXT Create a widget set →](https://www.palantir.com/docs/foundry/custom-widgets/create/)
