...
Markdown Content:
![Image 1: AI FDE overview header image.](https://www.palantir.com/docs/resources/foundry/ai-fde/ai-fde-overview-hero.png)
...
Users can expand this context in multiple ways, including dragging and dropping folders, datasets, or documentation to provide relevant information. [Learn more about context management.](https://www.palantir.com/docs/foundry/ai-fde/navigation/#manage-context)

### Closed-loop operation

AI FDE employs a _closed-loop_ operation model, where the model executes an action, observes the result, and uses that feedback to determine its next action. This creates a continuous feedback loop where outputs from one operation become inputs for subsequent decisions, enabling complex multi-step workflows.
...
AI FDE has access to several [modes and capabilities](https://www.palantir.com/docs/foundry/ai-fde/modes-and-capabilities/) that allow it to perform a broad range of operations. You can customize the tools available to AI FDE in the **Tools** menu under the request input field.
...
*   **Functions editing:** Writing Foundry functions in [Logic](https://www.palantir.com/docs/foundry/logic/overview/), TypeScript, or Python, and testing them with [AIP Evals](https://www.palantir.com/docs/foundry/aip-evals/overview/).
