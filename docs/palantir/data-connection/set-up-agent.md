...
URL Source: https://www.palantir.com/docs/foundry/data-connection/set-up-agent/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#set-up-an-agent)Set up an agent

An **agent** is a downloadable program installed within your organizational network and managed from Foundry's [Data Connection](https://www.palantir.com/docs/foundry/data-connection/overview/) interface. Agents have the ability to connect to different data sources within your organizational network. They are used to enable [**agent-proxy egress policies**](https://www.palantir.com/docs/foundry/data-connection/agent-proxy/) to provide network connectivity to privately-hosted sources, and to enable [**agent worker connections**](https://www.palantir.com/docs/foundry/data-connection/agent-worker/) to read data from those sources and securely ingest to Foundry with a restricted access token.

This guide walks you through the steps required to create an agent. First, complete the following:

1.   After logging in to Palantir, navigate to **Data Connection** using the left [sidebar](https://www.palantir.com/docs/foundry/getting-started/orientation-and-nav/).
2.   Select the **Agents** tab.
3.   Select **New agent** in the upper right corner.

If you do not see the option to create a new agent, you may not have the required role to do so. [Learn more about managing the agent creation workflow in Control Panel.](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#agent-permissions)
...
## [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#setup)Setup

### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#create-agent-host)Create agent host
...
![Image 4: Agent requirements](https://www.palantir.com/docs/resources/foundry/data-connection/agent-requirements.png?width=600px)
### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#configure-agent-network-access)Configure agent network access
...
*   [Egress on the agent host](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#egress-on-the-agent-host)
*   [Ingress in Foundry](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#ingress-in-foundry)
...
![Image 5: A diagram of how network egress works in Data Connection.](https://www.palantir.com/docs/resources/foundry/data-connection/agent-egress.svg)

#### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#ingress-in-foundry)Ingress in Foundry

Foundry must allow inbound traffic from your server's IP. You can manage ingress rules from the [**Network ingress** page in Control Panel](https://www.palantir.com/docs/foundry/administration/configure-ingress/). Your Foundry domain will not be accessible from outside of your approved ingress rules.

![Image 6: A diagram of how network ingress works in Data Connection.](https://www.palantir.com/docs/resources/foundry/data-connection/agent-ingress.svg)

### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#secure-an-agent-host-with-firewall)Secure an agent host with firewall
...
### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#set-up-automatic-restarts)Set up automatic restarts
...
### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#save-agent-resource-in-a-project)Save agent resource in a Project

Next, you must give your new agent a name and choose a Project in which to save it. In Foundry, an agent is considered a [resource](https://www.palantir.com/docs/foundry/getting-started/projects-and-resources/) that is saved into a Project to allow for highly configurable permissions.
...
*   [Recommendations for managing agent permissions](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#agent-permissions)
*   [Guidance on how permissions should be set up end-to-end for data pipeline](https://www.palantir.com/docs/foundry/building-pipelines/recommended-project-structure/)
*   [A full reference of how agent permissions interact with Projects and roles](https://www.palantir.com/docs/foundry/data-connection/permissions/#agents)

### [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#download-and-install-the-agent)Download and install the agent
...
If you need to configure a proxy, more details are available in the [proxy configuration documentation](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#proxy-configuration).

After the agent has started successfully, follow the steps to [configure automatic upgrades](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#automatic-upgrade-windows) to ensure that your agent remains updated.

## [](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#next-steps)Next steps

Now that you have created, installed, and started your agent, navigate to the agent page in Data Connection where you can [configure and monitor the agent permissions, health, and connectivity](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/).

After your agent is set up, you can move on to [setting up a source](https://www.palantir.com/docs/foundry/data-connection/set-up-source/) to connect your agent with your organization's data sources.

[← PREVIOUS FAQ](https://www.palantir.com/docs/foundry/data-connection/faq/)

[NEXT Agent configuration reference →](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/)
