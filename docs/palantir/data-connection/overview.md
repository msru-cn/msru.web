...
URL Source: https://www.palantir.com/docs/foundry/data-connection/overview/

Published Time: Thu, 09 Jul 2026 17:47:54 GMT

# [](https://www.palantir.com/docs/foundry/data-connection/overview/#data-connection)Data Connection
...
![Image 3: The Data Connection application in the Foundry sidebar.](https://www.palantir.com/docs/resources/foundry/data-connection/data-connection-sidebar.png)

You can also find the Data Connection application by searching in the Applications Portal.

![Image 4: The Data Connection application found in the Applications Portal](https://www.palantir.com/docs/resources/foundry/data-connection/data-connection-app-portal.png)

If you are connecting Foundry to your data for the very first time for your organization, get started by referring to the [initial setup guide](https://www.palantir.com/docs/foundry/data-connection/initial-setup-overview/).
...
## [](https://www.palantir.com/docs/foundry/data-connection/overview/#robustness)Robustness
...
## [](https://www.palantir.com/docs/foundry/data-connection/overview/#extensibility)Extensibility
...
Foundry also supports communication between Foundry enrollments via the dedicated [Foundry connector](https://www.palantir.com/docs/foundry/available-connectors/foundry/). With this connector, one Foundry instance can be treated as a source on another, supporting batch and streaming syncs with incremental options.

[Learn more about the full range of available source types.](https://www.palantir.com/docs/foundry/data-integration/source-type-overview/)

## [](https://www.palantir.com/docs/foundry/data-connection/overview/#ease-of-use)Ease of use
...
[← PREVIOUS Core concepts / Views](https://www.palantir.com/docs/foundry/data-integration/views/)

[NEXT Core concepts →](https://www.palantir.com/docs/foundry/data-connection/core-concepts/)
