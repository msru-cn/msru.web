...
URL Source: https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#listener-subdomains)Listener subdomains
...
## [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#creating-a-listener-subdomain)Creating a listener subdomain
...
![Image 8: Request a new listener subdomain in Control Panel.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-request-subdomain.png)

There is a limit of three listener subdomains per enrollment. Contact Palantir support if more are needed.

## [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#ingress-allowlisting)Ingress allowlisting

Listener subdomains can be configured in one of two modes: custom ingress or inherited ingress.

### [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#custom-ingress)Custom ingress
...
Once the subdomain is created, you can manage ingress in **Control Panel > Network ingress**. [Learn more about ingress configuration.](https://www.palantir.com/docs/foundry/administration/configure-ingress/)

### [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#inherited-ingress)Inherited ingress
...
## [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#using-a-listener-subdomain)Using a listener subdomain
...
![Image 9: Select a subdomain from the Configure connection step of the listener settings wizard.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-select-a-subdomain.png)
...
![Image 10: The subdomain mount is approved and an endpoint is now available.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-approved-subdomain-mount.png)

### [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#changing-the-subdomain-for-a-listener)Changing the subdomain for a listener
...
### [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#migration-to-subdomains)Migration to subdomains
...
![Image 11: Migration instructions for switching to use subdomains shown in the listener settings.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-subdomain-migration.png)

## [](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/#endpoint-rotation)Endpoint rotation
...
To support this process, listeners provide an endpoint rotation mechanism. To rotate your endpoint, navigate to the **Configuration** tab of your listener's settings and locate the **Rotate endpoints** option. Note that you can only have a maximum of two endpoints at a time, and a maximum of one _active_ endpoint. An active endpoint is an endpoint without a set expiration date.

![Image 12: The listener's endpoints table shown in the "Configuration" step.](https://www.palantir.com/docs/resources/foundry/data-connection/listener-endpoints-table.png)
...
![Image 13: The modal for configuring the endpoint rotation.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-rotate-endpoints-modal.png)
...
![Image 14: In the listener's endpoint table, endpoint expirations can be modified.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-modify-endpoint-expiration.png)
...
[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/data-connection/listeners-overview/)

[NEXT HTTPS listeners / Overview →](https://www.palantir.com/docs/foundry/data-connection/listeners-https/)
