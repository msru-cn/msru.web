...
URL Source: https://www.palantir.com/docs/foundry/data-connection/listeners-https/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-connection/listeners-https/#https-listeners)HTTPS listeners

HTTPS listeners receive inbound webhook requests from external systems through HTTPS endpoints. Events are written to a [stream](https://www.palantir.com/docs/foundry/data-integration/streams/), enabling processing through [Automate](https://www.palantir.com/docs/foundry/automate/streaming/), [streaming pipelines](https://www.palantir.com/docs/foundry/building-pipelines/streaming-overview/), or batch processing using the stream's backing dataset.

## [](https://www.palantir.com/docs/foundry/data-connection/listeners-https/#when-to-use-https-listeners)When to use HTTPS listeners
...
## [](https://www.palantir.com/docs/foundry/data-connection/listeners-https/#configure-a-listener)Configure a listener

Navigate to **Data Connection > Listeners** to connect the Palantir platform to external systems and workflows. For information on securely configuring listeners and incoming data, refer to the [HTTPS listener security](https://www.palantir.com/docs/foundry/data-connection/listeners-https-security/) documentation.

You can explore a listener's streaming dataset in Data Lineage to better understand data transformations and flows.

## [](https://www.palantir.com/docs/foundry/data-connection/listeners-https/#throughput-and-limitations)Throughput and limitations

Only low-throughput event streams should be pushed to HTTPS listeners. HTTPS listeners are rate-limited at approximately 100 requests per second, so integrations requiring substantially higher throughput should use [streaming syncs](https://www.palantir.com/docs/foundry/data-connection/set-up-streaming-sync/) or the [public streaming API endpoints](https://www.palantir.com/docs/foundry/api/v2/streams-v2-resources/streams/publish-record-to-stream) when possible.
...
## [](https://www.palantir.com/docs/foundry/data-connection/listeners-https/#supported-https-listeners)Supported HTTPS listeners
...
| [Apollo ↗](https://www.palantir.com/docs/apollo/managing-notifications/overview/) |  |
...
| [Google Cloud Pub/Sub ↗](https://cloud.google.com/pubsub/docs/push) | [Guide](https://www.palantir.com/docs/foundry/data-connection/listeners-google-pub-sub/) |
| [ION Factory OS ↗](https://manual.firstresonance.io/api/webhooks) |  |
| [Jira ↗](https://developer.atlassian.com/server/jira/platform/webhooks/) and [Jira Cloud Automation ↗](https://support.atlassian.com/cloud-automation/docs/jira-cloud-automation/) | [Guide](https://www.palantir.com/docs/foundry/data-connection/listeners-jira/) |
...
| [Slack ↗](https://api.slack.com/apis/events-api) | [Guide](https://www.palantir.com/docs/foundry/data-connection/listeners-slack/) |
...
[← PREVIOUS Listeners / Listener subdomains](https://www.palantir.com/docs/foundry/data-connection/listeners-subdomains/)

[NEXT Security →](https://www.palantir.com/docs/foundry/data-connection/listeners-https-security/)
