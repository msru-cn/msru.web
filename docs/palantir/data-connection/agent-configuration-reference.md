...
URL Source: https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/
...
*   [Agent permissions](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#agent-permissions)
*   [Proxy configuration](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#proxy-configuration)
    *   [Agent Manager proxy configuration](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#agent-manager-proxy-configuration)
    *   [Bootstrapper proxy configuration](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#bootstrapper-proxy-configuration)
    *   [Source proxy configuration](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#source-proxy-configuration)

*   [Agent metrics and health monitoring](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#agent-metrics-and-health-monitoring)
    *   [Metrics](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#metrics)
        *   ["Time until next expiration" metrics](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#time-until-next-expiration-metrics)

    *   [Health monitoring](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#health-monitoring)

*   [Automatic upgrade windows](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#automatic-upgrade-windows)
    *   [Upgrade windows](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#upgrade-windows)
    *   [Stagger upgrades](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#stagger-upgrades)
    *   [Schedule dataset syncs](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#schedule-dataset-syncs)

*   [Reinstall an agent](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#reinstall-an-agent)
*   [Move an agent to a new directory](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#move-an-agent-to-a-new-directory)
*   [Move an agent to a new host](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#move-an-agent-to-a-new-host)
*   [Install on a Windows host](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#install-on-a-windows-host)
*   [Backup and caches](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#backups-and-caches)
*   [Configure host overrides](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#configure-host-overrides)

Learn more about [agents](https://www.palantir.com/docs/foundry/data-connection/core-concepts/) and how to [set them up](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/) in the Data Connection application.

## Agent permissions

Permission to create agents is administered in [Control Panel](https://www.palantir.com/docs/foundry/administration/control-panel/). To create an agent, you must have either the `Organization administrator` or `Data flows administrator` role assigned to you. It is also possible to create a custom role and assign the `Create agent` workflow to that role. Organization roles are managed on the **Organization permissions** page in Control Panel.

[Learn more about managing roles in Control Panel.](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-permissions/)
...
*   [Certificates to allow agent communication with Foundry](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#certificates-to-allow-agent-communication-with-foundry)
*   [Certificates to allow agent communication with your systems (agent worker only)](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#certificates-to-allow-agent-communication-with-your-systems)
...
![Image 1: Manage agent certificates in Data Connection.](https://www.palantir.com/docs/resources/foundry/data-connection/manage-certs.png)
...
For client certificates, refer to our [private key setup](https://www.palantir.com/docs/foundry/data-connection/agent-worker/#add-a-private-key) documentation.
...
2.   Add necessary certificates from the agent management page as described in the [section above](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#add-certificates-to-an-agent), then download and follow the standard installation instructions.

If your additional certificate is for an explicit proxy, [additional configuration may be required](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#proxy-configuration).
...
6.   To allow the agent to connect to Foundry, follow the [instructions above](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#add-certificates-to-an-agent) to add the same certificate to the agent.
...
For your agent to use a proxy, you will need to configure the proxy in both the **Agent** and **Bootstrapper** configurations found in the **Advanced** tab of the **Manage Configuration** window in the agent configuration page within Data Connection. Make sure to provide the hostname _without_`http://` at the beginning.
...
Once you set up an [agent](https://www.palantir.com/docs/foundry/data-connection/core-concepts/#agents) in Data Connection, you can view metrics and monitor health to maintain performance.
...
![Image 2: The agent metrics page for a streaming agent, with metrics to measure memory, disk space, and operating system load.](https://www.palantir.com/docs/resources/foundry/data-connection/agent-metrics.png)
...
| 3 | v2.0 | v1.0 | `3` |  |
| 4 | v2.0 | v1.0 -> v2.0 | `4` ->`0` | Metric goes back to `0` after a successful update during [the maintenance window.](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#automatic-upgrade-windows) |
...
You can monitor an agent's health by [creating a monitoring view](https://www.palantir.com/docs/foundry/monitoring-views/overview/#create-a-new-monitoring-view) in the **Data Health** application. A monitoring view is a collection of monitoring rules that are of particular interest to a subscribed group of users.

You can view existing monitoring views by selecting the **Monitoring views** tab.

![Image 3: The Monitoring views page of the Data Health app, showing a single monitoring view named 'Test View'.](https://www.palantir.com/docs/resources/foundry/data-connection/data-health-monitoring-views.png)
...
![Image 4: The Manage monitors tab of the Data Health app, showing a button prompting the user to create a new monitoring rule.](https://www.palantir.com/docs/resources/foundry/data-connection/data-health-add-monitoring-rules.png)

In the **Create monitoring rules** page, you can configure specific rules and alerts of varying severities.

![Image 5: The Create monitoring rules tab, in which the user has applied alerts for CPU utilization, queue size, and low disk space for a test source.](https://www.palantir.com/docs/resources/foundry/data-connection/data-health-configure-and-apply-monitors.png)

Learn more about [tracking data health with monitors](https://www.palantir.com/docs/foundry/monitoring-views/overview/) and [integrating monitors with PagerDuty](https://www.palantir.com/docs/foundry/monitoring-views/overview/#integrate-with-external-systems).
...
![Image 6: Manage automatic upgrades](https://www.palantir.com/docs/resources/foundry/data-connection/manage-automatic-upgrades.png)
...
9.   If the agent was previously configured to autostart: 
    ...
    2.   For Windows, remove any scheduled tasks that were set up while following instructions on [installing on a Windows host](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#install-on-a-windows-host).
...
14.   If the agent was previously configured to auto-restart, re-enable it by following the [auto-restart setup instructions](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#set-up-automatic-restarts).
...
1.   Follow steps 1 through 11, excluding step 3 in the instructions for [moving an agent to a new directory](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#move-an-agent-to-a-new-directory). This will stop the agent and prepare it to be transferred to a new host.
...
3.   Follow previously skipped step 3 from the instructions on [moving an agent to a new directory](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#move-an-agent-to-a-new-directory). For each file or folder referenced by an absolute path, copy that resource to a location on the new host and update the configuration to point to the new path.
4.   Follow steps 13 through 16 from the [moving an agent to a new directory](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#move-an-agent-to-a-new-directory) guide.

## Install on a Windows host

Follow the steps in the [guide to setting up a agent](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/), but select Windows as your operating system on the [download and configure agent](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/#download-and-install-the-agent) step. Once you install your agent, you will need to set up a Windows scheduled task that restarts the Agent Manager on crash or machine restart, as follows:
...
3.   Under the **General** tab, perform the following: 
    ...
    3.   Make sure **Do not store password...** is _NOT_ selected.
...
5.   Under the **Actions** tab: 
    ...
    3.   Copy the whole path to the _enclosing folder_ for the batch script into the box for **Start in (optional)**. 
...
Agents may backup or cache files as part of installation, version upgrade, version downgrade, and ongoing usage. This includes earlier versions of the agent software and connector plugins. Security and stability fixes are delivered in the [latest version](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#automatic-upgrade-windows). Once an agent has upgraded, the versions it replaced are retained on the host but are no longer loaded or run. Normally, backups and cached files may be safely ignored, and will be automatically deleted after 30 days. If they are using up a higher than desired amount of disk space on the agent host, it is safe to delete them. Perform any deletion outside of a [maintenance window](https://www.palantir.com/docs/foundry/data-connection/agent-configuration-reference/#automatic-upgrade-windows).
...
![Image 7: Add a host override from the Agent settings page in Data Connection.](https://www.palantir.com/docs/resources/foundry/data-connection/agent-add-host-override.png)
...
![Image 8: Use the host override in your source settings](https://www.palantir.com/docs/resources/foundry/data-connection/source-with-host-override.png)
