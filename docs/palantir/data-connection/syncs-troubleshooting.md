...
URL Source: https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#troubleshooting-reference)Troubleshooting reference

This page describes several common issues with Syncs with steps to debug:

*   [PKIX and SSL Exceptions](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#pkix-and-ssl-exceptions)
*   [Egress Proxy Issues](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#egress-proxy-issues)
*   [Incremental JDBC Syncs](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#incremental-jdbc-sync-issues)
*   [Intermittent sync failures or hangs](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#intermittent-sync-failures-or-hangs)
*   [A sync started failing](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#a-sync-started-failing)
*   [Unexpected data was synced](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#unexpected-data-was-synced)

## [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#pkix-and-ssl-exceptions)PKIX and SSL exceptions

For certificate and TLS troubleshooting, including `PKIX` and `SSLHandshakeException` errors, see [Certificates and TLS](https://www.palantir.com/docs/foundry/data-connection/troubleshooting/#certificates-and-tls).
...
## [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#egress-proxy-issues)Egress proxy issues

### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#ftp-syncs)FTP syncs
...
### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#s3-syncs)S3 syncs
...
Copied!```yaml
1host: <address of deployment gateway or egress NLB>
2port: 8888
3protocol: http
4nonProxyHosts: <bucket>.s3.<region>.amazonaws.com,s3.<region>.amazonaws.com,s3-<region>.amazonaws.com
```  
e.g: Allowlisting all VPC buckets would involve a config addition of:

Copied!```yaml
1clientConfiguration:
2     proxyConfiguration:
3        host: <color>-egress-proxy.palantirfoundry.com
4        port: 8888
5        protocol: http
6        nonProxyHosts: *.s3.<region>.amazonaws.com, s3.<region>.amazonaws.com, s3-<region>.amazonaws.com
```  
...
## [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#incremental-jdbc-sync-issues)Incremental JDBC sync issues
...
#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#missing-rows-and-rows-not-being-updated)Missing rows and rows not being updated
...
#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#duplicate-rows)Duplicate rows
...
#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#nullpointerexception-thrown-on-incremental-sync)NullPointerException thrown on incremental sync
...
## [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#intermittent-sync-failures-or-hangs)Intermittent sync failures or hangs

#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#check-if-your-agent-is-running-out-of-resources)Check if your agent is running out of resources
...
#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#hanging-syncs)Hanging syncs
...
#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#large-file-based-syncs-are-vulnerable-to-transient-failures)Large file-based syncs are vulnerable to transient failures
...
*   Use [incremental `APPEND` syncs](https://www.palantir.com/docs/foundry/data-connection/file-based-syncs/#optimize-file-based-syncs) instead of `SNAPSHOT` syncs.
...
For more details, see [sync failure behavior](https://www.palantir.com/docs/foundry/data-connection/file-based-syncs/#sync-failure-behavior) and [optimize file-based syncs](https://www.palantir.com/docs/foundry/data-connection/file-based-syncs/#optimize-file-based-syncs).

#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#if-your-sync-fails-with-the-request_entity_too_large-error)If your sync fails with the `REQUEST_ENTITY_TOO_LARGE` error
...
1uploadStrategy:
2    type: data-proxy
3    maximumUploadedFileSizeBytes: 161061273600
```  

## [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#a-sync-started-failing)A sync started failing

#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#if-your-sync-fails-with-the-badpaddingexception-error)If your sync fails with the `BadPaddingException` error
...
## [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#unexpected-data-was-synced)Unexpected data was synced

#### [](https://www.palantir.com/docs/foundry/data-connection/syncs-troubleshooting/#if-timestamp-columns-in-your-jbdc-sync-show-up-as-long-columns-in-foundry)If timestamp columns in your JBDC sync show up as Long columns in Foundry
...
To fix the data type for these columns, we recommend using a [Python Transform](https://www.palantir.com/docs/foundry/transforms-python/overview/) environment to perform this cleaning. Here is an example code snippet that casts the column `"mytimestamp"` back into timestamp form:

Copied!

```python
1df = df.withColumn("mytimestamp", (F.col("mytimestamp") / 1000).cast("timestamp"))
```

[← PREVIOUS Optimize JDBC syncs](https://www.palantir.com/docs/foundry/data-connection/optimize-jdbc-syncs/)

[NEXT Exports / Overview →](https://www.palantir.com/docs/foundry/data-connection/export-overview/)
