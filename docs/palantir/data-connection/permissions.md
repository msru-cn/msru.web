...
URL Source: https://www.palantir.com/docs/foundry/data-connection/permissions/

Published Time: Thu, 09 Jul 2026 17:47:53 GMT

# [](https://www.palantir.com/docs/foundry/data-connection/permissions/#permissions-reference)Permissions reference

All major concepts in Data Connection — agents, sources, and syncs — are managed in Foundry as [resources](https://www.palantir.com/docs/foundry/getting-started/projects-and-resources/). This enables flexibly organizing these resources across Projects and folders, and allows security primitives such as [markings](https://www.palantir.com/docs/foundry/security/markings/) to be applied to Data Connection resources.
...
*   [Agents](https://www.palantir.com/docs/foundry/data-connection/permissions/#agents)
*   [Sources](https://www.palantir.com/docs/foundry/data-connection/permissions/#sources)
*   [Syncs](https://www.palantir.com/docs/foundry/data-connection/permissions/#syncs)
*   [Plugins](https://www.palantir.com/docs/foundry/data-connection/permissions/#plugins-and-jdbc-drivers)
*   [Webhooks](https://www.palantir.com/docs/foundry/data-connection/permissions/#webhooks)
*   [External connections from code](https://www.palantir.com/docs/foundry/data-connection/permissions/#external-connections-from-code)

## [](https://www.palantir.com/docs/foundry/data-connection/permissions/#resource-permissions)Resource permissions

The permissions listed below are defaults. In some environments, the default permission behavior may have been changed using [custom roles](https://www.palantir.com/docs/foundry/platform-security-management/manage-roles/#customizing-the-default-roles).

### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#agents)Agents
...
A user must be the editor of a Project to create an agent in that Project, but must be an _owner_ of the Project to administer the agents within that Project. That means that a user may create an agent and then be unable to generate download links or perform other administrative tasks on the agent.
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#sources)Sources
...
*   Modify export configurations if the user configuring exportable Markings has permission to [remove Markings](https://www.palantir.com/docs/foundry/platform-security-management/manage-markings/#remove-markings) from any Organization or security Markings they add as safe to export to the selected source.
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#syncs)Syncs
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#plugins-and-jdbc-drivers)Plugins and JDBC Drivers
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#webhooks)Webhooks
...
By default, only the user who executes a Webhook may view the response using the history tab in the Data Connection application. The `webhooks:read-privileged-data` permission may be added to a custom or default [role](https://www.palantir.com/docs/foundry/security/projects-and-roles/) to allow users with that role to view the full request and response history for all webhooks that they can access. The standard recommended setup is to add a new role called "Webhook Privileged Data Viewer" with this permission, and ensure that users who need to view full Webhook history have this role on the relevant sources.

### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#external-connections-from-code)External connections from code

#### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#external-transforms-pipelines-and-compute-modules)External transforms, pipelines, and compute modules
...
*   Importing a source in a code resource ([transform](https://www.palantir.com/docs/foundry/transforms-python/overview/), [pipeline](https://www.palantir.com/docs/foundry/pipeline-builder/overview/) or [compute module](https://www.palantir.com/docs/foundry/compute-modules/overview/)) requires `Editor` permission on the source.
...
#### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#external-functions)External functions

Refer to the documentation on [external functions permissions](https://www.palantir.com/docs/foundry/functions/webhooks/#permissions) for detailed information regarding permission of using webhooks in a functions repository.

## [](https://www.palantir.com/docs/foundry/data-connection/permissions/#marking-propagation)Marking propagation

As noted above, resources can have [Organizations](https://www.palantir.com/docs/foundry/security/orgs-and-spaces/#organizations) and [Markings](https://www.palantir.com/docs/foundry/security/markings/) applied as an additional level of access control. Organizations and Markings are applied to the source will propagate to the datasets produced from syncs on that source. This means users will not be able to view data in any of the datasets produced from a source, unless they have access to all of the Organizations and Markings applied to that source.

Foundry-to-Foundry sync exception
...
## [](https://www.palantir.com/docs/foundry/data-connection/permissions/#best-practices)Best practices
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#agent-best-practices)Agent best practices
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#source-best-practices)Source best practices

Each source should be in its own Project in the [datasource](https://www.palantir.com/docs/foundry/building-pipelines/recommended-project-structure/) layer. Each sync defined on a source should output to a [dataset](https://www.palantir.com/docs/foundry/data-integration/datasets/) within the same Project as the source. If the source contains sensitive data such as PII, you can apply a [Marking](https://www.palantir.com/docs/foundry/security/markings/) to the source which will propagate to the output datasets.
...
### [](https://www.palantir.com/docs/foundry/data-connection/permissions/#plugins-and-jdbc-drivers-1)Plugins and JDBC drivers
...
[← PREVIOUS Initial setup overview](https://www.palantir.com/docs/foundry/data-connection/initial-setup-overview/)

[NEXT FAQ →](https://www.palantir.com/docs/foundry/data-connection/faq/)
