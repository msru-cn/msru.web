...
URL Source: https://www.palantir.com/docs/foundry/data-connection/listeners-google-pub-sub/

Published Time: Thu, 09 Jul 2026 17:47:53 GMT

# [](https://www.palantir.com/docs/foundry/data-connection/listeners-google-pub-sub/#set-up-a-google-cloud-pubsub-listener)Set up a Google Cloud Pub/Sub listener
...
![Image 7: In the Google Cloud interface, create a new Pub/Sub topic.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-google-pubsub-1.png)
...
![Image 8: Google Cloud Pub/Sub listener configuration page in Data Connection.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-google-pubsub-2.png)
...
![Image 9: Google Cloud Pub/Sub Add subscription to topic page with sample configuration values.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-google-pubsub-3.png)
...
![Image 10: Google Cloud Pub/Sub Add subscription to topic page with sample configuration values.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-google-pubsub-4.png)
...
![Image 11: Publish a message to test in Google Cloud Pub/Sub as part of testing your setup.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-google-pubsub-5.png)

![Image 12: Receive an event in your successfully configured listener.](https://www.palantir.com/docs/resources/foundry/data-connection/listeners-google-pubsub-6.png)
...
_All screenshots of Google Cloud Pub/Sub™ are provided for reference purposes only and are the property of Google LLC._

[← PREVIOUS Event processing](https://www.palantir.com/docs/foundry/data-connection/listeners-event-processing/)

[NEXT Set up a Jira listener →](https://www.palantir.com/docs/foundry/data-connection/listeners-jira/)
