...
URL Source: https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/
...
This page contains information on [how to configure agent logs](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#configure-agent-logs), describes several [common issues with agent configuration](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#common-issues-with-agent-configuration), and provides debugging guidance. The steps described must be taken after SSHing into the host where the agent has been installed. Before exploring additional troubleshooting topics, we recommend first checking`./var/diagnostic/launch.yml` to confirm the agent successfully connected to Foundry. If the connection was unsuccessful, follow the instructions described in the field `enhancedMessage`.

[Common issues with agent configuration](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#common-issues-with-agent-configuration)

*   [Agent and agent manager shows "offline" status but returns "running" on the agent host](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#agent-and-agent-manager-shows-offline-status-but-returns-running-on-the-agent-host)

*   [Agent manager shows "offline" status](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#agent-manager-shows-offline-status)

*   [Bootstrapper shows "never reported" status](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#bootstrapper-shows-never-reported-status)

*   [Agent shows "online" but is not responding to restarts](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#agent-shows-online-but-is-not-responding-to-restarts)

*   [Agent status shows "Unhealthy"](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#agent-status-shows-unhealthy)

*   [Unable to download agent package](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#unable-to-download-agent-package)

*   [Unable to administer an agent](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#unable-to-administer-an-agent)

*   [Unable to create an agent due to PERMISSION_DENIED error](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#unable-to-create-an-agent-due-to-permission_denied-error)

[Agent configuration reference](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#agent-configuration-reference)

*   [Connect to data sources using the insecure TLSv1.0 and TLSv1.1 protocols](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#connect-to-data-sources-using-the-insecure-tlsv10-and-tlsv11-protocols)
*   [Configure agent logs](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#configure-agent-logs)
*   [What happens to cached files when the host where the agent is installed crashes?](https://www.palantir.com/docs/foundry/data-connection/agents-troubleshooting/#what-happens-to-cached-files-when-the-host-where-the-agent-is-installed-crashes)
...
2  adminConnectors:
3    ...
4    port: 7002 #This is the port value
``` 
...
2Mem:          5.8Gi       961Mi       2.8Gi       9.0Mi       2.1Gi       4.6Gi
3Swap:         1.0Gi          0B       1.0Gi
```
...
2.   Set JAVA_HOME: `setx -m JAVA_HOME "{BOOTVISOR_INSTALL_DIR}\jdk\{JDK_VERSION}-win_x64\"`
...
1.   Decide on how much memory should be allocated to each of the aforementioned subprocesses. 
    *   _Note: We do not recommend reducing the heap sizes below the defaults which are listed below._
...
4.   Below is an example **Bootstrapper configuration snippet** with the **agent** jvmHeapSize set to 3gb: Copied!

```
1agent:
2    ....
3    jvmHeapSize: 3g #This is jvm heap size value
``` 
...
For more details on agent permissions, review the guidance in our [permissions reference](https://www.palantir.com/docs/foundry/data-connection/permissions/) documentation.
...
![Image 1: Agent with custom legacy TLS protocols configured](https://www.palantir.com/docs/resources/foundry/data-connection/agent-tls.png)

1.   Select **Restart agent**.
