...
URL Source: https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#agent-worker-configuration-reference)Agent worker configuration reference
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#set-up-an-agent)Set up an agent
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#memory-allocation-and-usage)Memory allocation and usage
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#load-balancing)Load balancing
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#direct-vs-data-proxy-upload-strategy)Direct vs. data proxy upload strategy

Agent workers support two options to specify how data from batch syncs should be uploaded to the Palantir platform:

### [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#data-proxy-mode)Data proxy mode
...
### [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#direct-mode-sunset)Direct mode [Sunset]
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#custom-jdbc-drivers)Custom JDBC drivers
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#credentials)Credentials
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#certificates)Certificates
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#add-a-private-key)Add a private key
...
## [](https://www.palantir.com/docs/foundry/data-connection/agent-worker-runtime/#known-limitations)Known limitations
