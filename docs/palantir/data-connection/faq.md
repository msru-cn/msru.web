...
URL Source: https://www.palantir.com/docs/foundry/data-connection/faq/

Published Time: Thu, 09 Jul 2026 17:47:53 GMT

# [](https://www.palantir.com/docs/foundry/data-connection/faq/#data-connection-faq)Data Connection FAQ

The following are some frequently asked questions about Data Connection.

For general information, view our [Data Connection documentation](https://www.palantir.com/docs/foundry/data-connection/overview/).

*   [Scheduled build never ran](https://www.palantir.com/docs/foundry/data-connection/faq/#scheduled-build-never-ran)
*   [Ingestion led to duplicate rows in a dataset when running `SNAPSHOT` transaction](https://www.palantir.com/docs/foundry/data-connection/faq/#ingestion-led-to-duplicate-rows-in-a-dataset-when-running-a-snapshot-transaction)
*   [Incremental load run time info](https://www.palantir.com/docs/foundry/data-connection/faq/#incremental-load-run-time-info)
*   [Column type is not consistent between database and dataset](https://www.palantir.com/docs/foundry/data-connection/faq/#column-type-is-not-consistent-between-database-and-dataset)
*   [Status of running query](https://www.palantir.com/docs/foundry/data-connection/faq/#status-of-running-query)
*   [Sync is failing with a schema mismatch](https://www.palantir.com/docs/foundry/data-connection/faq/#sync-is-failing-with-a-schema-mismatch)
*   [Permission error when re-adding a deleted sync job spec](https://www.palantir.com/docs/foundry/data-connection/faq/#permission-error-when-re-adding-a-deleted-sync-job-spec)
*   [Bootvisor status is `Unknown`](https://www.palantir.com/docs/foundry/data-connection/faq/#bootvisor-status-is-unknown)
*   [SSL/TLS issues](https://www.palantir.com/docs/foundry/data-connection/faq/#common-tlsssl-issues)

* * *

## [](https://www.palantir.com/docs/foundry/data-connection/faq/#scheduled-build-never-ran)Scheduled build never ran
...
[Return to top](https://www.palantir.com/docs/foundry/data-connection/faq/#data-connection-faq)

* * *

## [](https://www.palantir.com/docs/foundry/data-connection/faq/#ingestion-led-to-duplicate-rows-in-a-dataset-when-running-a-snapshot-transaction)Ingestion led to duplicate rows in a dataset when running a `SNAPSHOT` transaction
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#incremental-load-run-time-info)Incremental load run time info
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#column-type-is-not-consistent-between-database-and-dataset)Column type is not consistent between database and dataset
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#time-type-columns-lose-sub-second-precision-between-database-and-dataset)`TIME` type columns lose sub-second precision between database and dataset
...
```sql
1SELECT record_id, CAST(column_with_time_type AS text) FROM table_name
```

* * *

## [](https://www.palantir.com/docs/foundry/data-connection/faq/#status-of-running-query)Status of running query
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#sync-is-failing-with-a-schema-mismatch)Sync is failing with a schema mismatch
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#permission-error-when-re-adding-a-deleted-sync-job-spec)Permission error when re-adding a deleted sync job spec
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#bootvisor-status-is-unknown)Bootvisor status is `Unknown`
...
## [](https://www.palantir.com/docs/foundry/data-connection/faq/#common-tlsssl-issues)Common TLS/SSL issues

For guidance on TLS, mTLS, and SSL — including whether to add a server or client certificate and how to resolve common certificate errors such as `CERTIFICATE_VERIFY_FAILED` — see [Certificates and TLS](https://www.palantir.com/docs/foundry/data-connection/troubleshooting/#certificates-and-tls).

[Return to top](https://www.palantir.com/docs/foundry/data-connection/faq/#data-connection-faq)

[← PREVIOUS Permissions reference](https://www.palantir.com/docs/foundry/data-connection/permissions/)

[NEXT Agents / Set up an agent →](https://www.palantir.com/docs/foundry/data-connection/set-up-agent/)
