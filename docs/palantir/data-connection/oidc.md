...
URL Source: https://www.palantir.com/docs/foundry/data-connection/oidc/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-connection/oidc/#openid-connect-oidc-authentication)OpenID Connect (OIDC) authentication
...
## [](https://www.palantir.com/docs/foundry/data-connection/oidc/#supported-sources)Supported sources
...
*   [OneLake and Azure Data Lake Storage Gen2 (Azure Blob Storage)](https://www.palantir.com/docs/foundry/available-connectors/onelake-and-azure-blob-filesystem/)
*   [BigQuery](https://www.palantir.com/docs/foundry/available-connectors/bigquery/)
*   [Databricks](https://www.palantir.com/docs/foundry/available-connectors/databricks/)
*   [Google Cloud Storage](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/)
*   [S3](https://www.palantir.com/docs/foundry/available-connectors/amazon-s3/)
*   [Snowflake](https://www.palantir.com/docs/foundry/available-connectors/snowflake/)

## [](https://www.palantir.com/docs/foundry/data-connection/oidc/#oidc-identity-token)OIDC identity token
...
[← PREVIOUS Push data into a stream](https://www.palantir.com/docs/foundry/data-connection/push-based-ingestion/)

[NEXT Add sync to a Marketplace product →](https://www.palantir.com/docs/foundry/data-connection/marketplace-data-connection/)
