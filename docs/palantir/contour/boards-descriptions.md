...
URL Source: https://www.palantir.com/docs/foundry/contour/boards-descriptions/
...
_**Use the links in this summary table to navigate between board types on this page.**_

| Board | Description | Visualize | Filter Rows | Aggregate | Manipulate Columns | Remove Duplicates |
| --- | --- | --- | --- | --- | --- | --- |
| [Summary](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#summary) | Reports the row count for your table. | Yes | No | No | No | No |
| [Filter](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#filter) | Filter your dataset by numeric, text, or date and time values. | No | Yes | No | No | Yes |
| [Expression](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#expression) | Use the expression language to derive new columns or perform complex filtering. | No | Yes | No | Yes | No |
| [Table](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#table) | View a portion of raw data, explore schemas and calculate data coverage metrics. | Yes | No | No | No | No |
| [Histogram](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#histogram) | Create a histogram of your data and filter to specific groups. | Yes | Yes | Yes | Yes, via the Pivot option | No |
| [Distribution](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#distribution) | Create a distribution plot of your data. | Yes | Yes | No | No | No |
| [Time series](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#time-series) | Create a chart with date/time on the x-axis and filter to specific groups. | Yes | Yes | No | No | No |
| [Edit columns](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#edit-columns) | Combine, duplicate, remove, rename, or split columns. | No | No | No | Yes | No |
| [Transform data](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#transform-data) | Obfuscate data, find and replace values, or parse dates. | No | No | No | Yes | No |
| [Chart](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#chart) | Create customizable, multi-layered charts. | Yes | Yes | Yes | No | No |
| [Grid](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#grid) | Create a matrix of two categorical columns. Cells can be filtered and are displayed as a heatmap. | Yes | Yes | No | No | No |
| [Heatmap](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#heatmap) | View a heatmap based on coordinate data. | Yes | Yes | No | No | No |
| [Pivot table](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#pivot-table) | Create a pivot table for one or more metrics. | Yes | Yes | Yes | Yes, via the Pivot option | No |
| [Column editor](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#column-editor) | Derive new columns or remove unnecessary columns. | No | No | No | Yes | Yes |
| [Multi-column editor](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#multi-column-editor) | Rename, remove, reorder columns, or remove duplicate rows in the data. | No | No | No | No | No |
| [Enrich](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#enrich) | Enrich data with another dataset and return columns from both datasets. | No | No | No | Yes | Yes |
| [Link](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#link) | Join to another dataset and return the matching records of that dataset. | No | No | No | Yes | Yes |
| [Set math](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#set-math) | Keep, add, or remove rows based on external dataset. | No | Yes | No | No | No |
| [Join](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#join) | Perform curated joins. | No | Yes | No | No | No |
| [Export](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#export) | Export your final filtered set of observations to CSV or XLS. | No | No | No | No | No |
| [Reorder columns](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#reorder-columns) | Reorder the columns in your table. | No | No | No | No | No |
| [Macro](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#macro) | Apply templatized transformations to your path. | No | No | No | No | No |
| [Sort](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#sort) | Sort the rows of data based on one or more columns. | No | No | No | No | No |
| [Calculation](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#calculation) | Display multiple aggregate calculations. | Yes | No | Yes | No | No |
| [Unpivot](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#unpivot) | Reshape your data by turning some columns into rows. | No | No | No | Yes | No |
...
![Image 1: filter-config](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-filter-config.png)

To add another filter, simply click **Add filter** again. You can choose to match **all filters** or **any filter**. To remove a filter, click the trash button next to the filter. Click **Save** to apply your filters.
...
![Image 2: table-column-operations](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-table-column-operations.png)

To move multiple columns at once, select the columns while holding down the Shift key. You can also use the **Configure** panel to modify multiple columns at once.

![Image 3: table-configure](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-table-configure.png)

### Conditional formatting

You can add conditional formatting to the table board by clicking the column dropdown.

![Image 4: conditional-formatting-action](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-conditional-formatting-action.png)
...
![Image 5: conditional-formatting-dialog](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-conditional-formatting-dialog.png)
...
The table panel makes the table (not boards) the focus, so you can see how the data changes as you add each board. This can be especially helpful when writing [expressions](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#expression).

![Image 6: table-view](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-table-view.png)
...
![Image 7: histogram-taxi-example](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-histogram-taxi-example.png)
...
The histogram board is a visualization of a SQL `GROUP BY` clause. The above example histogram is equivalent to the following SQL query:
...
![Image 8: histogram-pivot](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-histogram-pivot.png)
...
*   Choose **Bar** to filter by one or multiple distinct values of the column you selected as the Y-Axis.

![Image 9: histogram-bar-selection](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-histogram-bar-selection.png) 
*   Choose **Range** to filter by aggregate value. For example, you might use Range selection to select only categories that have values above a certain threshold.

![Image 10: histogram-range-selection](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-histogram-range-selection.png) Then choose **Keep** to filter to _only_ the selected values, or **Remove** to keep only the non-selected values.

![Image 11: histogram-keep-remove](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-histogram-keep-remove.png) 
...
The distribution board is similar to the histogram, but it displays aggregated data based on _ranges_ of values, rather than specific values. For example, the following distribution displays data about customers’ ages. Ages are divided into ten ranges (or “buckets”).

![Image 12: distribution](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-distribution.png)
...
![Image 13: distribution-select](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-distribution-select.png)

You can then adjust the interval more finely in the editable board footer.

![Image 14: distribution-footer](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-distribution-footer.png)
...
![Image 15: time series](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-timeseries.png)
...
![Image 16: time series-series](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-timeseries-series.png)

Note that the time series performs its aggregates over the _entire_ dataset, and reduces the output to the first 1000 values upon displaying it.
...
You can select a date range on the time series to filter the dataset for future boards. Click ![Image 17: select-range](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-select-range.png), then click-and-drag your desired interval. (You can adjust the interval more finely in the editable board footer.) To clear your selection, click the ![Image 18: clear-selection](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-clear-selection.png) icon.

Choose **Keep** from the dropdown to filter to _only_ the selected values, or choose **Remove** to keep only the non-selected values.

![Image 19: time series-select-range](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-timeseries-select-range.png)
...
3.   **Strategies:** Represents how data should be suppressed and in what order. You can set the given order of operations to reach the indicated k-value. For each column listed, you can choose amongst different strategies that would be applied to data to meet the k-value: 
    ...
    *   **Mask:** Replaces the last _n_ characters with a `*`.
...
4.   **Rows that do not meet the k-value post-suppression:** If some rows do not meet the k-value threshold and cannot be suppressed to meet a count greater than `k`, the following options are available: 
    ...
    *   **Redact:** Obfuscate all values in the table with `***`. This option is particularly relevant if you want to retain the same count of rows. 
![Image 20: The obfuscate interface labeled with numbers that represent the steps required to configure k-anonymitzation.](https://www.palantir.com/docs/resources/foundry/contour/board-obfuscate-clickthru.png)
...
![Image 21: parse-date](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-parse-date.png)
...
![Image 22: chart-board-bar](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-bar.png)

**Horizontal Bar**

![Image 23: chart-board-horizontal-bar](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-horizontal-bar.png)

**Line**

![Image 24: chart-board-line](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-line.png)

**Scatter**

![Image 25: chart-board-scatter](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-scatter.png)

**Heat Grid**

![Image 26: chart-board-heat-grid](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-heat-grid.png)

**Pie**

![Image 27: chart-board-pie](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-pie.png)
...
Expand the **Options** section to change how your chart data is sorted. You may order chart data by values in the main layers:

*   X values
*   Y values
*   A custom column value. This sort value may be _any_ column in the dataset (even ones that are not plotted on the chart).

The following example sorts a bar chart by the number of gold medals received by a country in the Olympics:

![Image 28: chart-board-custom-sort](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-custom-sort.png)
...
Note that _only the main chart layer is part of the data path_. The other layers are solely for presentation purposes. In other words, making a selection or otherwise manipulating the data on an overlay layer will _not_ affect the data downstream in your path.
...
![Image 29: chart-board-separate-y-axis](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-board-separate-y-axis.png)
...
*   **Most granular:** the chart uses the maximum number of buckets that can fit within the [Result limit](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#result-limit). Exact values are used when possible.
*   **Custom:** the number of buckets can be manually selected. Note, the number of buckets cannot be greater than the [Result limit](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#result-limit).

![Image 30: chart-numeric-bucket-selector](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-numeric-bucket-selector.png)
...
![Image 31: chart-date-bucket-selector](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-date-bucket-selector.png)
...
![Image 32: chart-rebucket-example](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-chart-rebucket-example.png)
...
The grid board is similar to the [histogram](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#histogram), but the grid board aggregates data by two columns rather than one, displaying a heat grid chart of the results. (For more than two columns, you can use a [pivot table](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#pivot-table).) For example, the following grid compares education level to yearly income:

![Image 33: grid](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-grid.png)

### SQL Equivalent

The grid board is a visualization of an aggregate query, similar to the histogram and pivot table boards. A grid is approximately equivalent to the following SQL query:
...
Choose **Keep** to filter to _only_ the selected values, or choose **Remove** to keep only the non-selected values.

![Image 34: grid-selection](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-grid-selection.png)

* * *

## Heatmap

The heatmap board displays geocoded data on a map, color-coded to represent the values. ![Image 35: heatmap](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-heatmap.png)
...
Click ![Image 36: draw-circle](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-draw-circle.png), then click-and-drag to draw a circle on the map.

![Image 37: heatmap-selection](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-heatmap-selection.png)
...
![Image 38: pivot-table](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-pivot-table.png)
...
![Image 39: pivot_table_example](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-pivot_table_example.png)
...
When you sort a column in your pivot table, sorting is performed on the preview, rather than the entire dataset. To sort your entire dataset, use the Sort Board. See [Sort](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#sort) for more information.
...
![Image 40: pivottable-pivot](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-pivottable-pivot.png)
...
![Image 41: The Remove duplicate rows option is selected.](https://www.palantir.com/docs/resources/foundry/contour/boards-remove-duplicate-rows.png)
...
![Image 42: multi-column-editor](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-multi-column-editor.png)

**SQL Equivalent**

Reordering, renaming, and removing columns is equivalent to selecting column names in SQL. For example, given a table that has 5 columns, A-E, the following code removes columns D and E, and renames A to A_1:
...
[Learn how to use the enrich board.](https://www.palantir.com/docs/foundry/contour/boards-join/)

* * *

## Link

The link board lets you join to another dataset and return the matching records of that dataset. This differs from the set math keep only operation in that it returns columns _from the linked (right) table only_.

[Learn how to use the link board.](https://www.palantir.com/docs/foundry/contour/boards-join/)
...
[Learn how to use the set math board.](https://www.palantir.com/docs/foundry/contour/boards-join/).
...
[Learn how to use the join board.](https://www.palantir.com/docs/foundry/contour/boards-join/).
...
![Image 43: export-prepare](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-export-prepare.png)

![Image 44: export-download](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-export-download.png)
...
![Image 45: reorder-columns](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-reorder-columns.png)
...
![Image 46: calculation-overview](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-calculation-card.png)
...
![Image 47: calculation-format](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-calculation-formatting.png)
...
![Image 48: calculation-conditional-formatting](https://www.palantir.com/docs/resources/foundry/contour/board-descriptions-calculation-conditional-format.png)
