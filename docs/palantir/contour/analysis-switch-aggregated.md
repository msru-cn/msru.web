...
URL Source: https://www.palantir.com/docs/foundry/contour/analysis-switch-aggregated/

Published Time: Thu, 09 Jul 2026 17:47:53 GMT

# [](https://www.palantir.com/docs/foundry/contour/analysis-switch-aggregated/#switch-to-aggregated-data)Switch to aggregated data
...
![Image 3: switch-to-pivot](https://www.palantir.com/docs/resources/foundry/contour/analysis-switch-to-pivot.png)
...
![Image 4: An image of the footer of the Contour pivot table board. On the bottom right of the board, there is a circular tick mark. A tooltip over the tick mark reads: 'Cached for faster downstream computation.'](https://www.palantir.com/docs/resources/foundry/contour/analysis-query-trimming-pivot.png?width=400)
...
[← PREVIOUS Parameterize your analysis](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/)

[NEXT Share and collaborate on an analysis →](https://www.palantir.com/docs/foundry/contour/analysis-share-collaborate/)
