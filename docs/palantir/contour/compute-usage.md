...
URL Source: https://www.palantir.com/docs/foundry/contour/compute-usage/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/compute-usage/#compute-usage-with-contour)Compute usage with Contour
...
## [](https://www.palantir.com/docs/foundry/contour/compute-usage/#how-compute-is-measured)How Compute is measured
...
### [](https://www.palantir.com/docs/foundry/contour/compute-usage/#interactive-contour-usage)Interactive Contour usage
...
### [](https://www.palantir.com/docs/foundry/contour/compute-usage/#batch-contour-usage)Batch Contour usage
...
## [](https://www.palantir.com/docs/foundry/contour/compute-usage/#investigating-contour-usage)Investigating Contour usage
...
## [](https://www.palantir.com/docs/foundry/contour/compute-usage/#understanding-drivers-of-usage)Understanding drivers of usage
...
Having more Contour users may incur more compute due to an increase in queries. However, Contour has two features to reduce compute usage by many users: _checkpoints_ and _caching_.

*   Contour _checkpoints_ are managed automatically by the Contour backend. Checkpoints allow Contour to quickly serve query results that are farther down in a path. This can reduce compute from larger Contour paths over time, but will not eliminate compute completely.
*   Contour also _caches_ the results of identical queries on identical data. That means that if two users open the same Contour analysis in succession, the computation will only be run once. This allows dashboards to be served much more efficiently and reduces the effect of the number of users on compute usage. 
...
## [](https://www.palantir.com/docs/foundry/contour/compute-usage/#managing-usage-with-contour)Managing usage with contour

Optimizing the analysis and input datasets can reduce cost and analysis time. [Learn more about Contour optimization.](https://www.palantir.com/docs/foundry/contour/performance-optimize/)

## [](https://www.palantir.com/docs/foundry/contour/compute-usage/#calculating-usage)Calculating usage
...
[← PREVIOUS Performance and correctness / Timezones in Contour](https://www.palantir.com/docs/foundry/contour/correctness-timezones/)

[NEXT Insight / Overview →](https://www.palantir.com/docs/foundry/insight/overview/)
