...
URL Source: https://www.palantir.com/docs/foundry/contour/expressions-overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/expressions-overview/#expressions)Expressions
...
*   Learn the basics of how to [use the expression board](https://www.palantir.com/docs/foundry/contour/expressions-use-board/).
*   Read the reference for [expressions syntax](https://www.palantir.com/docs/foundry/contour/expressions-syntax/).
*   Learn about advanced features like [window functions](https://www.palantir.com/docs/foundry/contour/expressions-window-functions/).

[← PREVIOUS Datasets / Export logic to Pipeline Builder](https://www.palantir.com/docs/foundry/contour/convert-to-pipeline-builder/)

[NEXT Use the expression board →](https://www.palantir.com/docs/foundry/contour/expressions-use-board/)
