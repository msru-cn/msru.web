...
URL Source: https://www.palantir.com/docs/foundry/contour/analysis-parameterize/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#parameterize-your-analysis)Parameterize your analysis
...
## [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#creating-parameters)Creating parameters
...
![Image 12: creating-param](https://www.palantir.com/docs/resources/foundry/contour/analysis-create-parameter.png)
...
### [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#multi-value-parameters)Multi-value parameters
...
## [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#using-parameters-in-transformations)Using parameters in transformations
...
![Image 13: use-parameter-filter.png](https://www.palantir.com/docs/resources/foundry/contour/analysis-use-parameter-filter.png)
...
![Image 14: use-parameters-expression.png](https://www.palantir.com/docs/resources/foundry/contour/analysis-use-parameters-expression.png)

## [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#editing-parameters)Editing parameters
...
![Image 15: edit-parameter.png](https://www.palantir.com/docs/resources/foundry/contour/analysis-edit-parameter.png?width=300)
...
### [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#suggested-values)Suggested values
...
![Image 16: Enabling suggested values for a parameter](https://www.palantir.com/docs/resources/foundry/contour/analysis-parameter-suggested-values-switch.png?width=300)
...
![Image 17: Linking to the country column of a dataset](https://www.palantir.com/docs/resources/foundry/contour/analysis-parameter-linked-resource-column.png?width=600)
_The dataset in the screenshot above uses [open source data from the UN Food and Agriculture Organization ↗](https://empres-i.apps.fao.org/)._
...
![Image 18: Suggested values from the country parameter](https://www.palantir.com/docs/resources/foundry/contour/analysis-parameter-suggested-values.png?width=300)
### [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#cross-filter-groups)Cross-filter groups
...
![Image 19: Cross-filter group configuration](https://www.palantir.com/docs/resources/foundry/contour/analysis-parameter-suggested-values-group.png?width=300)
...
![Image 20: Adding a parameter to an existing group](https://www.palantir.com/docs/resources/foundry/contour/analysis-parameter-suggested-values-existing-group.png?width=300)
...
![Image 21: The suggested values for the country parameter have been filtered to Europe](https://www.palantir.com/docs/resources/foundry/contour/analysis-parameter-filtered-suggested-values.png?width=300)
...
## [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#overriding-parameter-values)Overriding parameter values
...
![Image 22: overriding-parameter.png](https://www.palantir.com/docs/resources/foundry/contour/analysis-overriding-parameter.png?width=300)
...
## [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#parameters-in-contour-dashboards)Parameters in Contour dashboards
...
In a Contour dashboard, users can override the values of parameters to see different views of their data. [Learn more about Contour dashboards.](https://www.palantir.com/docs/foundry/contour/dashboards-overview/)
...
## [](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/#parameters-in-foundry-reports)Parameters in Foundry Reports

Once you create a parameter inside a Contour analysis, you can also use it in the legacy [Foundry Reports](https://www.palantir.com/docs/foundry/reports/overview/) application. However, Reports does not support parameters linked to Restricted View columns, or cross-filter groups - these features are only available in Contour analyses and Contour dashboards. If you add a parameter linked to a Restricted View to a Report, no suggested values will be populated. If you add a parameter in a cross-filter group to a Report, by default the Report parameter will be linked to the same dataset column, but it will not be cross-filtered based on selections in other parameters in the Contour cross-filter group.

[← PREVIOUS Create a path](https://www.palantir.com/docs/foundry/contour/analysis-create-path/)

[NEXT Switch to aggregated data →](https://www.palantir.com/docs/foundry/contour/analysis-switch-aggregated/)
