...
URL Source: https://www.palantir.com/docs/foundry/contour/boards-map/
...
The map board uses _Mapbox_ as the primary source for its base map imagery. To learn more about web map technology, see the [Mapbox documentation ↗](https://docs.mapbox.com/help/getting-started/web-apps/).
...
*   [Point](https://www.palantir.com/docs/foundry/contour/boards-map/#point)
*   [Cluster](https://www.palantir.com/docs/foundry/contour/boards-map/#cluster)
*   [Choropleth](https://www.palantir.com/docs/foundry/contour/boards-map/#choropleth)
*   [Line segment](https://www.palantir.com/docs/foundry/contour/boards-map/#line-segment)
...
For configuration information, see the [configure point layers section](https://www.palantir.com/docs/foundry/contour/boards-map/#configure-point-layers) below.

![Image 1: Example: A map showing Airbnb locations in the Lower East Side neighborhood of Manhattan, colored by the room type.](https://www.palantir.com/docs/resources/foundry/contour/map_point_layer.png)
...
For configuration information, see the [configure cluster layers section](https://www.palantir.com/docs/foundry/contour/boards-map/#configure-cluster-layers) below.

![Image 2: Example: A map showing the distribution of Airbnb prices in Manhattan. Cluster size/colors are based off of the average price in the given area.](https://www.palantir.com/docs/resources/foundry/contour/map_cluster_layer.png)
...
For configuration information, see the [configure choropleth layers section](https://www.palantir.com/docs/foundry/contour/boards-map/#configure-choropleth-layers) below.

![Image 3: Example: A map of the continental United States, with each state colored according to the percentage of its total population that is fully vaccinated as of December 13, 2021.](https://www.palantir.com/docs/resources/foundry/contour/map_choropleth_layer.png)
...
For configuration information, see the [configure line segment layers](https://www.palantir.com/docs/foundry/contour/boards-map/#configure-line-segment-layers) below.

![Image 4: Example: A map of the United States, with line segments that start in the center of each state and end in California. The line segments are colored according to their distance from California.](https://www.palantir.com/docs/resources/foundry/contour/map_line_segment_layer.png)
...
![Image 5: A picture of the map board, with no configuration set. The map type is set to Point.](https://www.palantir.com/docs/resources/foundry/contour/map_default_config.png)

At the top of the configuration panel are a set of tabs: **Data** and **Format**.

*   The **Data** tab allows you to add and configure the [overlay layers](https://www.palantir.com/docs/foundry/contour/boards-map/#overlay-layer-types) of the map, which are described in the previous section.
...
![Image 6: An image of the data tab of the map board's configuration panel.](https://www.palantir.com/docs/resources/foundry/contour/map_data_tab.png?width=300px)
...
![Image 7: An image of the formatting tab of the map board.](https://www.palantir.com/docs/resources/foundry/contour/map_format_tab.png?width=300px)
...
![Image 8: An image of a map legend on the map board.](https://www.palantir.com/docs/resources/foundry/contour/map_legend.png?width=300)
...
*   Drawing a radial filter (see the [map drawings section](https://www.palantir.com/docs/foundry/contour/boards-map/#map-drawings)) will create a radial filter corresponding to the latitude and longitude columns selected in the configuration.
...
![Image 10: Example: A selection made on a Mapbox choropleth layer. The selection creates a filter, which reads: “Keep rows where feature_id = 332521”. feature_id is the column provided as the “Region ID column”, and 332521 is the Mapbox feature id corresponding to the selected shape (California).](https://www.palantir.com/docs/resources/foundry/contour/map_choropleth_filter.png).
...
![Image 11: Example: A selection made on a line segment layer. The selection creates a filter, which reads: “Keep rows where (Latitude = 38.5 AND end_Latitude = 36.778259 AND Longitude = -98 AND end_Longitude = -119.417931).” ](https://www.palantir.com/docs/resources/foundry/contour/map_line_filter.png)
...
![Image 12: An image of three buttons that toggle map drawings in the map board. From top to bottom, there is a button with a circle icon, a button with a line segment icon, and a button with a 'x' icon.](https://www.palantir.com/docs/resources/foundry/contour/map_drawing_buttons.png)
