...
URL Source: https://www.palantir.com/docs/foundry/contour/faq/

Markdown Content:
## Contour FAQ

The following are a few frequently asked questions about Contour. For general information, view our [Contour documentation](https://www.palantir.com/docs/foundry/contour/overview/).

*   [How do I start a new analysis?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-start-a-new-analysis)
*   [How do I look for relevant data in the platform?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-look-for-relevant-data-in-the-platform)
*   [How do I share an analysis with a coworker?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-share-an-analysis-with-a-coworker)
*   [How do I create an initial dataset on which to perform an analysis?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-create-an-initial-dataset-on-which-to-perform-an-analysis)
*   [How do I change the view of my analysis?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-change-the-view-of-my-analysis)
*   [How do I apply a calculation?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-apply-a-calculation)
*   [What are common Microsoft Excel analysis equivalents in Foundry?](https://www.palantir.com/docs/foundry/contour/faq/#what-are-common-microsoft-excel-analysis-equivalents-in-foundry)
*   [How do I create a pivot table?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-create-a-pivot-table)
*   [How do I apply a function across an entire series of data?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-apply-a-function-across-an-entire-series-of-data)
*   [What are common Microsoft Excel aggregate equivalents in Foundry?](https://www.palantir.com/docs/foundry/contour/faq/#what-are-common-microsoft-excel-aggregate-equivalents-in-foundry)
*   [What are some ways to check my analysis?](https://www.palantir.com/docs/foundry/contour/faq/#what-are-some-ways-to-check-my-analysis)
*   [What is the difference between saving a dataset in Contour and creating one in Code Repositories or Code Workbook?](https://www.palantir.com/docs/foundry/contour/faq/#what-is-the-difference-between-saving-a-dataset-in-contour-and-creating-one-in-code-repositories-or-code-workbook)
*   [When I attempt to export it gives me a 100,000 row limit. Is this correct?](https://www.palantir.com/docs/foundry/contour/faq/#when-i-attempt-to-export-it-gives-me-a-100000-row-limit-is-this-correct)
*   [Can I automatically update a Contour analysis path?](https://www.palantir.com/docs/foundry/contour/faq/#can-i-automatically-update-a-contour-analysis-path)
*   [Can I revert changes to my Contour analysis?](https://www.palantir.com/docs/foundry/contour/faq/#can-i-revert-changes-to-my-contour-analysis)
*   [When I try to duplicate my analysis, I just see a spinner and nothing happens. What do I do?](https://www.palantir.com/docs/foundry/contour/faq/#when-i-try-to-duplicate-my-analysis-i-just-see-a-spinner-and-nothing-happens-what-do-i-do)
*   [Unable to build dataset from Contour](https://www.palantir.com/docs/foundry/contour/faq/#unable-to-build-dataset-from-contour)
*   [Pivot Table not showing all data](https://www.palantir.com/docs/foundry/contour/faq/#pivot-table-not-showing-all-data)
*   [Duplicate column found in pivot table](https://www.palantir.com/docs/foundry/contour/faq/#duplicate-column-found-in-pivot-table)
*   [General performance issues](https://www.palantir.com/docs/foundry/contour/faq/#general-performance-issues)
*   [`count_distinct()` fails in a window function in the expression board](https://www.palantir.com/docs/foundry/contour/faq/#count_distinct-fails-in-a-window-function-in-the-expression-board)
...
[Return to top](https://www.palantir.com/docs/foundry/contour/faq/#contour-faq)
...
To see more filtering options, review our [filter data](https://www.palantir.com/docs/foundry/contour/boards-filter/) documentation.
...
*   **ADD** columns: See the **VLOOKUP** section in [common Excel analysis equivalents in Foundry](https://www.palantir.com/docs/foundry/contour/faq/#what-are-common-microsoft-excel-analysis-equivalents-in-foundry)

*   Create an automated Notepad document: You have the option to add your Contour analysis outputs into an automated [Notepad](https://www.palantir.com/docs/foundry/notepad/overview/) to present your data in executive summaries. This report will change based on the refreshed data in Foundry, removing any need to recreate the same report.
...
Below are some of the most common Microsoft Excel functions and their expression equivalents in Contour. You can apply these calculations in the same way as discussed in [How do I apply a calculation?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-apply-a-calculation).
...
Read [the expression board](https://www.palantir.com/docs/foundry/contour/expressions-use-board/) and [support expression syntax](https://www.palantir.com/docs/foundry/contour/expressions-syntax/) documentation for more information.

*   **Excel: VLOOKUP(value, table, col_index, [range_lookup]) & ADD in columns from other datasets**
    *   **Foundry:****JOIN** board.
    *   The join board lets you join your current working dataset to another dataset and merge the matching results into your data. Example: You are working with the dataset `flights` and you would like to add the column `manufacturer` and `number_of_seats` from the `aircraft` dataset.
...
![Image 1: Contour function configuration.](https://www.palantir.com/docs/resources/foundry/contour/contour-function-1.png)

*   Result:

![Image 2: Contour result.](https://www.palantir.com/docs/resources/foundry/contour/contour-result-1.png)
...
Below are some of the most common Excel aggregate functions and the Contour expression equivalents. You can apply these calculations in the same way as displayed in the [How do I apply a function across an entire series of data?](https://www.palantir.com/docs/foundry/contour/faq/#how-do-i-apply-a-function-across-an-entire-series-of-data) question.
...
![Image 3: Contour sum function setup.](https://www.palantir.com/docs/resources/foundry/contour/contour-sum-function.png)
...
*   **COUNT():** When you aggregate with the count function, this will count the number of entries of an aggregate column across specified column groupings.
    ...
    *   Function: ![Image 4: Contour configuration.](https://www.palantir.com/docs/resources/foundry/contour/contour-count-function.png)

    *   Result: ![Image 5: Contour count result.](https://www.palantir.com/docs/resources/foundry/contour/contour-count-result.png)
...
![Image 6: Contour undo option.](https://www.palantir.com/docs/resources/foundry/contour/tcs_contour_undo.png?width=250)
...
Review the section on [general performance issues](https://www.palantir.com/docs/foundry/contour/faq/#general-performance-issues) for more information.
...
Refer to our guidance on [builds and checks errors](https://www.palantir.com/docs/foundry/health-checks/builds-checks-faq/) for more information.
...
Pivot table previews do not show all the data within the table. The pivot table calculates aggregates over the _entire_ dataset, and reduces the output to the first 100 columns or 10,000 values to prevent slow browser performance. To get the definitive answer for these large pivot tables, you will need to **Switch to pivoted data**. You can read more about this in the [pivot table documentation](https://www.palantir.com/docs/foundry/contour/boards-descriptions/#pivot-table).
...
For further reading, review our [Contour analysis performance optimization](https://www.palantir.com/docs/foundry/contour/performance-optimize/) documentation.
