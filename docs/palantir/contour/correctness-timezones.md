...
URL Source: https://www.palantir.com/docs/foundry/contour/correctness-timezones/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/correctness-timezones/#time-zones-in-contour)Time zones in Contour

This page describes [time zone configurations](https://www.palantir.com/docs/foundry/contour/correctness-timezones/#time-zone-configurations) available for Contour, as well as Contour's [DateTime type](https://www.palantir.com/docs/foundry/contour/correctness-timezones/#datetime-type-in-contour).

## [](https://www.palantir.com/docs/foundry/contour/correctness-timezones/#time-zone-configurations)Time zone configurations
...
![Image 4: Setting the bucketing time zone in a chart board](https://www.palantir.com/docs/resources/foundry/contour/bucketing-timezone-setting.png)
...
![Image 5: Setting the visualization time zone of the analysis](https://www.palantir.com/docs/resources/foundry/contour/visualization-timezone-setting.png)
...
![Image 6: A chart board bucketed in EDT and displayed in UTC](https://www.palantir.com/docs/resources/foundry/contour/visualization-timezone-configured-chart.png)
...
## [](https://www.palantir.com/docs/foundry/contour/correctness-timezones/#datetime-type-in-contour)DateTime type in Contour
...
[← PREVIOUS Non-determinism in Contour](https://www.palantir.com/docs/foundry/contour/correctness-non-determinism/)

[NEXT Administration / Compute Usage →](https://www.palantir.com/docs/foundry/contour/compute-usage/)
