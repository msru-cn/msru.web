...
URL Source: https://www.palantir.com/docs/foundry/contour/analysis-create-path/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/analysis-create-path/#create-a-path)Create a path

In Contour, there are two types of datasets you can use to begin a new analysis path:

*   [Datasets saved on the platform](https://www.palantir.com/docs/foundry/contour/analysis-create-path/#starting-an-analysis-from-datasets-in-foundry)
*   [Results from a path in the current analysis](https://www.palantir.com/docs/foundry/contour/analysis-create-path/#using-resulting-datasets-to-begin-a-new-path)

* * *

## [](https://www.palantir.com/docs/foundry/contour/analysis-create-path/#starting-an-analysis-from-datasets-in-foundry)Starting an analysis from datasets in Foundry
...
![Image 4: start-an-analysis](https://www.palantir.com/docs/resources/foundry/contour/analysis-create-path.gif)

* * *

## [](https://www.palantir.com/docs/foundry/contour/analysis-create-path/#using-resulting-datasets-to-begin-a-new-path)Using resulting datasets to begin a new path
...
You can add a new path based on a resulting dataset by selecting the **+** symbol as shown in the screenshot below, or by selecting the ![Image 5: new path icon](https://www.palantir.com/docs/resources/foundry/contour/analysis-new-from-resulting.png) new path icon from within an existing path.

![Image 6: resulting dataset](https://www.palantir.com/docs/resources/foundry/contour/analysis-select-dataset.png)

* * *

Next, read about [adding a board](https://www.palantir.com/docs/foundry/contour/boards-add/) to your Path.

[← PREVIOUS FAQ](https://www.palantir.com/docs/foundry/contour/faq/)

[NEXT Parameterize your analysis →](https://www.palantir.com/docs/foundry/contour/analysis-parameterize/)
