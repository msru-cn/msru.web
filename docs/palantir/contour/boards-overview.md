...
URL Source: https://www.palantir.com/docs/foundry/contour/boards-overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/boards-overview/#boards)Boards
...
![Image 2: boards-toolbar-overview](https://www.palantir.com/docs/resources/foundry/contour/boards-toolbar-overview.png)

Next steps:

*   For a guided tutorial to several boards, see [Getting started](https://www.palantir.com/docs/foundry/contour/getting-started/).
*   [Learn more about how to add boards from the toolbar.](https://www.palantir.com/docs/foundry/contour/boards-add/)
*   See the [board descriptions](https://www.palantir.com/docs/foundry/contour/boards-descriptions/) for details on all Contour boards.

[← PREVIOUS Analysis / Share results](https://www.palantir.com/docs/foundry/contour/analysis-share-results/)

[NEXT Add a board →](https://www.palantir.com/docs/foundry/contour/boards-add/)
