...
URL Source: https://www.palantir.com/docs/foundry/contour/performance-optimize/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#optimizing-your-analysis)Optimizing your analysis

Follow the suggestions below to improve the performance of your Contour Analysis and Dashboard.

* * *

## [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#structuring-your-analysis)Structuring your analysis

### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#minimizing-duplicated-logic)Minimizing duplicated logic
...
### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#joining)Joining
...
### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#joining-on-multiple-conditions-with-any-match)Joining on multiple conditions with "any match"
...
### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#saving-as-a-dataset)Saving as a dataset
...
### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#using-parameters)Using parameters
...
### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#frontend-performance)Frontend performance
...
## [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#using-filters)Using filters

### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#use-specific-filters-as-much-as-possible)Use specific filters as much as possible
...
![Image 5: filter-1](https://www.palantir.com/docs/resources/foundry/contour/performance-filtering-case-sensitive.png)

### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#apply-the-correct-filters-for-the-column-types)Apply the correct filters for the column types
...
![Image 6: filter-2](https://www.palantir.com/docs/resources/foundry/contour/performance-apply-correct-filter.png)

* * *

## [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#input-datasets)Input datasets

### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#partitioning)Partitioning
...
![Image 7: number-partitions](https://www.palantir.com/docs/resources/foundry/contour/performance-number-partitions.png)
...
For more information on Partitioning and its effects in Spark, review the [Spark optimization concepts](https://www.palantir.com/docs/foundry/optimizing-pipelines/spark-concepts/).

### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#projections)Projections

Dataset owners can [configure projections](https://www.palantir.com/docs/foundry/optimizing-pipelines/projections-overview/) on their datasets to improve the performance of various types of queries.
...
![Image 8: contour-projection-alert](https://www.palantir.com/docs/resources/foundry/contour/contour-projection-alert.png)
...
## [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#maintaining-and-sharing-your-analysis)Maintaining and sharing your analysis

All optimizations mentioned above will be especially important if your Contour analysis is consumed by a large audience.

### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#scheduling-builds)Scheduling builds
...
### [](https://www.palantir.com/docs/foundry/contour/performance-optimize/#limiting-parameters)Limiting parameters
...
[← PREVIOUS Expressions / Window functions](https://www.palantir.com/docs/foundry/contour/expressions-window-functions/)

[NEXT Non-determinism in Contour →](https://www.palantir.com/docs/foundry/contour/correctness-non-determinism/)
