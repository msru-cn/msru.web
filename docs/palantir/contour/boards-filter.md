...
URL Source: https://www.palantir.com/docs/foundry/contour/boards-filter/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/contour/boards-filter/#filter-data)Filter data

You can use many of Contour's visualization boards to filter as well as visualize data. This document explores how to use the histogram, filter, and chart boards to do so. Advanced users may want to look at Contour’s [expression language](https://www.palantir.com/docs/foundry/contour/expressions-overview/) for more powerful filtering options. The screenshots on this page use open source aviation data.

* * *

## [](https://www.palantir.com/docs/foundry/contour/boards-filter/#histogram-board)Histogram board
...
![Image 11: Animation of histogram filter board](https://www.palantir.com/docs/resources/foundry/contour/boards-histogram-filter.gif)

After selecting bars in the histogram, the bottom of the histogram will say **Keep rows where `column_name` is `value`**. This tells you that your working dataset has been filtered down to just the rows that have that value in that particular column. (You can use the dropdown selector to change **Keep** to **Remove** if you want to keep only rows that do _not_ have that value.)

You can use multiple histograms in sequence to perform more complex filtering:

![Image 12: histogram-2](https://www.palantir.com/docs/resources/foundry/contour/boards-histogram-2.png)

* * *

## [](https://www.palantir.com/docs/foundry/contour/boards-filter/#filter-board)Filter board
...
![Image 13: filter-1](https://www.palantir.com/docs/resources/foundry/contour/boards-filter-1.png)
...
![Image 14: Animation of "keep" filter](https://www.palantir.com/docs/resources/foundry/contour/boards-filter-keep.gif)

Use **Remove** if you want to exclude only data that meet the set criteria, as shown below:

![Image 15: Animation of "remove" filter](https://www.palantir.com/docs/resources/foundry/contour/boards-filter-remove.gif)

### [](https://www.palantir.com/docs/foundry/contour/boards-filter/#advanced-comparisons)Advanced comparisons
...
![Image 16: filter-types](https://www.palantir.com/docs/resources/foundry/contour/boards-filter-types.gif)
...
![Image 17: filter-types-2](https://www.palantir.com/docs/resources/foundry/contour/boards-filter-types-2.png)

### [](https://www.palantir.com/docs/foundry/contour/boards-filter/#multiple-data-filters)Multiple data filters
...
![Image 18: contour-filter-matching](https://www.palantir.com/docs/resources/foundry/contour/boards-filter-matching.gif)

### [](https://www.palantir.com/docs/foundry/contour/boards-filter/#adjusting-filters)Adjusting filters
...
### [](https://www.palantir.com/docs/foundry/contour/boards-filter/#wildcards-in-string-filters)Wildcards in string filters
...
## [](https://www.palantir.com/docs/foundry/contour/boards-filter/#chart-board)Chart board
...
![Image 19: Example chart board](https://www.palantir.com/docs/resources/foundry/contour/boards-chart-1.png)

Hover the mouse cursor over a piece of data to see a key with the exact figure:

![Image 20: Example chart board with hoverover](https://www.palantir.com/docs/resources/foundry/contour/boards-chart-2.png)

[← PREVIOUS Add a board](https://www.palantir.com/docs/foundry/contour/boards-add/)

[NEXT Join datasets →](https://www.palantir.com/docs/foundry/contour/boards-join/)
