...
URL Source: https://www.palantir.com/docs/foundry/foundry-devops/input-presets/
...
![Image 1: Packaging options for source presets](https://www.palantir.com/docs/resources/foundry/foundry-devops/input-preset-source.png)![Image 2: Packaging options for override presets](https://www.palantir.com/docs/resources/foundry/foundry-devops/input-preset-override.png)
...
Some preset types (for example, Ontology entities) use API-name based presets, which means they will be looked-up in the target installation location (space and ontology). Review [Cross-environment compatibility](https://www.palantir.com/docs/foundry/foundry-devops/input-presets/#cross-environment-compatibility) for more details.
...
![Image 3: Installation view when input has presets](https://www.palantir.com/docs/resources/foundry/foundry-devops/input-preset-installation.png)
...
![Image 4: API name of preset shown during packaging](https://www.palantir.com/docs/resources/foundry/foundry-devops/input-preset-api-name.png)
