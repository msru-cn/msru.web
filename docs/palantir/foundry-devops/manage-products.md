...
URL Source: https://www.palantir.com/docs/foundry/foundry-devops/manage-products/
...
![Image 1: View of published products.](https://www.palantir.com/docs/resources/foundry/foundry-devops/published-products.png)
...
![Image 2: Product overview page.](https://www.palantir.com/docs/resources/foundry/foundry-devops/product-overview.png)

The product page displays all the product's versions in a table, where you can access each version's respective page.

![Image 3: Product version table.](https://www.palantir.com/docs/resources/foundry/foundry-devops/product-version-table.png)

To create a new version, select **Start new version** from the top-right of the product page.

![Image 4: "Start new version" option is shown as located next to product name.](https://www.palantir.com/docs/resources/foundry/foundry-devops/start-new-version.png)
...
![Image 5: version page](https://www.palantir.com/docs/resources/foundry/foundry-devops/version-page.png)

## Release channels

You can tag product versions with [release channels](https://www.palantir.com/docs/foundry/foundry-devops/manage-products/#release-channels) in order to push a specific version out to relevant installations tracking each channel. Each version can be tagged as **Release**, **Pre-stable**, or **Stable**. Each installation tracks a release channel, and by default, all installations are set to track the **Release** release channel. This setting can be found in the [installation settings](https://www.palantir.com/docs/foundry/marketplace/installations/#installation-settings) during install.
...
![Image 6: Channel selection dropdown menu.](https://www.palantir.com/docs/resources/foundry/foundry-devops/set-release-channel.png)
...
A Maven coordinate uniquely identifies a product for publishing to [connected Apollo hubs](https://www.palantir.com/docs/foundry/administration/connected-hubs/). The coordinate is built from four parts:
...
| Namespace identifier | `my-namespace` | **[Space management](https://www.palantir.com/docs/foundry/platform-security-management/manage-orgs-and-spaces/)** extension in Control Panel |
...
![Image 7: Deprecate product option.](https://www.palantir.com/docs/resources/foundry/foundry-devops/deprecate-product.png)
...
![Image 8: The recall version table from the product overview page.](https://www.palantir.com/docs/resources/foundry/foundry-devops/recall-version-product-table.png)

You can also recall a version directly from the product version page, as shown below.

![Image 9: Recall a version from the product version page.](https://www.palantir.com/docs/resources/foundry/foundry-devops/recall-version-product-version.png)
