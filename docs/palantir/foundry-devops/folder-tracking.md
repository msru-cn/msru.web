...
URL Source: https://www.palantir.com/docs/foundry/foundry-devops/folder-tracking/
...
This feature is useful when you have a well-defined [project](https://www.palantir.com/docs/foundry/security/projects-and-roles/) that contains all the outputs you want to include in your product.
...
![Image 1: The Draft product creation page is displayed.](https://www.palantir.com/docs/resources/foundry/foundry-devops/creation-landing-page.png)

Select the folder that will be used as the source, and configure the initial settings that will be used to create the product. ![Image 2: Folder tracking configuration is displayed.](https://www.palantir.com/docs/resources/foundry/foundry-devops/configure-folder-tracking.png)

## Discovery settings

By default, all files in the project will be included in your product. For files that are not present in the [Compass filesystem](https://www.palantir.com/docs/foundry/compass/overview/), you can use settings to automatically track related resources. For example, you can track all health checks that exist on the datasets in the project.
...
![Image 3: Folder tracking settings view.](https://www.palantir.com/docs/resources/foundry/foundry-devops/folder-tracking-edit.png)
...
![Image 4: Refresh all resources option.](https://www.palantir.com/docs/resources/foundry/foundry-devops/refresh-all.png)
...
You can [manually add outputs](https://www.palantir.com/docs/foundry/foundry-devops/create-products/#add-outputs) using the **Add output** dropdown in the top right. This may be necessary to add resources that do not exist within the Compass filesystem, and that are not covered by [discovery settings](https://www.palantir.com/docs/foundry/foundry-devops/folder-tracking/#discovery-settings).
...
![Image 5: The Details panel displays the ability to Edit versions or configuration.](https://www.palantir.com/docs/resources/foundry/foundry-devops/edit-details-panel.png)

### Stale overrides

Over time your product may accumulate stale overrides. This can happen for the following reasons:

1.   There is a resource that was previously a **Manually added output** and is now tracked as part of your source folder. For example, an object type that was initially [manually added](https://www.palantir.com/docs/foundry/foundry-devops/folder-tracking/#manual-overrides), but since [migrated to Project based permissions](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/).
2.   There is a resource with an unnecessary override, because it matches the default configuration or latest version.

You can select the **Stale overrides** warning in the outputs row to clean them up. ![Image 6: The stale overrides modal allows users to clean up unnecessary overrides.](https://www.palantir.com/docs/resources/foundry/foundry-devops/stale-overrides.png)
...
To disable strict folder tracking, select **Edit** in the folder tracking banner and disable the **Strict folder tracking** option. This will allow you to manually add outputs and override configurations as described in [Manual overrides](https://www.palantir.com/docs/foundry/foundry-devops/folder-tracking/#manual-overrides).
...
![Image 7: The Outputs panel displays the ability to group outputs by destination folder.](https://www.palantir.com/docs/resources/foundry/foundry-devops/group-by-folder.png)

1.   Under **Actions**, choose the **Migrate to folder** option.

![Image 8: Migrate to folder tracking option.](https://www.palantir.com/docs/resources/foundry/foundry-devops/migrate-to-folder-tracking.png)

1.   Choose the source folder you want to start tracking.

![Image 9: Migrate to folder tracking settings.](https://www.palantir.com/docs/resources/foundry/foundry-devops/migrate-to-folder-tracking-page.png)

1.   The migration dialog will show you a preview of the migration. This preview includes resources that will now be tracked as part of the resource. It will also include resources that will continue to be manually tracked, as they are not within the Compass filesystem, for example, Ontology entities that have not been [migrated to Project based permissions](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/).

![Image 10: Migrate to folder tracking preview.](https://www.palantir.com/docs/resources/foundry/foundry-devops/migrate-to-folder-tracking-page-2.png)
...
![Image 11: Disable folder tracking preview.](https://www.palantir.com/docs/resources/foundry/foundry-devops/disable-folder-tracking.png)
