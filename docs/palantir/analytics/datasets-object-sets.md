...
# [](https://www.palantir.com/docs/foundry/analytics/datasets-object-sets/#datasets-and-object-sets)Datasets and object sets

## [](https://www.palantir.com/docs/foundry/analytics/datasets-object-sets/#datasets)Datasets
...
You can choose to save the results of Code Workbook transformations as a dataset by selecting **Save as dataset**. By default, new transforms are not saved as datasets. [Learn more about saving a dataset from Code Workbook.](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/)
...
### [](https://www.palantir.com/docs/foundry/analytics/datasets-object-sets/#when-are-code-repositories-a-better-fit)When are Code Repositories a better fit?

We recommend using the [Code Repositories](https://www.palantir.com/docs/foundry/code-repositories/overview/) application to create robust production pipelines and support workflows that require an additional layer of governance and monitoring. With Code Repositories, data engineers can create efficient pipelines in bulk.
...
## [](https://www.palantir.com/docs/foundry/analytics/datasets-object-sets/#object-sets)Object sets
...
To export an object set, open the editor of the object set card by clicking the ![Image 8: Settings icon](https://www.palantir.com/docs/resources/foundry/analytics/gear.png?width=30px) icon in the upper-right corner of the card, and navigate to the Export tab.
...
Read more on [how to import and export object sets in Quiver](https://www.palantir.com/docs/foundry/quiver/objects-overview/).

Object sets can also be saved, updated, and compared in Object Explorer. Read more on how to save object sets in [Object Explorer](https://www.palantir.com/docs/foundry/object-explorer/overview/).

[← PREVIOUS Models](https://www.palantir.com/docs/foundry/analytics/models/)

[NEXT Exporting outputs →](https://www.palantir.com/docs/foundry/analytics/exporting-outputs/)
