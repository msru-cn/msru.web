...
URL Source: https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/

Published Time: Thu, 09 Jul 2026 17:47:54 GMT

# [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#drag-and-drop)Drag and drop
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#set-up-drag-and-drop-behavior)Set up drag-and-drop behavior
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#set-up-instructions)Set up instructions
...
![Image 4: Setting up Drag and Drop.](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/configuring-drag-and-drop.gif?width=800)
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#drag-and-drop-behavior-customizations)Drag-and-drop behavior customizations

You can customize the drag-and-drop behavior beyond the simple configuration described in the previous section.

### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#update-snap-behavior)Update snap behavior
...
![Image 5: Setting up Snap Behavior.](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/schedule-layer-snap-behavior.gif?width=800)
### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#advanced-save-handler-action-type)Advanced save handler action type
...
### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/#suggestion-function)Suggestion function
...
Review [Suggestion functions](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-suggestion-functions/) for more information.

![Image 6: Setting up snap behavior.](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/drag-and-drop-suggestion-function.gif?width=800)

[← PREVIOUS Drag to create](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-to-create/)

[NEXT Program Scheduling widget / Overview →](https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-overview/)
