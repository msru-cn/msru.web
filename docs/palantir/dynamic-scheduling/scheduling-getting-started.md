...
URL Source: https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-getting-started/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-getting-started/#getting-started)Getting started
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-getting-started/#1-create-core-ontology-objects)1. Create core Ontology objects
...
*   Create a save handler action for each `Schedule`. See [drag and drop](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/) for more information. 
...
Review the [dynamic scheduling Ontology primitives documentation](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-ontology-primitives/) for more information about the schema of each object type.

## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-getting-started/#2-configure-the-widget-in-workshop)2. Configure the widget in Workshop
...
Review the [scheduling Gantt chart widget documentation](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-gantt-chart-widget/) for more information.

[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-overview/)

[NEXT Core concepts →](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-concepts/)
