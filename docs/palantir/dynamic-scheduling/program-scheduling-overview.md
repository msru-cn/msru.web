...
URL Source: https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-overview/#program-scheduling-widget)Program Scheduling widget
...
![Image 3: Program Scheduling widget example: Displaying tasks grouped by project phase with dependency arrows between deliverables.](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/scheduling-table.png?width=800)
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-overview/#puck-types)Puck types
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-overview/#dependencies)Dependencies
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-overview/#widget-layout)Widget layout

The image below provides an overview of the full widget layout.

![Image 4: Overview of the Program Scheduling widget layout.](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/scheduling-table-layout.png?width=1000)
...
[← PREVIOUS Schedule layer-level interactions / Drag and drop](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-drag-and-drop/)

[NEXT Widget configuration →](https://www.palantir.com/docs/foundry/dynamic-scheduling/program-scheduling-configuration/)
