...
URL Source: https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-row-level-interactions-overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-row-level-interactions-overview/#row-level-interactions)Row-level interactions
...
![Image 2: Example of row-level interactions.](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/row-level-interactions.gif)

[← PREVIOUS Inline metrics](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-inline-metrics/)

[NEXT Triggering actions and events →](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-row-level-triggering-actions-and-events/)
