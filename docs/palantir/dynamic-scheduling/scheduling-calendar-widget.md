...
URL Source: https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#widget-configuration)Widget configuration

## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#widget-modes)Widget modes
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#input-data-pucks)Input data (pucks)
...
*   **Enable Drag to Create (Dynamic mode):** Select an action to let end users create new schedule objects by dragging across empty space on the calendar. See [Drag to create](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#drag-to-create) for setup and usage details.

![Image 3: Configuration of data layer](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/calendar_data_layer_config.png)

### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#display-configuration)Display configuration
...
![Image 4: Display configuration panel](https://www.palantir.com/docs/resources/foundry/dynamic-scheduling/calendar_config.png)

## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#drag-to-create)Drag to create
...
### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#set-up-drag-to-create-behavior)Set up drag-to-create behavior
...
### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#use)Use
...
## [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#common-configuration-issues)Common configuration issues

### [](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-widget/#error-the-action-parameter-ids-must-align-with-the-ids-of-the-selected-properties)Error: "The action parameter ids must align with the ids of the selected properties"
...
2.   Check your action parameter IDs: 
    ...
    *   Parameter names can differ, but the _parameter IDs_ must be identical to property IDs.
...
[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/dynamic-scheduling/scheduling-calendar-overview/)

[NEXT Ontology architecture / Overview and getting started / Overview →](https://www.palantir.com/docs/foundry/object-backend/overview/)
