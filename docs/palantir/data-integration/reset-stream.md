...
URL Source: https://www.palantir.com/docs/foundry/data-integration/reset-stream/

Published Time: Thu, 09 Jul 2026 17:47:54 GMT

# [](https://www.palantir.com/docs/foundry/data-integration/reset-stream/#reset-stream)Reset stream
...
*   [Push-based ingestion](https://www.palantir.com/docs/foundry/data-connection/push-based-ingestion/) requires updating the POST URL to reference the new stream `viewRid` value.
*   [Magritte-based ingestion](https://www.palantir.com/docs/foundry/data-connection/set-up-streaming-sync/) requires an agent rebuild.
...
![Image 3: Stream connection details.](https://www.palantir.com/docs/resources/foundry/data-integration/reset-stream-open.png)
...
![Image 4: Stream connection reset view.](https://www.palantir.com/docs/resources/foundry/data-integration/reset-stream-page.png)
1.   Select **Reset stream** to initiate the stream reset.

[← PREVIOUS Flink fundamentals](https://www.palantir.com/docs/foundry/data-integration/flink-streaming/)

[NEXT Stream monitoring →](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/)
