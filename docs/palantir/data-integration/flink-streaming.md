...
URL Source: https://www.palantir.com/docs/foundry/data-integration/flink-streaming/

Published Time: Thu, 09 Jul 2026 17:47:54 GMT

# [](https://www.palantir.com/docs/foundry/data-integration/flink-streaming/#flink-fundamentals)Flink fundamentals
...
## [](https://www.palantir.com/docs/foundry/data-integration/flink-streaming/#flink-jobs)Flink jobs
...
## [](https://www.palantir.com/docs/foundry/data-integration/flink-streaming/#job-managers-and-task-managers)Job Managers and Task Managers
...
## [](https://www.palantir.com/docs/foundry/data-integration/flink-streaming/#job-state)Job state

While some Flink operations only need to look at single events in isolation, others need to remember information across multiple events. These are [stateful operations](https://www.palantir.com/docs/foundry/pipeline-builder/breaking-changes/). Some examples of stateful operations are:
...
The information required for stateful operations is known as _job state_, and is stored by Flink using a state backend. State is managed and stored by Task Managers and coordinated by the Job Manager in the form of [checkpoints](https://www.palantir.com/docs/foundry/data-integration/streams/#checkpointing). When you have a larger state (such as when an aggregation or join has a very large window), your Job Managers and Task Managers may require additional resources.

[← PREVIOUS Streaming](https://www.palantir.com/docs/foundry/data-integration/streaming-guide/)

[NEXT Reset stream →](https://www.palantir.com/docs/foundry/data-integration/reset-stream/)
