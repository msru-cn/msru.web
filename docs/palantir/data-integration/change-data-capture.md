...
URL Source: https://www.palantir.com/docs/foundry/data-integration/change-data-capture/
...
Foundry supports syncing, processing, and storing data from systems that produce change data capture feeds. Components throughout the platform, including [data connectors](https://www.palantir.com/docs/foundry/data-connection/set-up-source/), [streams](https://www.palantir.com/docs/foundry/data-integration/streams/), [pipelines](https://www.palantir.com/docs/foundry/building-pipelines/overview/), and the [Foundry Ontology](https://www.palantir.com/docs/foundry/ontology/overview/) can all work natively with this changelog data using the metadata configured on the [schema](https://www.palantir.com/docs/foundry/data-integration/datasets/#schemas) of the underlying data.
...
| --- | --- |
| [Data Connection](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#change-data-capture-in-data-connection) | CDC support available for syncs (source-system dependent) |
| [Ontology](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#change-data-capture-in-the-ontology) | CDC indexing for batch- and stream-backed objects |
| [Pipeline Builder](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#change-data-capture-in-pipeline-builder) | Full CDC stream processing and partial CDC streams with backfill |
| [Streams](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#change-data-capture-in-streams) | Full CDC support for live and archive views |
| Transforms | Append-only [incremental](https://www.palantir.com/docs/foundry/transforms-python/incremental-overview/) for datasets, full [changelog incremental](https://www.palantir.com/docs/foundry/iceberg/changelogs/) available for [Iceberg tables](https://www.palantir.com/docs/foundry/data-integration/iceberg-tables/) |
| [Workshop](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#change-data-capture-in-workshop) | Auto-refresh available for frequently updating objects |
...
If you have changelog-shaped data available from other sources, such as Kafka, Kinesis, Amazon SQS, or push-based integration with streams, read how to manually configure changelog metadata using the key-by board in [Pipeline Builder](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#change-data-capture-in-pipeline-builder).
...
![Image 1: A new source page for CDC data in Data Connection.](https://www.palantir.com/docs/resources/foundry/data-integration/cdc-new-sql-server-source.png)

### Create a change data capture sync

On the source overview page, you will find an empty table of **CDC Syncs**.

![Image 2: The CDC Syncs section on the overview page of an example Microsoft SQL Server source, outlined in a red rectangle. ](https://www.palantir.com/docs/resources/foundry/data-integration/cdc-data-connection-source-overview.png)
...
![Image 4: The CDC settings section on the CDC syncs page of a Microsoft SQL Server source.](https://www.palantir.com/docs/resources/foundry/data-integration/cdc-settings.png)

Foundry’s default CDC configuration is designed to provide a frictionless setup and minimize disruptions on your source systems. However, we strongly recommend reviewing the [specific default behaviors](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#default-cdc-behavior) for your connector, particularly its [snapshot mode](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/#snapshot-mode-considerations), to ensure these defaults align with your data requirements.
...
![Image 5: The dropdown menu to switch between live and archive views, located in the upper left corner of the page.](https://www.palantir.com/docs/resources/foundry/data-integration/cdc-live-archive-view-on-stream.png)

The schema will display changelog metadata as a primary key resolution strategy in the details view.

![Image 6: Streaming change data capture schema with resolution strategy. ](https://www.palantir.com/docs/resources/foundry/data-integration/cdc-dataset-schema-primary-key-resolution.png)
...
![Image 7: The Key By board in Pipeline Builder. ](https://www.palantir.com/docs/resources/foundry/data-integration/cdc-builder-key-by-board.png)

## Change data capture in the Ontology

The Ontology uses changelog metadata to index data into object types in [Object Storage V2](https://www.palantir.com/docs/foundry/object-backend/overview/) that are backed by a streaming data source. The data arriving in the stream is resolved and indexed into a latest current view that is available when querying the Ontology (to display in a Workshop module, for example).

If [retention](https://www.palantir.com/docs/foundry/retention/overview/) is configured on a data source with changelog metadata, any records that do not receive updates within the retention window time will disappear from the Ontology.
