...
URL Source: https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#stream-monitoring)Stream monitoring
...
*   Regularly persisting state, regardless of the presence of incoming records. This is _only_ applicable for pipelines.
...
## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#creating-monitors)Creating monitors
...
## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#configuring-ingest-monitors)Configuring ingest monitors
...
1.   Follow the [creating monitors](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#creating-monitors) instructions.
...
## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#configuring-pipeline-monitors)Configuring pipeline monitors

You can follow the same workflow used to [configure ingest monitors](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#configuring-ingest-monitors) for pipeline monitors, but there are some notable differences in the monitors available for streaming pipelines outlined below.

### [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#checkpoint-metrics)Checkpoint metrics

*   `Checkpoint Liveness`: Alerts if a stream has not checkpointed in the configured amount of time. This monitor is _highly recommended_ for production streams, as it is a high-signal indicator of a degraded performance. [Learn more about checkpointing.](https://www.palantir.com/docs/foundry/data-integration/streams/#checkpointing)
...
### [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#performance-metrics)Performance metrics
...
*   `Utilization`: Alerts if the percentage of the stream's utilized capacity is above a set threshold, which you can configure using [streaming profiles](https://www.palantir.com/docs/foundry/data-integration/streaming-profiles/).

## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#configuring-output-monitors)Configuring output monitors
...
While stream monitoring is in the beta phase, [time series](https://www.palantir.com/docs/foundry/time-series/time-series-overview/) and [geotemporal series](https://www.palantir.com/docs/foundry/geospatial/geotemporal-series-overview/) are the only data formats able to be monitored.

### [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#time-series)Time series

To monitor records written to [time series](https://www.palantir.com/docs/foundry/time-series/time-series-overview/), you will set alerts on the time series sync.
...
### [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#geotemporal-observations)Geotemporal observations

To monitor [geotemporal observations](https://www.palantir.com/docs/foundry/geospatial/geotemporal-series-overview/), you will set alerts on the backing observation dataset.
...
## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#viewing-metrics)Viewing metrics
...
![Image 4: View stream monitor metrics](https://www.palantir.com/docs/resources/foundry/data-integration/stream-monitoring-metrics.gif)

## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#monitor-notifications)Monitor notifications
...
![Image 5: Monitor notifications](https://www.palantir.com/docs/resources/foundry/data-integration/stream-monitoring-notifications.png)

## [](https://www.palantir.com/docs/foundry/data-integration/stream-monitoring/#firing-alerts)Firing alerts

You can view firing alerts in the **Troubleshoot alerts** tab of your monitoring view.

![Image 6: Firing alerts](https://www.palantir.com/docs/resources/foundry/data-integration/stream-monitoring-firing-alerts.png)

[← PREVIOUS Reset stream](https://www.palantir.com/docs/foundry/data-integration/reset-stream/)

[NEXT Streaming profiles →](https://www.palantir.com/docs/foundry/data-integration/streaming-profiles/)
