...
URL Source: https://www.palantir.com/docs/foundry/data-lineage/overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-lineage/overview/#data-lineage)Data Lineage

**Data Lineage** is an interactive tool that facilitates a holistic view of how data flows through the Foundry platform.

![Image 2: Data Lineage flow animation](https://www.palantir.com/docs/resources/foundry/data-lineage/data-lineage-flow.gif)
...
*   Explore [pipelines](https://www.palantir.com/docs/foundry/data-integration/data-pipeline/) through a powerful interface 
...
[← PREVIOUS Code Repositories / Administer repositories / Compute Usage](https://www.palantir.com/docs/foundry/code-repositories/compute-usage/)

[NEXT Navigation →](https://www.palantir.com/docs/foundry/data-lineage/navigation/)
