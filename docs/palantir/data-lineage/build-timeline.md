...
URL Source: https://www.palantir.com/docs/foundry/data-lineage/build-timeline/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-lineage/build-timeline/#view-build-timeline)View build timeline
...
![Image 3: View build timeline in Data Lineage](https://www.palantir.com/docs/resources/foundry/data-lineage/build-timeline.png)
...
![Image 4: View job details in build timeline](https://www.palantir.com/docs/resources/foundry/data-lineage/job-details-window.png)

See more details about the build, job, and schedule by clicking on the links within the job information window.

[← PREVIOUS View dataset preview and logic](https://www.palantir.com/docs/foundry/data-lineage/dataset-preview-logic/)

[NEXT Understand out-of-date datasets →](https://www.palantir.com/docs/foundry/data-lineage/stale-datasets/)
