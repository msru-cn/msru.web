...
URL Source: https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#branching-data-lineage)Branching data lineage
...
## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#select-a-branch)Select a branch
...
![Image 6: The Data Lineage branch selector with the global branches tab open, listing available branches.](https://www.palantir.com/docs/resources/foundry/data-lineage/branch-selector-global-branches.png)
...
## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#view-branch-aware-lineage)View branch-aware lineage
...
![Image 7: Data Lineage graph displaying branch-aware datasets, ontology entities, and the links between them on a global branch.](https://www.palantir.com/docs/resources/foundry/data-lineage/lineage-graph-on-branch.png)
...
## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#search-for-entities-on-a-branch)Search for entities on a branch
...
![Image 8: Branch-aware search in Data Lineage returning an ontology entity that exists only on the selected global branch.](https://www.palantir.com/docs/resources/foundry/data-lineage/branch-aware-search.png)

## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#view-entities-modified-on-your-branch)View entities modified on your branch
...
![Image 9: Search panel callout offering to add all entities modified on the selected global branch to the lineage graph.](https://www.palantir.com/docs/resources/foundry/data-lineage/modified-entities-callout.png)

## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#node-details-and-previews)Node details and previews
...
![Image 10: Data Lineage side panel showing branch-specific metadata and properties for a selected ontology entity node.](https://www.palantir.com/docs/resources/foundry/data-lineage/node-details-on-branch.png)

## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#colorings-and-badges)Colorings and badges

Node [colorings](https://www.palantir.com/docs/foundry/data-lineage/node-coloring/) and badges in Data Lineage are branch-aware when a global branch is selected. Coloring options that depend on ontology metadata or dataset properties will reflect the state of the selected branch.

## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#saved-graphs)Saved graphs
...
## [](https://www.palantir.com/docs/foundry/data-lineage/branching-data-lineage/#known-limitations)Known limitations
...
[← PREVIOUS Navigation](https://www.palantir.com/docs/foundry/data-lineage/navigation/)

[NEXT FAQ →](https://www.palantir.com/docs/foundry/data-lineage/faq/)
