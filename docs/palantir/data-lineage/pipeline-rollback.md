...
URL Source: https://www.palantir.com/docs/foundry/data-lineage/pipeline-rollback/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/data-lineage/pipeline-rollback/#roll-back-a-pipeline-planned-deprecation)Roll back a pipeline [Planned deprecation]

Planned deprecation

Rolling back a pipeline is in the [planned deprecation](https://www.palantir.com/docs/foundry/platform-overview/development-life-cycle/) phase of development and will be unavailable for use after November 30th. We recommend using the [roll back a dataset](https://www.palantir.com/docs/foundry/data-lineage/dataset-rollback/) feature instead.

When building your pipeline, you may need to roll back a [dataset](https://www.palantir.com/docs/foundry/data-integration/datasets/) and all of its downstream dependents to an earlier version. There can be many reasons for this, including the following:
...
## [](https://www.palantir.com/docs/foundry/data-lineage/pipeline-rollback/#execute-a-pipeline-rollback)Execute a pipeline rollback

1.   Navigate to a [Data Lineage](https://www.palantir.com/docs/foundry/data-lineage/overview/) graph containing the upstream dataset you would like to roll back.
...
![Image 11: The "View node properties" panel.](https://www.palantir.com/docs/resources/foundry/data-lineage/click-rollback.png)

1.   Select **Actions**, then **Rollback**.
2.   Under **Selected transaction**, choose the transaction to which you would like to roll back.

![Image 12: Choose the transaction to which you would like to roll back.](https://www.palantir.com/docs/resources/foundry/data-lineage/select-transaction.png)
...
1.   Select the timestamp under each dataset to navigate to the [**History** page](https://www.palantir.com/docs/foundry/dataset-preview/overview/#history) of the input, where the corresponding transaction will be highlighted.

![Image 13: Preview the state of your pipeline after a rollback.](https://www.palantir.com/docs/resources/foundry/data-lineage/preview-rollback-panel.png)
...
![Image 14: Exclude a dataset from rollback.](https://www.palantir.com/docs/resources/foundry/data-lineage/exclude-from-rollback.png)

1.   To add an excluded dataset back to the rollback, select **+** to the right of the dataset name.

![Image 15: Add an excluded dataset back for rollback.](https://www.palantir.com/docs/resources/foundry/data-lineage/add-to-rollback.png)

1.   After finalizing the state of your desired rollback, select **Rollback**. A confirmation dialog will appear.

![Image 16: Confirm the rollback.](https://www.palantir.com/docs/resources/foundry/data-lineage/rollback-confirmation-required.png)

1.   Enter the branch name as confirmation, then select **Confirm rollback** to proceed.

![Image 17: Rollback complete.](https://www.palantir.com/docs/resources/foundry/data-lineage/rollback-complete.png)
...
![Image 18: The transaction is crossed out after a successful rollback.](https://www.palantir.com/docs/resources/foundry/data-lineage/branch-pointer-updated.png)

## [](https://www.palantir.com/docs/foundry/data-lineage/pipeline-rollback/#warnings)Warnings
...
![Image 19: Logic was changed after selected rollback transaction.](https://www.palantir.com/docs/resources/foundry/data-lineage/jobspec-changed-after-rollback.png)
...
![Image 20: Empty input after rollback.](https://www.palantir.com/docs/resources/foundry/data-lineage/empty-input-after-rollback.png)

## [](https://www.palantir.com/docs/foundry/data-lineage/pipeline-rollback/#considerations-and-limitations)Considerations and limitations
...
*   It is not possible to roll back to a [retentioned transaction](https://www.palantir.com/docs/foundry/retention/overview/)
...
*   Only transactional datasets with a [JobSpec](https://www.palantir.com/docs/foundry/data-integration/builds/#jobs-and-jobspecs) can be rolled back; uploaded datasets are not supported for rollback.
*   A maximum of **50 transactions** can be rolled back on the upstream dataset at a given time.

[← PREVIOUS Manage schedules](https://www.palantir.com/docs/foundry/data-lineage/manage-schedules/)

[NEXT Roll back a dataset →](https://www.palantir.com/docs/foundry/data-lineage/dataset-rollback/)
