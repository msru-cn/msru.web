...
URL Source: https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#dataset-preview-faq)Dataset Preview FAQ

The following are some frequently asked questions about Dataset Preview.

For general information, see the [Dataset Preview overview](https://www.palantir.com/docs/foundry/dataset-preview/overview/).

*   [CSV fails to parse due to unmatched quote character](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#csv-fails-to-parse-due-to-unmatched-quote-character)
*   [Dataset fails to parse because some underlying CSVs have more columns](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#dataset-fails-to-parse-because-some-underlying-csvs-have-more-columns)
*   [Why does my downloaded dataset look strange when I open it in Microsoft Excel?](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#why-does-my-downloaded-dataset-look-strange-when-i-open-it-in-microsoft-excel)

* * *

## [](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#csv-fails-to-parse-due-to-unmatched-quote-character)CSV fails to parse due to unmatched quote character
...
[Return to top](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#dataset-preview-faq)

* * *

## [](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#dataset-fails-to-parse-because-some-underlying-csvs-have-more-columns)Dataset fails to parse because some underlying CSVs have more columns
...
2.   Your schema enforces strict column ordering. For example, if you want the dataset to contain and show columns _{a, b, c}_, an underlying CSV can have a column structure like:

*   _{a}_
*   _{a, b}_

but _cannot_ have a column structure like:

*   _{b, a}_

1.   An underlying CSV must have all columns preceding the _n_-th column if it has the _(n+1)_ th column. For example, if you want the dataset to contain and show columns _{a, b, c, d}_, an underlying CSV can have a column structure like:
...
2.   Modify the `fieldSchemaList` to ensure it includes all the columns that the dataset should possess. For example, if the dataset should have columns _{a, b, c}_, all with integer types, the `fieldSchemaList` may look like the following:
...
## [](https://www.palantir.com/docs/foundry/dataset-preview/dataset-preview-faq/#why-does-my-downloaded-dataset-look-strange-when-i-open-it-in-microsoft-excel)Why does my downloaded dataset look strange when I open it in Microsoft Excel?
...
[← PREVIOUS CSV parsing](https://www.palantir.com/docs/foundry/dataset-preview/csv-parsing/)

[NEXT Linter / Overview →](https://www.palantir.com/docs/foundry/linter/overview/)
