...
![Image 1: Control Panel's Network ingress VPNs page is displayed.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-vpns-page.png)
...
*   **Public IP address of your VPN gateway:** Enter the customer’s public VPN gateway address _or_ the outside address when using NAT.
...
![Image 2: The Add VPN connection popup window displays the steps necessary to configure an ingress VPN configuration.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-create-vpn-1.png)
...
![Image 3: The Add VPN connection popup window displays the Select CIDR tab.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-create-vpn-2.png)
...
![Image 4: The Add VPN connection popup window displays the Tunnel 1 configuration tab.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-create-vpn-tunnel-1-config.png)
...
![Image 5: The Add VPN connection popup window displays the Tunnel 2 configuration tab.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-create-vpn-tunnel-2-config.png)
...
![Image 6: The Download VPN configuration window displays vendors and configuration for their gateway devices.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-vpn-download-config.png)
...
![Image 7: Control Panel displays that status of network ingress VPN tunnels as Up.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-vpn-tunnel-status.png)

### 5. Connect to Foundry

To connect to Foundry, you will:

1.   [Allow ingress into Foundry from a VPN.](https://www.palantir.com/docs/foundry/administration/configure-vpn-ingress/#allow-ingress-into-foundry)
2.   [Override DNS resolution in a VPN.](https://www.palantir.com/docs/foundry/administration/configure-vpn-ingress/#override-dns-in-a-vpn)

#### Allow ingress into Foundry

You can reference the existing [ingress configuration documentation](https://www.palantir.com/docs/foundry/administration/configure-ingress/#configure-network-ingress-in-control-panel) to allow ingress from a customer's private CIDRs into Foundry.
...
![Image 8: The VPN configuration details panel is displayed.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-vpn-details.png)
...
`1curl -s https://<mycompany>.palantirfoundry.com/magritte-coordinator/api/ping > /dev/null && echo pass || echo fail`
...
![Image 9: The VPNs tab displays the ability to Disable or Delate a VPN.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-vpn-actions.png)
...
![Image 10: The Logs window displays logs based off of a set quantity from a configured starting timestamp.](https://www.palantir.com/docs/resources/foundry/administration/network-ingress-vpn-logs.png)
