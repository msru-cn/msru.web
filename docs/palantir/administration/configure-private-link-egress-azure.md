...
![Image 1: The Control Panel page for managing private links in Azure.](https://www.palantir.com/docs/resources/foundry/administration/private-link-overview-azure.png)

To successfully create a private link connection:

1.   [Create a private link service for your target resource](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-azure/#create-a-private-link-service-for-your-target-resource).
2.   [Allow the Palantir platform to access the target resource](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-azure/#allow-the-palantir-platform-to-access-the-target-resource).
3.   [Provide the target resource details](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-azure/#provide-the-target-resource-details).
4.   [Create network egress policies](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-azure/#create-private-link-egress-policies).
...
![Image 2: A Control Panel callout displaying the Palantir platform's Azure subscription.](https://www.palantir.com/docs/resources/foundry/administration/private-link-account-callout-azure.png) 
...
![Image 3: The Control Panel dialog to create a standard private link in Azure.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create-normal-azure.png)
...
![Image 4: The Control Panel dialog to create a storage private link in Azure.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create-storage-azure.png)
...
![Image 5: The Control Panel display of network egress policy settings in a private link for Azure.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create-egress-policy-azure.png)
...
![Image 6: The Control Panel display of the menu for managing a private link through the details page.](https://www.palantir.com/docs/resources/foundry/administration/private-link-managing-1-azure.png)

![Image 7: The Control Panel display of the menu for managing a private link through the overview page.](https://www.palantir.com/docs/resources/foundry/administration/private-link-managing-2-azure.png)

### Update a private link

A private link's **DNS zone**, **DNS record**, and **TCP ports** can be updated by selecting **Actions > Update**.

![Image 8: The Control Panel display for updating a private link in Azure.](https://www.palantir.com/docs/resources/foundry/administration/private-link-update-azure.png)
