...
![Image 1: no access search result](https://www.palantir.com/docs/resources/foundry/administration/no-access-search-result.png)
...
![Image 2: beta search result](https://www.palantir.com/docs/resources/foundry/administration/beta-extension-search-result.png)
...
![Image 3: extension search result](https://www.palantir.com/docs/resources/foundry/administration/extension-search-results.png)

## Managing Organization access

There are two ways in which a user can access an Organization: as the user's [primary Organization](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-access/#primary-organization), or as an Organization for which the user has [guest access](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-access/#guest-access-to-organizations).

### Primary Organization

Every user has exactly one primary Organization. A user's primary Organization can be assigned upon user creation, mapped via your SAML setup (available at [**Admin > Authentication > Organization assignment**](https://www.palantir.com/docs/foundry/authentication/org-assignment/)), or managed in the **Users** interface.
