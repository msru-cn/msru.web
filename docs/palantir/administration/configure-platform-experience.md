...
![Image 1: Configure the home page URL in the Platform experience settings.](https://www.palantir.com/docs/resources/foundry/administration/configure-homepage-url.png)
...
*   If a [Slate](https://www.palantir.com/docs/foundry/slate/overview/) dashboard should be used as the Organization's home page, set the value to `/slate/<dashboard-rid-or-permalink>`.
*   If a [Carbon](https://www.palantir.com/docs/foundry/carbon/overview/) workspace should be used as the Organization's home page, set the value to `/carbon/<workspace-rid>`
...
![Image 2: Configure languages in the Platform experience settings.](https://www.palantir.com/docs/resources/foundry/administration/configure-languages.png)
...
![Image 3: Configure the platform logo in Platform experience settings.](https://www.palantir.com/docs/resources/foundry/administration/configure-platform-logo.png)
...
![Image 4: Configure the title of your platform in the Platform experience settings.](https://www.palantir.com/docs/resources/foundry/administration/configure-platform-title.png)

## Configure platform version

The [platform version switcher](https://www.palantir.com/docs/foundry/administration/configure-platform-experience/#platform-version-switcher) lets you choose between using different versions of the platform. For instance, some users may prefer to use the _beta_ version of the platform to access new features earlier, before they are available on the _stable_ version of the platform.

To view and configure the **Platform version** tab in Control Panel, a user needs the **Manage platform version** workflow, which is granted by the **User experience administrator** role. Roles are administered in the **[Organization permissions](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-permissions/#roles)** tab in Control Panel.

### Platform versions

There are three platform versions available through the platform version switcher: [stable](https://www.palantir.com/docs/foundry/administration/configure-platform-experience/#stable), [beta](https://www.palantir.com/docs/foundry/administration/configure-platform-experience/#beta), and [prior](https://www.palantir.com/docs/foundry/administration/configure-platform-experience/#prior).
...
The prior release is the stable release that existed immediately previous to the current stable release. Switching to the prior release can be useful for viewing the old UI in case of changes made in the stable release, but the prior release is not recommended for everyday use. Users can temporarily view the prior version, but will be automatically moved back onto their default version (see [Configuring users' default platform version](https://www.palantir.com/docs/foundry/administration/configure-platform-experience/#configuring-users-default-platform-version)).
...
![Image 5: Change platform version.](https://www.palantir.com/docs/resources/foundry/administration/platform-version-switcher.png)

The default version shown to users is determined by the [default platform version setting in Control Panel](https://www.palantir.com/docs/foundry/administration/configure-platform-experience/#configuring-users-default-platform-version). When viewing a platform version other than the stable release, a small tag will be visible in the sidebar to indicate that the user is viewing a different release.

![Image 6: Platform version tag visible in sidebar.](https://www.palantir.com/docs/resources/foundry/administration/version-tag.png)
...
![Image 7: Platform version tab](https://www.palantir.com/docs/resources/foundry/administration/configure-platform-version.png)

Select **Manage** next to **Platform version switcher** to bring up a dialog to change the platform version switcher setting.

![Image 8: Platform version switcher dialog](https://www.palantir.com/docs/resources/foundry/administration/platform-version-switcher-dialog.png)

Select the desired access, then select **Request and apply change for your organization**. This will create a change request in the [Approvals inbox in Control Panel](https://www.palantir.com/docs/foundry/administration/control-panel-approvals/) that will automatically be self-approved and applied. To view all past changes, choose **Platform version switcher requests** in the approvals inbox.

![Image 9: Platform version switcher request](https://www.palantir.com/docs/resources/foundry/administration/platform-version-switcher-request.png)
...
![Image 10: Platform version default](https://www.palantir.com/docs/resources/foundry/administration/platform-version-default.png)
...
![Image 11: Platform version default dialog](https://www.palantir.com/docs/resources/foundry/administration/platform-version-default-dialog.png)

When you are done with configuration, select **Request and apply change for your organization**. This will create a change request in the [Approvals inbox in Control Panel](https://www.palantir.com/docs/foundry/administration/control-panel-approvals/) that will automatically be self-approved and applied. To view all past changes, choose **Platform version default requests** in the approvals inbox.

![Image 12: Platform version default request](https://www.palantir.com/docs/resources/foundry/administration/platform-version-default-request.png)
...
![Image 13: Configure the static banner in the Platform experience settings](https://www.palantir.com/docs/resources/foundry/administration/configure-static-banner.png)
