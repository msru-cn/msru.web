...
![Image 1: The Control Panel page for managing private links.](https://www.palantir.com/docs/resources/foundry/administration/private-link-overview.png)

To successfully create a private link connection:

1.   [Create an endpoint service for your target resource](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#create-an-endpoint-service-for-your-target-resource).
2.   [Allow the Palantir platform to access the target resource](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#allow-the-palantir-platform-to-access-the-target-resource).
3.   [Provide the target resource endpoint service name](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#provide-the-target-resource-endpoint-service-name).
4.   [Create network egress policies](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#create-private-link-egress-policies).
...
![Image 2: A Control Panel callout displaying the AWS account of the Palantir platform.](https://www.palantir.com/docs/resources/foundry/administration/private-link-account-callout.png)
...
![Image 3: The Control Panel dialog to create a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create.png) 
    *   **Advanced settings:**
...
![Image 4: The Control Panel advanced settings when creating a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create-advanced.png)
...
After successful creation of a private link, create [private link egress policies](https://www.palantir.com/docs/foundry/administration/configure-egress/#private-link-egress-policies) to allow egress to the target resource.
...
![Image 5: The Control Panel display of default, private and zonal domains in the network egress policy settings in a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create-egress.png)
...
![Image 6: The Control Panel display of default domains in the network egress policy settings in a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-default-domain.png)
...
![Image 7: The Control Panel display of zonal domains in the network egress policy settings in a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-zonal-domain.png)

*   Create network egress policies for private domains, if configured. 
![Image 8: The Control Panel display of private domains in the network egress policy settings in a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-private-domains.png)
...
![Image 9: The Control Panel display of the menu for managing a private link through the details page.](https://www.palantir.com/docs/resources/foundry/administration/private-link-managing-1.png)

![Image 10: The Control Panel display of menu for managing in a private link through the overview page.](https://www.palantir.com/docs/resources/foundry/administration/private-link-managing-2.png)

### Update a private link

A private link's **Private domains** and **TCP ports** can be updated by selecting **Actions > Update**.

![Image 11: The Control Panel display for updating a private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-update.png)
...
![Image 12: The Control Panel display of sharing network egress policies.](https://www.palantir.com/docs/resources/foundry/administration/private-link-share-policy.png)

## Use a private link

### Data Connection source

In Data Connection, [configure a source](https://www.palantir.com/docs/foundry/data-connection/set-up-source/) using the default domain or the third-party API domain, and attach the created network egress policies. After configuring, test connectivity by previewing or exploring the source and verifying that the source's data is accurate.

### Snowflake source

To create a Snowflake source connected through a private link, follow these steps:

1.   [Allowlist the Palantir platform cloud provider account in Snowflake](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#allowlist-the-palantir-platform-cloud-provider-account-in-snowflake).
2.   [Create the private link in Control Panel](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#create-the-private-link-in-control-panel).
3.   [Create the Snowflake source in Data Connection](https://www.palantir.com/docs/foundry/administration/configure-private-link-egress-aws/#create-the-snowflake-source-in-data-connection).
...
![Image 13: A Control Panel callout displaying the AWS account of the Palantir platform.](https://www.palantir.com/docs/resources/foundry/administration/private-link-account-callout.png)
...
![Image 14: A Control Panel callout displaying a sample configuration of a Snowflake private link.](https://www.palantir.com/docs/resources/foundry/administration/private-link-create-snowflake.png)
...
![Image 15: A Control Panel callout displaying the sample configuration of a Snowflake source.](https://www.palantir.com/docs/resources/foundry/administration/private-link-snowflake-source.png)

#### Network egress policies

Create network egress policies for all of the URLs output by the command [`SYSTEM$ALLOWLIST_PRIVATELINK` ↗](https://docs.snowflake.com/en/sql-reference/functions/system_allowlist_privatelink). Additionally, create an [S3 bucket policy](https://www.palantir.com/docs/foundry/administration/configure-egress/#amazon-s3-bucket-policies) for the `STAGE` of the output as shown below:

![Image 16: A Control Panel callout displaying suggested egress for a Snowflake source.](https://www.palantir.com/docs/resources/foundry/administration/private-link-suggest-egress.png)

For more information on Snowflake configuration refer to Palantir's [Snowflake documentation](https://www.palantir.com/docs/foundry/available-connectors/snowflake/).
