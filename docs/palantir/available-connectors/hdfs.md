...
URL Source: https://www.palantir.com/docs/foundry/available-connectors/hdfs/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#hdfs)HDFS

Connect Foundry to the Hadoop Distributed File System (HDFS) to read and sync data from HDFS to Foundry datasets.

## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#supported-capabilities)Supported capabilities
...
## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#data-model)Data model
...
## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#performance-and-limitations)Performance and limitations
...
## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#setup)Setup
...
### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#networking)Networking
...
### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#certificates-and-private-keys)Certificates and private keys
...
## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#configuration-options)Configuration options
...
### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#advanced-options)Advanced options

The following advanced options are available for the HDFS connector:

| Option | Required? | Description |
| --- | --- | --- |
| `User` | No | HDFS user. For legacy agent worker sources, defaults to the currently logged-in user on the agent host. The `user` parameter overrides Data Connection's global Kerberos settings. Leave the `user` parameter blank if you are using Kerberos. |
| `File change timeout` | No | Amount of time (in [ISO-8601 ↗](https://docs.oracle.com/javase/8/docs/api/java/time/Duration.html#parse-java.lang.CharSequence)) a file must remain constant before being considered for upload. If possible, use the more efficient `lastModifiedBefore` processor. |

## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#sync-data-from-hdfs)Sync data from HDFS
...
## [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#hdfs-export-task-legacy)HDFS export task (legacy)

[Export tasks](https://www.palantir.com/docs/foundry/data-connection/export-tasks/) are a legacy feature that is _not_ recommended for new implementations. This documentation is provided for users who are still using legacy export tasks.

### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#basic-configuration)Basic configuration

Copied!

```yaml
1type: export-hdfs-task
2directoryPath: /some/directory
```

### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#complete-configuration-options)Complete configuration options
...
| `rewritePaths` | No | N/A | Map of regex patterns for path rewriting (see [common configuration](https://www.palantir.com/docs/foundry/data-connection/export-tasks/#path-rewriting)) |

### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#incremental-exports)Incremental exports
...
```yaml
1type: export-hdfs-task
2directoryPath: /exports/incremental/
3incrementalType: incremental
```

### [](https://www.palantir.com/docs/foundry/available-connectors/hdfs/#connection-retries)Connection retries
...
[← PREVIOUS Greenplum](https://www.palantir.com/docs/foundry/available-connectors/greenplum/)

[NEXT Highrise →](https://www.palantir.com/docs/foundry/available-connectors/highrise/)
