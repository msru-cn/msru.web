...
URL Source: https://www.palantir.com/docs/foundry/available-connectors/asana/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/available-connectors/asana/#asana)Asana

Connect Foundry to Asana with the CData JDBC driver to import data into Foundry datasets.

## [](https://www.palantir.com/docs/foundry/available-connectors/asana/#supported-capabilities)Supported capabilities
...
## [](https://www.palantir.com/docs/foundry/available-connectors/asana/#data-model)Data model
...
## [](https://www.palantir.com/docs/foundry/available-connectors/asana/#setup)Setup
...
### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#authentication)Authentication
...
### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#networking)Networking

The Asana connector requires network access to `app.asana.com` on port 443. Ensure that an [egress policy](https://www.palantir.com/docs/foundry/administration/configure-egress/) exists for the source.

## [](https://www.palantir.com/docs/foundry/available-connectors/asana/#configuration-options)Configuration options
...
| `Credentials settings` | Yes | Configure using the [Authentication](https://www.palantir.com/docs/foundry/available-connectors/asana/#authentication) guidance shown above. |
| `Proxy settings` | No | Enable and enter the username and password to allow a proxy connection to Asana. |
| `Logs` | No | Enable to control how the connector logs information. Review the [log settings](https://www.palantir.com/docs/foundry/available-connectors/asana/#log-settings) section below for more details. |

### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#log-settings)Log settings
...
## [](https://www.palantir.com/docs/foundry/available-connectors/asana/#sync-data-from-asana)Sync data from Asana
...
## [](https://www.palantir.com/docs/foundry/available-connectors/asana/#configure-asana-syncs)Configure Asana syncs
...
| Option | Required? | Description |
| --- | --- | --- |
| `Table` | Yes | Choose what table from Asana should be copied into Foundry. See [data model](https://www.palantir.com/docs/foundry/available-connectors/asana/#data-model) for what tables are supported. |
| `Column selection` | No | Select a subset of columns to sync into Foundry. Review the [column selection](https://www.palantir.com/docs/foundry/available-connectors/asana/#column-selection) section below for more information. |
| `Row filters` | No | Enable and add filters to remove rows that do not fit criteria based on its column values. Review the [row filters](https://www.palantir.com/docs/foundry/available-connectors/asana/#row-filters) section below for more information. |
...
| `Incremental` | No | Enable to sync data into Foundry in small batches. Review the [incremental](https://www.palantir.com/docs/foundry/available-connectors/asana/#incremental) section below for more information. |

### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#incremental)Incremental
...
### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#column-selection)Column selection
...
### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#row-filters)Row filters
...
#### [](https://www.palantir.com/docs/foundry/available-connectors/asana/#comparison-operations)Comparison operations
...
[← PREVIOUS Apache Phoenix](https://www.palantir.com/docs/foundry/available-connectors/apache-phoenix/)

[NEXT Authorize.Net →](https://www.palantir.com/docs/foundry/available-connectors/authorize-net/)
