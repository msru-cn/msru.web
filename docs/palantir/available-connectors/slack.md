...
URL Source: https://www.palantir.com/docs/foundry/available-connectors/slack/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/available-connectors/slack/#slack-beta)Slack [Beta]

Beta

The Slack connector in Data Connection is in the [beta](https://www.palantir.com/docs/foundry/platform-overview/development-life-cycle/) phase of development and may not be available on your enrollment. Functionality may change during active development. Contact Palantir Support to request access to the Slack connector if you do not see it listed in Data Connection.

Connect Foundry to Slack with the CData JDBC driver to import data into Foundry datasets.

## [](https://www.palantir.com/docs/foundry/available-connectors/slack/#supported-capabilities)Supported capabilities
...
## [](https://www.palantir.com/docs/foundry/available-connectors/slack/#data-model)Data model
...
## [](https://www.palantir.com/docs/foundry/available-connectors/slack/#setup)Setup
...
### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#authentication)Authentication
...
*   [Configure the required scopes for the app. ↗](https://api.slack.com/start/quickstart#scopes)
    *   See [Permissions](https://www.palantir.com/docs/foundry/available-connectors/slack/#permissions) for details of required scopes.
...
*   [Install the app to your target workspace. ↗](https://api.slack.com/start/quickstart#installing)
    ...
    *   After installation, follow the steps in the Slack documentation to locate and copy the bot token for the installed app into the Credentials settings for the Slack source in Data Connection (see [Configuration options](https://www.palantir.com/docs/foundry/available-connectors/slack/#configuration-options)).

### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#permissions)Permissions

To ingest data tables, the Slack application for the bearer token configured in the **Credentials** settings for [source configuration](https://www.palantir.com/docs/foundry/available-connectors/slack/#configuration-options) must be granted specific Slack permission scopes.
...
### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#networking)Networking

The Slack connector requires network access to `slack.com` on port `443`. If your source is running in Foundry, ensure that an [egress policy](https://www.palantir.com/docs/foundry/administration/configure-egress/) to that address exists.

For sources running on an agent, the agent host must have network access to this domain.

## [](https://www.palantir.com/docs/foundry/available-connectors/slack/#configuration-options)Configuration options

The following configuration options are available for the Slack connector:

| Option | Required? | Description |
| --- | --- | --- |
| `Credentials settings` | Yes | Configure using the [Authentication](https://www.palantir.com/docs/foundry/available-connectors/slack/#authentication) guidance shown above. |
...
## [](https://www.palantir.com/docs/foundry/available-connectors/slack/#sync-data-from-slack)Sync data from Slack
...
[Learn more about source exploration in Foundry.](https://www.palantir.com/docs/foundry/data-connection/source-exploration/)

## [](https://www.palantir.com/docs/foundry/available-connectors/slack/#configure-slack-syncs)Configure Slack syncs
...
| Option | Required? | Description |
| --- | --- | --- |
| `Table` | Yes | Choose what table from Slack should be copied into Foundry. See [data model](https://www.palantir.com/docs/foundry/available-connectors/slack/#data-model) for what tables are supported. |
| `Column selection` | No | Select a subset of columns to sync into Foundry. Review the [column selection](https://www.palantir.com/docs/foundry/available-connectors/slack/#column-selection) section below for more information. |
| `Row filters` | No | Enable and add filters to remove rows that do not fit criteria based on its column values. Review the [row filters](https://www.palantir.com/docs/foundry/available-connectors/slack/#row-filters) section below for more information. |
...
| `Incremental` | No | Enable to sync data into Foundry in small batches. Review the [incremental](https://www.palantir.com/docs/foundry/available-connectors/slack/#incremental) section below for more information. |

### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#incremental)Incremental
...
### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#column-selection)Column selection
...
### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#row-filters)Row filters
...
#### [](https://www.palantir.com/docs/foundry/available-connectors/slack/#comparison-operations)Comparison operations
...
[← PREVIOUS SingleStore](https://www.palantir.com/docs/foundry/available-connectors/singlestore/)

[NEXT Smartsheet →](https://www.palantir.com/docs/foundry/available-connectors/smartsheet/)
