...
URL Source: https://www.palantir.com/docs/foundry/available-connectors/db2/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/available-connectors/db2/#db2)Db2

Connect Foundry to Db2 to read and sync data between Db2 databases and Foundry.

## [](https://www.palantir.com/docs/foundry/available-connectors/db2/#supported-capabilities)Supported capabilities
...
## [](https://www.palantir.com/docs/foundry/available-connectors/db2/#setup)Setup
...
## [](https://www.palantir.com/docs/foundry/available-connectors/db2/#configuration-options)Configuration options
...
### [](https://www.palantir.com/docs/foundry/available-connectors/db2/#jdbc-properties)JDBC properties
...
## [](https://www.palantir.com/docs/foundry/available-connectors/db2/#configure-db2-syncs)Configure Db2 syncs

### [](https://www.palantir.com/docs/foundry/available-connectors/db2/#sql-queries)SQL queries
...
![Image 2: The SLQ Query input on the Edit syncs page for a JDBC connector.](https://www.palantir.com/docs/resources/foundry/available-connectors/jdbc-sql-query.png)

## [](https://www.palantir.com/docs/foundry/available-connectors/db2/#table-exports)Table Exports

The Db2 source type supports [table exports](https://www.palantir.com/docs/foundry/data-connection/export-overview/#table-exports). For Db2 databases running on z/OS or LUW (Linux, Unix, Windows), no additional configuration should be required. However, for Db2 databases running on the IBM iSeries or AS/400, [journaling ↗](https://www.ibm.com/docs/en/i/7.5?topic=integrity-journaling) must be enabled for any target tables.

## [](https://www.palantir.com/docs/foundry/available-connectors/db2/#change-data-capture)Change data capture

The Db2 connector supports [change data capture](https://www.palantir.com/docs/foundry/data-integration/change-data-capture/) (CDC) syncs. Db2 CDC syncs are implemented using the [Debezium Db2 connector ↗](https://debezium.io/documentation/reference/stable/connectors/db2.html). To enable CDC on your Db2 instance, follow the instructions outlined in the [Debezium documentation ↗](https://debezium.io/documentation/reference/stable/connectors/db2.html#setting-up-db2).
...
[← PREVIOUS Databricks](https://www.palantir.com/docs/foundry/available-connectors/databricks/)

[NEXT Directory →](https://www.palantir.com/docs/foundry/available-connectors/directory/)
