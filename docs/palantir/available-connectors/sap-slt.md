...
URL Source: https://www.palantir.com/docs/foundry/available-connectors/sap-slt/

Published Time: Thu, 09 Jul 2026 17:47:52 GMT

# [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#sap-slt)SAP SLT
...
## [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#setup)Setup
...
### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#remote-context)Remote context

The SAP SLT connector requires a **Remote context** value, which is the unique identifier of the RFC connection between the SLT Replication Server and the source ERP system. Learn more about configuring this in the [SLT configuration guide](https://www.palantir.com/docs/foundry/sap/configure-sap-slt/#slt-configuration) and about [SLT connections](https://www.palantir.com/docs/foundry/sap/architecture/#connecting-to-an-sap-erp-system-via-an-sap-slt-replication-server).

## [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#authentication)Authentication
...
## [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#networking-and-connectivity)Networking and connectivity

You must properly configure egress policies (if using a [Foundry worker](https://www.palantir.com/docs/foundry/data-connection/core-concepts/#foundry-worker)) or your agent networking (if using an [agent worker](https://www.palantir.com/docs/foundry/data-connection/core-concepts/#agent-worker)) to make sure your SAP SLT system can communicate with Foundry.

Many SAP systems use custom-signed certificates which can cause SSL handshake exceptions when configuring the connection for the first time. Make sure you have the correct custom certificates from your system and [add them to the source](https://www.palantir.com/docs/foundry/data-connection/set-up-source/#optional-add-certificates) (if using a Foundry worker) or [to the agent directly](https://www.palantir.com/docs/foundry/data-connection/agent-worker/#certificates) (if using an agent worker).

### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#sap-data-accelerator)SAP Data Accelerator
...
## [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#sync-data-from-sap-slt)Sync data from SAP SLT

Use the [exploration view](https://www.palantir.com/docs/foundry/data-connection/source-exploration/) to create syncs for SAP SLT tables. From the source overview page, select **+ New** next to batch sync, then choose your desired object type from the dropdown:
...
### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#sync-parameters)Sync parameters
...
### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#streaming-syncs)Streaming syncs
...
#### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#force-snapshot)Force snapshot
...
#### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#api-version)API version
...
*   The `PALODATA` add-on component to be [installed on the SLT system](https://www.palantir.com/docs/foundry/sap/install-sap/#slt-installation).
*   SAP NetWeaver version **7.50 SP09** or higher. Learn more about the [prerequisites and configuration](https://www.palantir.com/docs/foundry/sap/configure-sap-slt/#use-odp-via-odata-connector-version-234-sp34-and-above).
...
![Image 2: Sync settings showing the API version selector with OData and ODP (legacy) options.](https://www.palantir.com/docs/resources/foundry/available-connectors/sap-slt-api-version.png)

#### [](https://www.palantir.com/docs/foundry/available-connectors/sap-slt/#reset-queue-registration)Reset queue registration
...
[← PREVIOUS SAP ERP](https://www.palantir.com/docs/foundry/available-connectors/sap-erp/)

[NEXT SAP (Custom source) →](https://www.palantir.com/docs/foundry/available-connectors/sap-custom-source/)
