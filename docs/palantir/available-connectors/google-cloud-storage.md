...
URL Source: https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/

Published Time: Thu, 09 Jul 2026 17:47:51 GMT

# [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#google-cloud-storage)Google Cloud Storage

Connect Foundry to Google Cloud Storage to sync files between Foundry datasets and storage buckets.

## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#supported-capabilities)Supported capabilities
...
## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#data-model)Data model
...
## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#performance-and-limitations)Performance and limitations
...
## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#setup)Setup
...
### [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#authentication)Authentication
...
### [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#networking)Networking
...
## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#configuration-options)Configuration options
...
| `Credentials settings` | Yes | Configure using the [Authentication](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#authentication) guidance shown above. |
| `Proxy settings` | No | Enable to use a proxy while connecting to Google Cloud Storage. |

## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#sync-data-from-google-cloud-storage)Sync data from Google Cloud Storage

The Google Cloud Storage connector uses the file-based sync interface. See documentation on [configuring file-based syncs](https://www.palantir.com/docs/foundry/data-connection/file-based-syncs/).

## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#virtual-tables)Virtual tables

This section provides additional details around using [virtual tables](https://www.palantir.com/docs/foundry/data-integration/virtual-tables/) from Google Cloud Storage source. This section is not applicable when syncing to Foundry datasets.
...
| Incremental pipelines | 🟢 Generally available for Delta tables: `APPEND` only ([details](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#delta)) 🟢 Generally available for Iceberg tables: `APPEND` only ([details](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#iceberg)) 🔴 Not available for Parquet tables |
| Compute pushdown | 🔴 Not available |

Consult the [virtual tables documentation](https://www.palantir.com/docs/foundry/data-integration/virtual-tables/#supported-foundry-workflows) for details on the supported Foundry workflows where tables stored in Google Cloud Storage can be used as inputs or outputs.

### [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#source-configuration-requirements)Source configuration requirements
...
*   Ensure that bi-directional connectivity and allowlisting is established as described in the [Networking section of this documentation](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#networking).
...
### [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#delta)Delta
...
### [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#iceberg)Iceberg
...
### [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#parquet)Parquet

Virtual tables using Parquet rely on schema inference. At most 100 files will be used to determine the schema.

## [](https://www.palantir.com/docs/foundry/available-connectors/google-cloud-storage/#export-data-to-google-cloud-storage)Export data to Google Cloud Storage
...
```yaml
1type: export-google-cloud-storage
2directoryPath: directory/to/export/to
3excludePaths:
4  -  ^_.*
5  - ^spark/_.*
6uploadConfirmation: exportedFiles
7incrementalType: incremental
8retriesPerFile: 0
9createTransactionFolders: true
10threads: 0
```

After you configure the export task, select **Save** in the upper right corner.

[← PREVIOUS Google Campaign Manager](https://www.palantir.com/docs/foundry/available-connectors/google-campaign-manager/)

[NEXT Google Contacts →](https://www.palantir.com/docs/foundry/available-connectors/google-contacts/)
