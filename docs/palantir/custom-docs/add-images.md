...
URL Source: https://www.palantir.com/docs/foundry/custom-docs/add-images/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/custom-docs/add-images/#add-images-or-media-to-custom-docs)Add images or media to custom docs
...
### [](https://www.palantir.com/docs/foundry/custom-docs/add-images/#images-stored-in-the-foundry-filesystem)Images stored in the Foundry filesystem
...
### [](https://www.palantir.com/docs/foundry/custom-docs/add-images/#images-stored-as-dataset-files)Images stored as dataset files
...
[← PREVIOUS Add links to custom docs](https://www.palantir.com/docs/foundry/custom-docs/add-links/)

[NEXT Add callouts to custom docs →](https://www.palantir.com/docs/foundry/custom-docs/add-callouts/)
