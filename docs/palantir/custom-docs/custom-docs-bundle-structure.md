...
URL Source: https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/

Markdown Content:
## Custom docs bundle structure

The `ordering.md` file for a custom documentation bundle determines the structure and organization of pages in the bundle. A [**section annotation**](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/#section-annotations) must be specified for each page in a documentation bundle; the [set of available section annotations](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/#summary-of-section-annotations) is predetermined and cannot be altered.
...
*   [Recommended] [Declare the child on the parent page](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/#declare-the-child-on-the-parent-page)
*   [Not recommended] [Declare the parent on the child page](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/#declare-the-parent-on-the-child-page)
