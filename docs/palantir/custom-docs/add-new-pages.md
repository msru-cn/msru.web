...
URL Source: https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#add-new-pages-to-custom-documentation)Add new pages to custom documentation
...
*   [Page must use `@title` for the page title](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#specify-a-page-title)
*   [Page must be listed in `ordering.md`](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#add-the-new-page-to-orderingmd)
*   [Optional: Specify a label for the table of contents](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#optional-use-a-different-label-in-the-table-of-contents)
...
## [](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#specify-a-page-title)Specify a page title
...
## [](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#add-the-new-page-to-orderingmd)Add the new page to `ordering.md`

Each page in a documentation bundle (other than the mandatory `overview.md`) must be specified in an `ordering.md` file in the documentation repository. The `ordering.md` enables you to structure and organize the documentation bundle with [section annotations](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/). The left-hand table of contents is automatically generated with these section annotations.

[Learn more about organizing your documentation bundle.](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/)

## [](https://www.palantir.com/docs/foundry/custom-docs/add-new-pages/#optional-use-a-different-label-in-the-table-of-contents)Optional: Use a different label in the table of contents
...
[← PREVIOUS Custom docs bundle structure](https://www.palantir.com/docs/foundry/custom-docs/custom-docs-bundle-structure/)

[NEXT Add links to custom docs →](https://www.palantir.com/docs/foundry/custom-docs/add-links/)
