...
URL Source: https://www.palantir.com/docs/foundry/devops-release-management/use-devops-for-release-management/
...
Using DevOps and Marketplace, as outlined below, is one way to implement a release management process. There are other ways to do this in the Palantir platform, such as using [Global Branching](https://www.palantir.com/docs/foundry/global-branching/overview/).

## 1. Set up environments using spaces

Use [spaces](https://www.palantir.com/docs/foundry/security/orgs-and-spaces/#spaces) in the Palantir platform for environments. Create one space per environment that you need. For example, you can create `Development`, `Test`, and `Production` spaces. All resources and projects in the Palantir platform exist within a space, so the current space that your resources are in can be used as your `Development` space. If you would like to use that current space as your `Development` space, you only need to create additional `Test` and `Production` spaces.

Refer to [documentation on spaces](https://www.palantir.com/docs/foundry/platform-security-management/manage-orgs-and-spaces/#spaces) to learn how to create and configure spaces.
...
![Image 1: Environment settings.](https://www.palantir.com/docs/resources/foundry/devops-release-management/environment-settings.png?width=750)

## 2. Package resources into products

Use [DevOps](https://www.palantir.com/docs/foundry/foundry-devops/overview/) to package resources from your development environment into products. You can package your workflow into one or more products. A typical split might look like:
...
![Image 2: Package created from various Foundry resources in a development environment.](https://www.palantir.com/docs/resources/foundry/devops-release-management/development-space.png)

[Review our guide on how to create a product.](https://www.palantir.com/docs/foundry/foundry-devops/create-products/)
...
![Image 3: For uses cases that have links to the same object type, package the object type in the downstream use case.](https://www.palantir.com/docs/resources/foundry/devops-release-management/use-case-package-example.png) 
...
![Image 4: Diagram for linked products.](https://www.palantir.com/docs/resources/foundry/devops-release-management/linked-products.png)

[Learn more about linked products.](https://www.palantir.com/docs/foundry/marketplace/linked-products/)

## 3. Release manage your products

Once your Projects have been packaged into products, you can now install these products into your second environment. In a release management process with `Development`, `Test`, and `Production` environments, this would be the `Test` environment. [Learn more about installing a product through Marketplace.](https://www.palantir.com/docs/foundry/marketplace/install-product/)

![Image 5: A package that is created in the development environment and installed in the production environment.](https://www.palantir.com/docs/resources/foundry/devops-release-management/development-production-space.png)

Repeat this process for every subsequent environment. After installing a product in an environment, you can automate upgrades by customizing your [installation settings](https://www.palantir.com/docs/foundry/marketplace/installations/#installation-settings). Additional customizations, such as release channels and maintenance windows can also be configured during the initial installation.
...
![Image 6: Environments table.](https://www.palantir.com/docs/resources/foundry/devops-release-management/environments-table.png)

A more detailed view of an environment can be found by selecting the individual environment.

![Image 7: Environment page.](https://www.palantir.com/docs/resources/foundry/devops-release-management/environment-page.png)
...
![Image 8: Installation of linked products.](https://www.palantir.com/docs/resources/foundry/devops-release-management/linked-product-installation.png)
