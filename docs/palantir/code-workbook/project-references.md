...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/project-references/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/project-references/#project-references)Project references

In Foundry, [Projects](https://www.palantir.com/docs/foundry/compass/move-and-share-resources/) define both a conceptual boundary around related work, and a security boundary for applying and managing access. Using data across project boundaries must be treated with extra care.

## [](https://www.palantir.com/docs/foundry/code-workbook/project-references/#referencing-a-resource)Referencing a resource
...
![Image 4: add-reference-project](https://www.palantir.com/docs/resources/foundry/code-workbook/add-reference-project.png)
...
## [](https://www.palantir.com/docs/foundry/code-workbook/project-references/#project-scoped-workbooks)Project-scoped Workbooks
...
![Image 5: psj-dialog-enabled](https://www.palantir.com/docs/resources/foundry/code-workbook/psj-dialog-enabled.png)

In a project-scoped workbook, noncompliant inputs and outputs are also denoted with a red icon.

## [](https://www.palantir.com/docs/foundry/code-workbook/project-references/#enabling-project-scoping-on-your-workbook)Enabling project scoping on your workbook
...
![Image 6: psj-dialog-disabled](https://www.palantir.com/docs/resources/foundry/code-workbook/psj-dialog-disabled.png)
...
[← PREVIOUS Optional data persistence](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/)

[NEXT Code repositories / Comparison: Code Repositories vs. Code Workbook vs. Code Workspaces →](https://www.palantir.com/docs/foundry/code-workbook/code-products-comparison/)
