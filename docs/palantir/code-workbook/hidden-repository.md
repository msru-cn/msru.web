...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/hidden-repository/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/hidden-repository/#hidden-code-repositories)Hidden code repositories

Code Workbook offers lightweight version control through the use of [branches](https://www.palantir.com/docs/foundry/code-workbook/branching-overview/). Additionally, every workbook is backed by a special hidden code repository. This repository serves as a secure backup of the code written in a code workbook while also exposing the history of all code changes made on the workbook.
...
![Image 2: Hidden repository button](https://www.palantir.com/docs/resources/foundry/code-workbook/open-hidden-repository-button.png?width=300)
## [](https://www.palantir.com/docs/foundry/code-workbook/hidden-repository/#special-properties)Special properties
...
## [](https://www.palantir.com/docs/foundry/code-workbook/hidden-repository/#code-conversion)Code conversion
...
```python
1def rename_column(dataset):
2    return dataset.withColumnRenamed("old_name", "new_name")
```
...
```python
1@transform_pandas(
2    Output(rid="ri.foundry.main.dataset.id-1"),
3    dataset=Input(rid="ri.vector.main.dataset.id-2")
4)
5def rename_column(dataset):
6    return dataset.withColumnRenamed("old_name", "new_name")
```
...
## [](https://www.palantir.com/docs/foundry/code-workbook/hidden-repository/#recover-lost-code)Recover lost code
...
[← PREVIOUS Exporting to a Code Repository](https://www.palantir.com/docs/foundry/code-workbook/code-repositories-export/)

[NEXT PySpark reference →](https://www.palantir.com/docs/foundry/code-workbook/pyspark-reference/)
