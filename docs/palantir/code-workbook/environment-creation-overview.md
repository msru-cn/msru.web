...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/
...
For general guidance regarding common environment-related issues, see the [Environment Troubleshooting Guide](https://www.palantir.com/docs/foundry/code-workbook/environment-troubleshooting/).
...
*   [Package](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#package)
*   [Channel](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#channel)
*   [Environment](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#environment)
...
A package is _versioned_, and nearly always has a set of dependencies—other packages that must also be installed for it to function properly. A dependency might be a specific version of a package, a range of acceptable versions, or any version at all.
...
Conda searches a set of preconfigured channels whenever it needs to fetch a package. For more information about channel management in Foundry, see the [Code Repositories documentation](https://www.palantir.com/docs/foundry/transforms-python/use-python-libraries/).
...
*   [Creating an Environment](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#creating-an-environment)
*   [Limitations](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#limitations)
...
If the solve succeeds, the _install step_ is next. Here, each artifact is retrieved from the proper channel and uses them to construct the environment. This step contains three stages:
...
*   [Upstream changes](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#upstream-changes)
*   [Environment specification](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#environment-specification)
*   [Package size](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#package-size)
...
Remediation in this case is similar to the suggestions for [environment specification](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#environment-specification): try to keep environments as small as possible.

## Environment optimizations

The previous sections of this page describe the [environment initialization process](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#environment-creation) and [factors that affect initialization performance](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/#performance). The following diagram summarizes the standard process of obtaining an environment:

![Image 1: standard environment initialization](https://www.palantir.com/docs/resources/foundry/code-workbook/environments_initialization.png)
...
![Image 2: environments using spec files](https://www.palantir.com/docs/resources/foundry/code-workbook/environments_specfiles.png)
...
![Image 3: environments using conda docker](https://www.palantir.com/docs/resources/foundry/code-workbook/environments_conda_docker.png)
