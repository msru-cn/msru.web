...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/transforms-overview/
...
![Image 1: transforms-new-transform-button](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms_new_transform_button.png)
...
![Image 2: transforms-plus-button](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms_plus_button.png)

## Editing transforms

### Editing names

Transforms in Code Workbook can be saved as datasets. Read more about [data persistence](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/).
...
![Image 3: transforms-names](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms-names.png)
...
![Image 4: transforms-add-input](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms-add-input.png)

To add multiple inputs, use the button next to the **+**.

### Code

Code transforms appear as a code editor prepopulated with basic structure for the language you are using in the current Workbook. See the [Languages documentation](https://www.palantir.com/docs/foundry/code-workbook/workbooks-languages/) for specific details about writing code in each language.

### Global code

The [Global code](https://www.palantir.com/docs/foundry/code-workbook/workbooks-global-code/) pane allows you to define code that executes before each code transform in your Workbook. The Global Code pane can be used to define variables and functions that will be available throughout the transforms in your Workbook.

### Templates

For [Template transforms](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/), the logic panel displays a form to edit Template parameters.
...
![Image 5: manual-entry-button](https://www.palantir.com/docs/resources/foundry/code-workbook/manual-entry-button.png)
...
![Image 6: manual-entry-node](https://www.palantir.com/docs/resources/foundry/code-workbook/manual-entry-node.png)
...
Running a transform requires edit permissions on the workbook, as well as access to all of the [Markings](https://www.palantir.com/docs/foundry/security/markings/) used by any dataset used by the workbook.
...
*   Click the settings icon (![Image 7: Gear icon](https://www.palantir.com/docs/resources/foundry/code-workbook/gear-icon.png)) in the top bar and select **Run all transforms**.
...
![Image 8: changing_input_type](https://www.palantir.com/docs/resources/foundry/code-workbook/changing_input_type.png)
...
|  | R | R data.frame |  |
|  | SQL | Spark dataframe |  |
| Import with custom file format, including models | Python | Object | See the [model training tutorial](https://www.palantir.com/docs/foundry/model-integration/tutorial-intro/) for more information. Object input types in Code Workbook are custom file formats and are not related to ontology objects. |
|  | R | Object | See the [model training tutorial](https://www.palantir.com/docs/foundry/model-integration/tutorial-intro/) for more information. Object input types in Code Workbook are custom file formats and are not related to ontology objects. |
...
Depending on the language used in your transform, you can use plotting libraries to return visualizations that will propagate to the Code Workbook user interface. See the [Languages documentation](https://www.palantir.com/docs/foundry/code-workbook/workbooks-languages/) for details about how to do this in each language.
...
![Image 9: transforms-visualization](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms-visualization.png)

Using the context menu, you can toggle the view in the Graph between table and graph mode.

![Image 10: toggle_transformation](https://www.palantir.com/docs/resources/foundry/code-workbook/toggle_transformation.png)
...
![Image 11: visualization_tab](https://www.palantir.com/docs/resources/foundry/code-workbook/visualization_tab.png)
...
![Image 12: logs_tab](https://www.palantir.com/docs/resources/foundry/code-workbook/logs_tab.png)
...
Transforms that return models will automatically be written to Foundry as a model, allowing use of the Foundry ML interface. Refer to the [Languages documentation](https://www.palantir.com/docs/foundry/code-workbook/workbooks-languages/) for details about how to use models in each language.
