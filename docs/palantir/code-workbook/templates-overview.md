...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/templates-overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#templates)Templates
...
Any transform that can be created with code, including Matplotlib or Plotly visualizations, can be created with code templates. To try using templates hands-on, follow the [Templates tutorial](https://www.palantir.com/docs/foundry/code-workbook/templates-getting-started/).

## [](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#search-and-discovery)Search and discovery
...
![Image 6: transforms-new-transform-button](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms_new_transform_button.png)
...
![Image 7: search_available_templates](https://www.palantir.com/docs/resources/foundry/code-workbook/search_available_templates.png)

## [](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#using-code-templates)Using code templates
...
![Image 8: transforms-template](https://www.palantir.com/docs/resources/foundry/code-workbook/transforms-template.png)

### [](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#input-types)Input types

*   **Dataset:** The value for a dataset field must be a valid dataset in the current workbook. When a user clicks the dataset input field, they will be prompted to select an input dataset from the graph. Dataset inputs can also be configured to always map to the same input dataset; for example, a code template might always rely on a particular ontology dataset. For more, see the [Creating and editing templates](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#creating-and-editing-templates) section below.
...
## [](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#creating-and-editing-templates)Creating and editing templates
...
![Image 9: template_creation_side_by_side_view](https://www.palantir.com/docs/resources/foundry/code-workbook/template_creation_side_by_side_view.png)
...
![Image 10: template_creation_highlight_parameter](https://www.palantir.com/docs/resources/foundry/code-workbook/template_creation_highlight_parameter.png)
...
## [](https://www.palantir.com/docs/foundry/code-workbook/templates-overview/#best-practices)Best practices
...
[← PREVIOUS Transforms / Transforms FAQ](https://www.palantir.com/docs/foundry/code-workbook/transforms-faq/)

[NEXT Getting started →](https://www.palantir.com/docs/foundry/code-workbook/templates-getting-started/)
