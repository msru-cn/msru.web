...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/environment-profiles/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/environment-profiles/#code-workbook-profiles)Code Workbook profiles
...
## [](https://www.palantir.com/docs/foundry/code-workbook/environment-profiles/#artifacts-profiles)Artifacts profiles

[New Code Workbook profiles created in Control Panel](https://www.palantir.com/docs/foundry/administration/configure-code-workbook-profiles/) use Artifacts. Artifacts-backed profiles allow use of libraries securely produced by Artifacts, including Python libraries authored in Foundry that are not published to the `shared` channel. Refer to the [Control Panel documentation](https://www.palantir.com/docs/foundry/administration/configure-code-workbook-profiles/) to learn more about creating Artifacts profiles.

### [](https://www.palantir.com/docs/foundry/code-workbook/environment-profiles/#using-an-artifacts-profile)Using an Artifacts profile
...
![Image 2: artifacts_import_dialog](https://www.palantir.com/docs/resources/foundry/code-workbook/artifacts_import_dialog.png)
...
### [](https://www.palantir.com/docs/foundry/code-workbook/environment-profiles/#customizing-an-artifacts-profile)Customizing an Artifacts profile
...
### [](https://www.palantir.com/docs/foundry/code-workbook/environment-profiles/#future-plans)Future plans
...
[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/code-workbook/environment-overview/)

[NEXT View resolved environment →](https://www.palantir.com/docs/foundry/code-workbook/environment-view-resolved/)
