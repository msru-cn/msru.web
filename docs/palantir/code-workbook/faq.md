...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/faq/
...
For general information, view our [Code Workbook documentation](https://www.palantir.com/docs/foundry/code-workbook/overview/).

*   [Can I easily move all of my work from one workbook to another?](https://www.palantir.com/docs/foundry/code-workbook/faq/#can-i-easily-move-all-of-my-work-from-one-workbook-to-another)
*   [Can I set a transformation node to be a variable?](https://www.palantir.com/docs/foundry/code-workbook/faq/#can-i-set-a-transformation-node-to-be-a-variable)
*   [Why does each transformation node need to return a table or a dataframe?](https://www.palantir.com/docs/foundry/code-workbook/faq/#why-does-each-transformation-node-need-to-return-a-table-or-a-dataframe)
*   [Can Code Workbook handle merging and merge conflicts?](https://www.palantir.com/docs/foundry/code-workbook/faq/#can-code-workbook-handle-merging-and-merge-conflicts)
*   [How long does it take to initialize my environment?](https://www.palantir.com/docs/foundry/code-workbook/faq/#how-long-does-it-take-to-initialize-my-environment)
*   [How do I restore code I previously deleted from my code workbook?](https://www.palantir.com/docs/foundry/code-workbook/faq/#how-do-i-restore-code-i-previously-deleted-from-my-code-workbook)
*   [Spark environment and custom libraries](https://www.palantir.com/docs/foundry/code-workbook/faq/#spark-environment-and-custom-libraries)
    *   [Cannot find required Python library](https://www.palantir.com/docs/foundry/code-workbook/faq/#cannot-find-required-python-library)
    *   [Trouble importing Python libraries](https://www.palantir.com/docs/foundry/code-workbook/faq/#trouble-importing-python-libraries)
    *   [Failed to create environment](https://www.palantir.com/docs/foundry/code-workbook/faq/#failed-to-create-environment)

*   [Python code is failing](https://www.palantir.com/docs/foundry/code-workbook/faq/#python-code-is-failing)
    *   [Retryer error](https://www.palantir.com/docs/foundry/code-workbook/faq/#retryer-error)

*   [Failed to save as dataset](https://www.palantir.com/docs/foundry/code-workbook/faq/#failed-to-save-as-dataset)
*   [Workbook not automatically recomputing after updating input dataset preview](https://www.palantir.com/docs/foundry/code-workbook/faq/#workbook-not-automatically-recomputing-after-updating-input-dataset-preview)
*   [Unable to merge my branch into master](https://www.palantir.com/docs/foundry/code-workbook/faq/#unable-to-merge-my-branch-into-master)
*   [Make cell computation faster](https://www.palantir.com/docs/foundry/code-workbook/faq/#make-cell-computation-faster)
    *   [1. Refactoring](https://www.palantir.com/docs/foundry/code-workbook/faq/#1-refactoring)
    *   [2. Caching](https://www.palantir.com/docs/foundry/code-workbook/faq/#2-caching)
    *   [3. Function calls](https://www.palantir.com/docs/foundry/code-workbook/faq/#3-function-calls)
    *   [4. Downsampling](https://www.palantir.com/docs/foundry/code-workbook/faq/#4-downsampling)
    *   [5. Summary](https://www.palantir.com/docs/foundry/code-workbook/faq/#5-summary)
...
[Return to top](https://www.palantir.com/docs/foundry/code-workbook/faq/#code-workbook-faq)
...
Yes. For more information, view the documentation on [branching and merging](https://www.palantir.com/docs/foundry/code-workbook/branching-merging/).
...
For additional information, you may also refer to our guidance on [Builds and checks errors](https://www.palantir.com/docs/foundry/health-checks/builds-checks-faq/).
...
2.   If the branch is protected then identify the owner and request that they merge your branch. 
    ...
    *   More information is available in our [Branching overview](https://www.palantir.com/docs/foundry/code-workbook/branching-overview/#branch-settings).
...
3.   If the branch is not protected, then you run into merge conflicts, where this is non-additive code that conflicts with the code in the `master` branch. 
    ...
    *   More information is available in our [Merging branches](https://www.palantir.com/docs/foundry/code-workbook/branching-merging/) documentation.
...
![Image 1: Add multiple input datasets option.](https://www.palantir.com/docs/resources/foundry/code-workbook/code-workbooks-cache.png)
