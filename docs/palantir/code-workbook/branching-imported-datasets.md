...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/branching-imported-datasets/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/branching-imported-datasets/#choose-imported-dataset-branch)Choose imported dataset branch

Code Workbook implements branch _fallbacks_ for imported datasets, which means that the branch hierarchy in your Workbook will be used to determine where imported datasets should be pulled from.
...
![Image 2: branching-pin-branch](https://www.palantir.com/docs/resources/foundry/code-workbook/branching-pin-branch.png)

[← PREVIOUS Merging branches](https://www.palantir.com/docs/foundry/code-workbook/branching-merging/)

[NEXT Datasets / Optional data persistence →](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/)
