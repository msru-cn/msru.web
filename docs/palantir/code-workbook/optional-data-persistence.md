...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#optional-data-persistence)Optional data persistence

For each transform in a workbook, users can choose whether to save the result as a dataset.

## [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#choose-whether-to-save-as-a-dataset)Choose whether to save as a dataset

By default, new transforms are not saved as datasets. To save them, use the toggle in the logic pane.

![Image 8: save-as-dataset-toggle](https://www.palantir.com/docs/resources/foundry/code-workbook/save-as-dataset-toggle.png)

_These screenshots use open source data from the [NYC Taxi & Limousine Commission ↗](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page)._

To change the persistence of multiple transforms at once, use the bulk editor on the left-hand side.

![Image 9: bulk-persistence-sidebar](https://www.palantir.com/docs/resources/foundry/code-workbook/bulk-persistence-sidebar.png)
...
## [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#execution-model)Execution Model
...
![Image 10: op-diagram-1](https://www.palantir.com/docs/resources/foundry/code-workbook/op-diagram-1.png)
...
![Image 11: op-diagram-2](https://www.palantir.com/docs/resources/foundry/code-workbook/op-diagram-2.png)
...
![Image 12: op-diagram-3](https://www.palantir.com/docs/resources/foundry/code-workbook/op-diagram-3.png)
...
## [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#faq)FAQ

### [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#when-should-i-save-a-transform-as-a-dataset)When should I save a transform as a dataset?
...
### [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#when-should-i-preview-a-node)When should I preview a node?
...
### [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#why-dont-my-unsaved-transforms-appear-in-data-lineage)Why don't my unsaved transforms appear in Data Lineage?
...
![Image 13: workbook-in-data-lineage-1](https://www.palantir.com/docs/resources/foundry/code-workbook/workbook-in-data-lineage-1.png)
...
![Image 14: workbook-in-data-lineage-2](https://www.palantir.com/docs/resources/foundry/code-workbook/workbook-in-data-lineage-2.png)

### [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#what-are-the-performance-and-resource-usage-effects-of-optional-data-persistence)What are the performance and resource usage effects of optional data persistence?
...
#### [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#scheduled-builds)Scheduled builds
...
#### [](https://www.palantir.com/docs/foundry/code-workbook/optional-data-persistence/#interactive-use)Interactive use
...
[← PREVIOUS Branching / Choose imported dataset branch](https://www.palantir.com/docs/foundry/code-workbook/branching-imported-datasets/)

[NEXT Project references →](https://www.palantir.com/docs/foundry/code-workbook/project-references/)
