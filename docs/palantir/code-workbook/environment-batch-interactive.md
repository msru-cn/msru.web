...
URL Source: https://www.palantir.com/docs/foundry/code-workbook/environment-batch-interactive/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-workbook/environment-batch-interactive/#batch-builds-and-interactive-builds)Batch builds and interactive builds

When using Code Workbook interactively by running jobs from within the workbook interface, all jobs will use the Spark module associated with the workbook. As seen in the image below, you can view the Spark module ID [in the session history](https://www.palantir.com/docs/foundry/code-workbook/session-history-pinning/) dialog for any session.

![Image 5: spark_module_id](https://www.palantir.com/docs/resources/foundry/code-workbook/spark_module_id.png)
...
![Image 6: build_datasets](https://www.palantir.com/docs/resources/foundry/code-workbook/build_datasets.png)

Alternately, use the same sidebar and click on the calendar icon to set up a recurring schedule to build the datasets. [Learn more about setting up schedules.](https://www.palantir.com/docs/foundry/code-workbook/workbooks-production/#using-batch-builds)
...
![Image 7: details_button](https://www.palantir.com/docs/resources/foundry/code-workbook/details_button.png)
...
![Image 8: details_pane](https://www.palantir.com/docs/resources/foundry/code-workbook/details_pane.png)

[← PREVIOUS View resolved environment](https://www.palantir.com/docs/foundry/code-workbook/environment-view-resolved/)

[NEXT Environment creation overview →](https://www.palantir.com/docs/foundry/code-workbook/environment-creation-overview/)
