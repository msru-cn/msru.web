...
URL Source: https://www.palantir.com/docs/foundry/aip/overview/

Published Time: Thu, 09 Jul 2026 17:47:45 GMT

Markdown Content:
![Image 1: AIP header image.](https://www.palantir.com/docs/resources/foundry/aip/AIP@4x.png?width=0.25)
...
The remainder of this page provides a brief overview of key AIP benefits. For more details about AIP's capabilities, we recommend reviewing the [AIP documentation](https://www.palantir.com/docs/foundry/aip/aip-features/), including the [AIP application reference](https://www.palantir.com/docs/foundry/aip/aip-features/#aip-application-reference).
...
To learn more about the tools that enable developers to monitor and optimize the performance of the agents and applications that are built with the platform, review the [AIP observability documentation](https://www.palantir.com/docs/foundry/aip-observability/overview/).
