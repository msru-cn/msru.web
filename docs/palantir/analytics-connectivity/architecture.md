...
# [](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/#architecture)Architecture

This page documents the architecture of the original Spark and Direct Read SQL engines. Foundry is transitioning to [Furnace](https://www.palantir.com/docs/foundry/sql-warehousing/furnace/), a next-generation SQL engine with enhanced performance, flexibility, and compatibility. This transition is automatic and requires no changes to existing workflows.
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/#supported-sql-dialects)Supported SQL Dialects
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/#execution-engines)Execution Engines
...
### [](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/#spark-engine)Spark Engine
...
### [](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/#direct-read-engine)Direct Read Engine
...
1.   Executed on a dataset. [Views](https://www.palantir.com/docs/foundry/data-integration/views/) are not currently supported.
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/#caveats)Caveats

*   This functionality is intended to support clients external to the Foundry Platform such as PowerBI, Tableau, or other downstream Applications. For SQL-powered transformations within the Foundry Platform see [SQL Transforms](https://www.palantir.com/docs/foundry/code-workbook/workbooks-languages/#introduction-to-sql).
*   The architecture of Foundry SQL Server has been optimized for ad-hoc interactive queries against moderate data scale.

[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/analytics-connectivity/overview/)

[NEXT Power BI® / Overview →](https://www.palantir.com/docs/foundry/analytics-connectivity/power-bi-overview/)
