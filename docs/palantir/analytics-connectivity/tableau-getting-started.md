...
URL Source: https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#getting-started)Getting started
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#select-foundry-as-your-data-source-in-tableau)Select Foundry as your data source in Tableau

1.   Launch Tableau and select **Connect to Data**.
2.   Under **To a Server**, click **More**.
3.   Search for and select **Foundry by Palantir**.

![Image 2: New Palantir Foundry connection in Tableau](https://www.palantir.com/docs/resources/foundry/analytics-connectivity/tableau_tableau-new-connection.png)

### [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#enter-your-foundry-url)Enter your Foundry URL
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#authenticate-with-foundry)Authenticate with Foundry
...
### [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#foundry-oauth-authentication)Foundry OAuth authentication
...
If you receive an error when logging in to Foundry, it is likely your organization has not yet enabled the OAuth login option for Tableau. In this case, contact your Foundry administrator for support, referencing the [instructions for enabling the OAuth client](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-oauth-setup/#part-1-enable-the-oauth-client-for-tableau-desktop).

#### [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#publish-a-report-with-oauth)Publish a report with OAuth
...
### [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#foundry-token-authentication)Foundry token authentication

1.   Under the **Authentication** dropdown, select **Foundry Token**.
2.   In the **Token** field, enter a unique [user-generated token](https://www.palantir.com/docs/foundry/platform-security-third-party/user-generated-tokens/).
3.   Click **Sign In**.

### [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#foundry-third-party-application-client-credentials-available-since-tableau-connector-version-260)Foundry third-party application client credentials (available since Tableau connector version 2.6.0)
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#select-your-dataset)Select your dataset
...
## [](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-getting-started/#high-data-scale-and-tableau-data-extracts)High data scale and Tableau Data Extracts

Higher data scale can be processed by using [Tableau Data Extracts ↗](https://help.tableau.com/current/pro/desktop/en-us/extracting_data.htm), and ensuring that queries are "direct read eligible" when processed by Foundry SQL Server. See [Architecture](https://www.palantir.com/docs/foundry/analytics-connectivity/architecture/) for details about direct read functionality.

[← PREVIOUS Setup](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-setup/)

[NEXT Tableau Server setup →](https://www.palantir.com/docs/foundry/analytics-connectivity/tableau-server-setup/)
