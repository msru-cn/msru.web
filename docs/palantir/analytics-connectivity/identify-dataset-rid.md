...
URL Source: https://www.palantir.com/docs/foundry/analytics-connectivity/identify-dataset-rid/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/analytics-connectivity/identify-dataset-rid/#identify-a-datasets-rid-or-filepath)Identify a dataset's RID or filepath
...
![Image 2: Dataset RID and location in sidebar](https://www.palantir.com/docs/resources/foundry/analytics-connectivity/location-rid.png?width=800)

[← PREVIOUS Downloads](https://www.palantir.com/docs/foundry/analytics-connectivity/downloads/)

[NEXT Troubleshooting issues →](https://www.palantir.com/docs/foundry/analytics-connectivity/troubleshooting-odbc-jdbc/)
