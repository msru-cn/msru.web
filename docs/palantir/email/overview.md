...
URL Source: https://www.palantir.com/docs/foundry/email/overview/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/email/overview/#email-administration)Email administration
...
## [](https://www.palantir.com/docs/foundry/email/overview/#email-data-risks)Email data risks
...
## [](https://www.palantir.com/docs/foundry/email/overview/#email-deliverability)Email deliverability
...
## [](https://www.palantir.com/docs/foundry/email/overview/#email-provider)Email provider

By default, the platform uses Amazon (AWS SES) to send email.

## [](https://www.palantir.com/docs/foundry/email/overview/#allowlisting)Allowlisting

Learn more about how to [control where email can be sent](https://www.palantir.com/docs/foundry/email/email-allowlisting/).

## [](https://www.palantir.com/docs/foundry/email/overview/#content-redaction)Content redaction

Learn more about how to [redact the contents of emails](https://www.palantir.com/docs/foundry/email/email-content-redaction/).

## [](https://www.palantir.com/docs/foundry/email/overview/#suppression-management)Suppression management

Learn more about how to [understand why emails may have failed to send](https://www.palantir.com/docs/foundry/email/email-suppression-management/).

[← PREVIOUS Retention / Transaction selectors](https://www.palantir.com/docs/foundry/retention/transaction-selectors/)

[NEXT Email allowlisting →](https://www.palantir.com/docs/foundry/email/email-allowlisting/)
