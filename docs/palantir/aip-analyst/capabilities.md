...
![Image 1: The AIP Analyst tools menu.](https://www.palantir.com/docs/resources/foundry/aip-analyst/aip-analyst-tools.png)

## Search

These tools let AIP Analyst find relevant resources across your Ontology using fuzzy keyword matching. The [search scope](https://www.palantir.com/docs/foundry/aip-analyst/using-aip-analyst/#settings) settings in the **Settings** menu apply to these tools.
...
*   **Object type lookup:** Retrieves comprehensive metadata for a _specific object type_, including properties and links to related object types.
