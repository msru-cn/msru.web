...
URL Source: https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/#performance-considerations)Performance considerations
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/#latency)Latency
...
### [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/#latency-factors)Latency factors
...
### [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/#end-to-end-latency-of-a-streaming-pipeline)End-to-end latency of a streaming pipeline
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/#throughput)Throughput
...
*   How many records is your source producing per time interval? 
    *   Foundry’s streaming capabilities come with high throughput levels out of the box. However, if your source stream is producing at an exceptionally high rate, you can: 
        *   Increase the number of [partitions](https://www.palantir.com/docs/foundry/data-connection/set-up-streaming-sync/#part-3-configure-the-streaming-sync) your stream uses to support those higher volumes.
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/#advanced)Advanced
...
[← PREVIOUS Comparison: Streaming vs. batch](https://www.palantir.com/docs/foundry/building-pipelines/stream-vs-batch/)

[NEXT Streaming compute usage →](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/)
