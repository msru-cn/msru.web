...
URL Source: https://www.palantir.com/docs/foundry/building-pipelines/considerations-pb-cr/

Published Time: Thu, 09 Jul 2026 17:47:52 GMT

# [](https://www.palantir.com/docs/foundry/building-pipelines/considerations-pb-cr/#considerations-pipeline-builder-and-code-repositories)Considerations: Pipeline Builder and Code Repositories
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/considerations-pb-cr/#best-practices)Best practices
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/considerations-pb-cr/#feature-summary)Feature summary
...
| Incremental computation | [Yes](https://www.palantir.com/docs/foundry/pipeline-builder/datasets-computation-modes-for-batch/#incremental-computation) | [Yes](https://www.palantir.com/docs/foundry/transforms-python-spark/incremental-examples/) |
| Filesystem and API access | No | [Yes](https://www.palantir.com/docs/foundry/transforms-python/unstructured-files/) |
| **Pipeline testing** |  |  |
...
| Unit testing | [Yes](https://www.palantir.com/docs/foundry/pipeline-builder/dataexpectations-unit-tests/) | [Yes](https://www.palantir.com/docs/foundry/code-repositories/unit-tests/) (for advanced users) |
| **Pipeline management** |  |  |
| Data expectations | Yes | Yes |
| Schedules | Yes | Yes |
| Publish custom libraries | In development | [Yes](https://www.palantir.com/docs/foundry/transforms-python/share-python-libraries/) |
...
| Manage security markings | [Yes](https://www.palantir.com/docs/foundry/pipeline-builder/outputs-remove-markings-and-organizations/) | [Yes](https://www.palantir.com/docs/foundry/building-pipelines/remove-inherited-markings/) |

[← PREVIOUS Supported languages](https://www.palantir.com/docs/foundry/building-pipelines/supported-languages/)

[NEXT Getting started / Create a dataset batch pipeline with Pipeline Builder →](https://www.palantir.com/docs/foundry/building-pipelines/create-batch-pipeline-pb/)
