...
URL Source: https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#create-a-schedule)Create a schedule

The [Data Lineage](https://www.palantir.com/docs/foundry/data-lineage/overview/) schedule editor is where you can create new schedules and edit existing schedules. You can also view metrics on existing schedules and see how the schedule will build your datasets.

## [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#navigate-to-the-schedule-editor)Navigate to the schedule editor

The following steps guide you to the Data Lineage schedule editor, where you can create a new schedule:

1.   Navigate to the [dataset preview](https://www.palantir.com/docs/foundry/dataset-preview/overview/) of the dataset for which you would like to schedule a build, open the **Actions** menu, and select **Manage Schedules**. 

![Image 8: Manage schedules from Actions menu](https://www.palantir.com/docs/resources/foundry/building-pipelines/actions-menu-manage-schedules.png)

2.   This will bring you to a [Data Lineage](https://www.palantir.com/docs/foundry/data-lineage/overview/) graph, with the schedules panel to the right listing all current schedules that affect the dataset.

To create a schedule, click the **Create schedule** button. 

![Image 9: Create a new schedule](https://www.palantir.com/docs/resources/foundry/building-pipelines/schedules-page-new.png)

3.   This will bring you to the schedule editor. 

![Image 10: Data Lineage schedule editor](https://www.palantir.com/docs/resources/foundry/building-pipelines/schedule-editor-create.png)

## [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#define-the-schedule)Define the schedule
...
### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#target-datasets)Target dataset(s)
...
![Image 11: Target datasets of build schedule](https://www.palantir.com/docs/resources/foundry/building-pipelines/target-datasets.png)

Target datasets can be selected by adding them to the graph and marking them as a target.

![Image 12: Add target dataset to graph](https://www.palantir.com/docs/resources/foundry/building-pipelines/adding-target.png)
...
### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#excluded-datasets)Excluded datasets
...
![Image 13: Exclude datasets from build](https://www.palantir.com/docs/resources/foundry/building-pipelines/exclude-datasets.png)

### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#when-to-build)When to build
...
[Learn more about time triggers.](https://www.palantir.com/docs/foundry/building-pipelines/triggers-reference/#time-trigger)

*   **When dataset(s) update:** Satisfied once a specified datasets update has occurred in the platform.

[Learn more about event triggers.](https://www.palantir.com/docs/foundry/building-pipelines/triggers-reference/#event-trigger)
...
[Learn more about compound triggers.](https://www.palantir.com/docs/foundry/building-pipelines/triggers-reference/#compound-trigger)

### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#build-type)Build type
...
Connecting build branch selection
...
### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#build-scope)Build scope
...
#### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#project-scoping)Project scoping
...
*   The schedule settings cover datasets that [remove markings](https://www.palantir.com/docs/foundry/building-pipelines/remove-markings/) (you can see this in [Data Lineage](https://www.palantir.com/docs/foundry/data-lineage/node-coloring/) when the graph is colored by Permissions).
...
#### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#user-scoping)User scoping
...
### [](https://www.palantir.com/docs/foundry/building-pipelines/create-schedule/#advanced-settings)Advanced settings

The advanced settings specify additional build options:

![Image 14: advanced-settings](https://www.palantir.com/docs/resources/foundry/building-pipelines/advanced-settings.png)
...
[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/building-pipelines/scheduling-overview/)

[NEXT View and modify schedules →](https://www.palantir.com/docs/foundry/building-pipelines/view-modify-schedules/)
