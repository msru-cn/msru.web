...
URL Source: https://www.palantir.com/docs/foundry/building-pipelines/create-faster-pipeline-pb/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/building-pipelines/create-faster-pipeline-pb/#faster-pipelines-in-pipeline-builder)Faster pipelines in Pipeline Builder
...
If you are unfamiliar with creating pipelines in Pipeline Builder, review the documentation on [how to create a batch pipeline in Pipeline Builder](https://www.palantir.com/docs/foundry/building-pipelines/create-batch-pipeline-pb/) before proceeding.
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/create-faster-pipeline-pb/#create-a-new-faster-pipeline)Create a new faster pipeline
...
![Image 8: Screenshot of Pipeline selection](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-pb-create-new.png)

## [](https://www.palantir.com/docs/foundry/building-pipelines/create-faster-pipeline-pb/#convert-between-faster-and-standard-batch-pipelines)Convert between faster and standard batch pipelines
...
![Image 9: Screenshot of pipeline settings "Convert to faster pipeline" option](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-pb-settings.png)

To convert a pipeline back to a batch pipeline, go to **Settings** and select **Convert to Batch pipeline**.

![Image 10: Screenshot of pipeline settings "Convert to batch pipeline" option](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-pb-convert-to-batch.png)
...
![Image 11: The dialog shows a successful conversion to a Faster pipeline with a confirmation message.](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-pb-can-convert.png)

1.   If the pipeline is not compatible with the new pipeline type, a warning will appear when you try to convert your pipeline. The warning will list any expressions or transforms that are incompatible with faster pipelines.

![Image 12: The dialog shows an unsuccessful conversion to a Faster pipeline with a warning listing incompatible features.](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-pb-cannot-convert.png)
...
![Image 13: The dialog shows the show pipeline conversion checks toggled on.](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-show-conversion-checks.png)
...
![Image 14: The Pipeline warnings bottom panel with the Faster conversion compatibility checks section.](https://www.palantir.com/docs/resources/foundry/building-pipelines/faster-pb-pipeline-warnings.png)

## [](https://www.palantir.com/docs/foundry/building-pipelines/create-faster-pipeline-pb/#known-limitations)Known limitations
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/create-faster-pipeline-pb/#pipeline-type-support-comparison)Pipeline type support comparison
...
[← PREVIOUS Create a streaming pipeline with Pipeline Builder](https://www.palantir.com/docs/foundry/building-pipelines/create-stream-pipeline-pb/)

[NEXT External pipelines with Pipeline Builder →](https://www.palantir.com/docs/foundry/building-pipelines/create-external-pipeline-pb/)
