...
URL Source: https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/#compute-usage-with-foundry-streaming)Compute usage with Foundry Streaming
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/#how-compute-is-measured)How compute is measured
...
Learn more about values used to calculate compute usage, including [memory-to-core ratio](https://www.palantir.com/docs/foundry/resource-management/usage-types/#memory-to-core-ratio).
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/#investigate-foundry-streaming-usage)Investigate Foundry Streaming usage

To view the total usage of streams, first navigate to the [Resource Management application](https://www.palantir.com/docs/foundry/resource-management/overview/). Then, find your stream under the **Usage by resource** section and select **Details** to view usage by individual dataset.

![Image 2: streaming-compute-usage](https://www.palantir.com/docs/resources/foundry/building-pipelines/stream-compute-usage.png)
...
Each time a historical archive is ran, it publishes its compute metrics in the [Builds application](https://www.palantir.com/docs/foundry/data-integration/application-reference/#builds). Use the Builds application to investigate the resource allocation for each archive that was run.

## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/#understand-drivers-of-usage)Understand drivers of usage
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/#manage-usage-with-foundry-streaming)Manage usage with Foundry Streaming
...
## [](https://www.palantir.com/docs/foundry/building-pipelines/streaming-compute-usage/#calculating-usage)Calculating usage
...
The total compute usage for this stream running for 10 minutes is 150 job manager compute-seconds and 450 task manager compute-seconds. Learn more about the factors that impact [compute usage in Foundry](https://www.palantir.com/docs/foundry/resource-management/usage-types/).

[← PREVIOUS Performance considerations](https://www.palantir.com/docs/foundry/building-pipelines/streaming-performance-considerations/)

[NEXT Keys →](https://www.palantir.com/docs/foundry/building-pipelines/streaming-keys/)
