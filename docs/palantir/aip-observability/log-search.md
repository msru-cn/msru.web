...
1.   Open [Workflow Lineage](https://www.palantir.com/docs/foundry/workflow-lineage/overview/) and navigate to the workflow containing your resource.
2.   Select an executable resource node.
3.   Select the **Search logs** tab in the bottom panel.

![Image 1: Log search in Workflow Lineage.](https://www.palantir.com/docs/resources/foundry/aip-observability/workflow-lineage-log-search.png)
...
![Image 2: Log search results showing matching text highlighted in the Content column.](https://www.palantir.com/docs/resources/foundry/aip-observability/log-search-automate.png)

The Search logs tab displays logs for executions where the selected resource is the _source executor_. Logs from executions where the resource was called by another resource are not included. In the example below, the function produced logs during execution but is not the source executor — it was called by an automation. Searching from the function returns no results; to find these logs, search from the automation node instead.
...
![Image 3: Log search showing no results for the selected function, with source executor suggestions and the Also recently executed by indicator.](https://www.palantir.com/docs/resources/foundry/aip-observability/log-search-function-no-logs.png)
...
![Image 4: The View trace button appearing on hover at the right side of a log row.](https://www.palantir.com/docs/resources/foundry/aip-observability/log-search-view-trace.png)
...
![Image 5: Service log content dialog showing the Content tab with formatted JSON and highlighted search match.](https://www.palantir.com/docs/resources/foundry/aip-observability/log-search-log-details.png)
...
![Image 6: Log search indicating access is limited to own executions from the past 24 hours.](https://www.palantir.com/docs/resources/foundry/aip-observability/log-search-action-no-perms.png)
