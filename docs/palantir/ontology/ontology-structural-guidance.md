...
URL Source: https://www.palantir.com/docs/foundry/ontology/ontology-structural-guidance/
...
4.   **Name links for clarity:** Link names should describe the relationship from each direction. Review the section on [naming conventions](https://www.palantir.com/docs/foundry/ontology/ontology-structural-guidance/#naming-conventions) for more information.
