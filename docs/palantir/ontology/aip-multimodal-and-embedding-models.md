...
URL Source: https://www.palantir.com/docs/foundry/ontology/aip-multimodal-and-embedding-models/

Published Time: Thu, 09 Jul 2026 17:47:57 GMT

# [](https://www.palantir.com/docs/foundry/ontology/aip-multimodal-and-embedding-models/#process-multimodal-and-embedding-models)Process multimodal and embedding models

This page discusses some methods you can use to process multimodal and embedding models.

## [](https://www.palantir.com/docs/foundry/ontology/aip-multimodal-and-embedding-models/#multimodal-models)Multimodal models
...
## [](https://www.palantir.com/docs/foundry/ontology/aip-multimodal-and-embedding-models/#embedding-models)Embedding models
...
[← PREVIOUS Document processing](https://www.palantir.com/docs/foundry/ontology/document-processing/)

[NEXT Ontology augmented generation →](https://www.palantir.com/docs/foundry/ontology/ontology-augmented-generation/)
