...
URL Source: https://www.palantir.com/docs/foundry/ontology/applications/
...
*   [Application reference](https://www.palantir.com/docs/foundry/ontology/applications/#application-reference)
*   [Application comparison](https://www.palantir.com/docs/foundry/ontology/applications/#application-comparison)
...
![Image 1: Object View Hub Example](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-object-view-hub.png)
...
![Image 2: Object Explorer](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-oe.png)
...
![Image 3: Quiver](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-quiver.png)
...
_Workshop Editor View_

![Image 4: Workshop Editor View](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-workshop-editor-view.png)

_Final Workshop Module_

![Image 5: Final Workshop Module](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-workshop-module.png)
...
![Image 6: Slate Editor View](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-slate-editor-view.png)

_Slate Application View_

![Image 7: Slate Application View](https://www.palantir.com/docs/resources/foundry/ontology/object-apps-slate-app-view.png)

### Carbon

[**Carbon**](https://www.palantir.com/docs/foundry/carbon/overview/) enables combining multiple resources or applications in Foundry to create highly curated _workspaces_ for operational users. By allowing you to combine analytical results such as dashboards, applications built in Workshop or Slate, and out-of-the-box capabilities such as Object Views and Object Explorer, Carbon enables workflow builders to perform the "last mile" of customization to create a highly tailored and usable experience for end users.

![Image 8: Carbon workspace](https://www.palantir.com/docs/resources/foundry/ontology/carbon-workspace.png)
...
![Image 9: Map Application](https://www.palantir.com/docs/resources/foundry/ontology/map-overview.png)

## Application comparison

Each object-aware application varies on a few dimensions. Three particularly important dimensions are:

*   the [primary use case(s)](https://www.palantir.com/docs/foundry/ontology/applications/#use-cases),
*   the [workflow style](https://www.palantir.com/docs/foundry/ontology/applications/#workflow-style), and
*   the [configuration model](https://www.palantir.com/docs/foundry/ontology/applications/#configuration-model) of the application.

| Foundry Application | [Primary use case](https://www.palantir.com/docs/foundry/ontology/applications/#use-cases) | [Workflow Style](https://www.palantir.com/docs/foundry/ontology/applications/#workflow-style) | [Configuration Model](https://www.palantir.com/docs/foundry/ontology/applications/#configuration-model) | Objects or Datasets |
| --- | --- | --- | --- | --- |
| [Object Views](https://www.palantir.com/docs/foundry/ontology/applications/#object-views) | Discovery | Workflow-specific | Walk-up usable | Objects |
| [Object Explorer](https://www.palantir.com/docs/foundry/ontology/applications/#object-explorer) | Discovery & Analysis | Exploratory | Walk-up usable | Objects |
| [Quiver](https://www.palantir.com/docs/foundry/ontology/applications/#quiver) | Analysis & Dashboards | Exploratory (for Analytical mode); workflow-specific (for Dashboard mode) | Walk-up usable (for Analytical mode); customizable (for Dashboard mode) | Objects |
| [Workshop](https://www.palantir.com/docs/foundry/ontology/applications/#workshop) | Applications & Dashboards | Workflow-specific | Customizable | Objects |
| [Slate](https://www.palantir.com/docs/foundry/ontology/applications/#slate) | Applications & Dashboards (complex) | Workflow-specific | Customizable | Objects (recommended) and Datasets |
| [Map](https://www.palantir.com/docs/foundry/ontology/applications/#map) | Geospatial | Exploratory or Workflow-specific | Walk-up usable | Objects |
...
*   **Analysis** enables users to answer a broad range of questions. These range from the simple (_what is the average customer retention for a given product?_) to the very complex (_how do three different customer cohorts compare in terms of retention and overall revenue over time, across all products and for each individual product?_). The analytical path is exploratory, meaning that it is defined by the end user themselves and is often highly iterative; as the initial questions are answered, new questions are developed and incorporated into the analysis path.
*   **Dashboards** are sets of pre-configured visualizations consumed primarily in a read-only fashion by a broader set of consumer users. Dashboards are often used to turn meaningful _Analyses_ into recurring reporting or operational monitoring. Dashboards are characterized by a large number of charts and other visualizations, but are not as customizable or interactive as _Applications_ (see below). Dashboards are often parameterized such that users can filter down the visualizations to different subsets of data.
