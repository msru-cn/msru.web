...
URL Source: https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/
...
1.   **Model reality, not systems:** Object types should represent real-world entities, not individual source system or department representations. 
    *   **Design principle:**[Domain-driven design](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#1-domain-driven-design)
...
3.   **Collaborate across teams:** Ontology design should involve stakeholders from multiple departments or teams. Siloed teams are a leading cause of duplication. 
    *   **Design principle:**[Don't repeat yourself](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#2-dont-repeat-yourself-rule-of-three)
...
6.   **Use interfaces for abstraction:** When entities share common characteristics, model the abstraction with interfaces rather than creating wide, sparse object types. 
    *   **Design principle:**[Composition over deep hierarchies](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#4-composition-over-deep-hierarchies)
...
| --- | --- | --- |
| 1 | [Domain-driven design](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#1-domain-driven-design) | Model the real world, not the source data. |
| 2 | [Don't repeat yourself](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#2-dont-repeat-yourself-rule-of-three) | If you built the same thing three times, refactor. |
| 3 | [Open for extension, closed for modification](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#3-open-for-extension-closed-for-modification) | Protect core models. Enable builders to extend them. |
| 4 | [Composition over deep hierarchies](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#4-composition-over-deep-hierarchies) | Favor multiple inheritance via interfaces. Keep things pluggable. |

Practical considerations should always factor into any decision. Review the section on [pragmatism and tradeoffs](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#pragmatism-and-tradeoffs) for more information.

### 1. Domain-driven design

![Image 1: 1-Domain Design](https://www.palantir.com/docs/resources/foundry/ontology/domain-design.png?width=1280)
...
![Image 2: 3-Don't Repeat](https://www.palantir.com/docs/resources/foundry/ontology/do-not-repeat.png?width=1280)
...
![Image 3: 2-Open Closed](https://www.palantir.com/docs/resources/foundry/ontology/open-closed.png?width=1280)
...
| Scope creep | Core types accumulate properties and logic for every new use case, trending toward a [God Object](https://www.palantir.com/docs/foundry/ontology/ontology-anti-patterns/#anti-pattern-the-god-object). |
...
![Image 4: 4-Composition](https://www.palantir.com/docs/resources/foundry/ontology/composition.png?width=1280)
...
| Semantic distortion | Contrived parent types (like `SchedulableBuilding`) do not represent real-world concepts, violating the [domain-driven design principle](https://www.palantir.com/docs/foundry/ontology/ontology-best-practices/#1-domain-driven-design). |
