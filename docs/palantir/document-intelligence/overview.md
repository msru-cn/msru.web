...
URL Source: https://www.palantir.com/docs/foundry/document-intelligence/overview/
...
![Image 1: An example PDF document from a media set previewed in AIP Document Intelligence.](https://www.palantir.com/docs/resources/foundry/document-intelligence/ui_preview.png)
...
![Image 2: An example of document extracting in Document Intelligence, using bounding boxes to highlight distinct areas of extraction.](https://www.palantir.com/docs/resources/foundry/document-intelligence/bounding_boxes.png)
...
*   **Preprocessing with VLM extractions:** For more complex use cases, you can combine document preprocessing with traditional methods, such as layout-aware OCR. Then, you can pass the results of the preprocessing to a VLM for better performance. Learn more about [document preprocessing](https://www.palantir.com/docs/foundry/document-intelligence/core-concepts/#preprocessing).
*   **Execution metrics:** Observe rubric metrics for extraction quality, execution time, and input/output token consumption.
*   **Evaluations:** Using the VLM as a judge, extraction results are scored on a variety of factors that may be included in the document, including the quality of lists, tables, and code blocks. The evaluation strategy is tuned to match evaluation results against ground truth in our internal evaluation set. Learn more about [extraction evalutions](https://www.palantir.com/docs/foundry/document-intelligence/core-concepts/#evaluations).
...
![Image 3: A diagram of the standard workflow when using AIP Document Intelligence.](https://www.palantir.com/docs/resources/foundry/document-intelligence/workflow.png)
...
![Image 4: The Configuration tab in AIP Document Intelligence](https://www.palantir.com/docs/resources/foundry/document-intelligence/configuration.png) 
...
5.   **Evaluate extraction results (optional):** From the results tab, select **Evaluate results** to use an LLM to evaluate the extraction results. Continue to test steps 3 through 5 until you are satisfied with the extraction results and evaluation.

![Image 5: An example of an evaluation of document extraction results.](https://www.palantir.com/docs/resources/foundry/document-intelligence/evaluation.png) 
...
![Image 6: A Python transform repository, preconfigured with an AIP Document Intelligence template.](https://www.palantir.com/docs/resources/foundry/document-intelligence/python_transform.png)
