...
URL Source: https://www.palantir.com/docs/foundry/foundry-adoption/phase-3-roles/

Markdown Content:
## Phase 3: Roles and responsibilities

The following are new roles and responsibilities for Phase 3 of the Foundry Program team, in addition to the roles established in [Phase 1](https://www.palantir.com/docs/foundry/foundry-adoption/phase-1-roles/) and [Phase 2](https://www.palantir.com/docs/foundry/foundry-adoption/phase-2-roles/).
...
*   [Foundry Interoperability](https://www.palantir.com/docs/foundry/platform-overview/interoperability/)
*   [Foundry Data Integration](https://www.palantir.com/docs/foundry/data-integration/overview/)
*   [Foundry Platform Security](https://www.palantir.com/docs/foundry/security/overview/)
*   [Foundry Data Protection and Governance](https://www.palantir.com/docs/foundry/security/data-protection-and-governance/)
...
*   [Restricted View policy management](https://www.palantir.com/docs/foundry/platform-security-management/manage-restricted-views/#restricted-view-policy-management)
*   [Permissions](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-permissions/)
...
*   [Foundry Data Integration](https://www.palantir.com/docs/foundry/data-integration/overview/)
*   [Foundry Platform Security](https://www.palantir.com/docs/foundry/security/overview/)
*   [Foundry Data Protection & Governance](https://www.palantir.com/docs/foundry/security/data-protection-and-governance/)
