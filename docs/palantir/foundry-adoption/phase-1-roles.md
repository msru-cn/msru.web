...
URL Source: https://www.palantir.com/docs/foundry/foundry-adoption/phase-1-roles/
...
*   Set the high-level direction of the program's process and scaling requirements by working with the [Program Manager](https://www.palantir.com/docs/foundry/foundry-adoption/phase-1-roles/#program-manager) to use this vision to guide processes, governance, and best practices across teams and in cross-functional collaboration efforts.
...
*   [Approvals](https://www.palantir.com/docs/foundry/approvals/overview/) application
*   [Foundry Program team](https://www.palantir.com/docs/foundry/foundry-adoption/program-overview/)
...
*   [Carbon](https://www.palantir.com/docs/foundry/carbon/overview/)
*   [Project access](https://www.palantir.com/docs/foundry/security/projects-and-roles/#request-access-to-a-project)
*   [Approvals](https://www.palantir.com/docs/foundry/approvals/overview/) application
*   [Enrollment permissions](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-permissions/)
*   [Foundry program governance](https://www.palantir.com/docs/foundry/foundry-adoption/governance-processes/)
...
*   [Control Panel (SAML)](https://www.palantir.com/docs/foundry/administration/control-panel/)
...
*   [Data Lineage](https://www.palantir.com/docs/foundry/data-lineage/overview/)
*   [Foundry Architecture](https://www.palantir.com/docs/foundry/platform-overview/architecture/)
*   [Foundry Interoperability](https://www.palantir.com/docs/foundry/platform-overview/interoperability/)
