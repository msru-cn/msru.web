...
URL Source: https://www.palantir.com/docs/foundry/automate/condition-time/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/condition-time/#time-condition)Time condition
...
![Image 4: Add time condition](https://www.palantir.com/docs/resources/foundry/automate/condition-time-add-condition.png)

By default, a daily frequency will be selected.

![Image 5: Configure time condition via user interface](https://www.palantir.com/docs/resources/foundry/automate/condition-time-ui-configuration.png)

## [](https://www.palantir.com/docs/foundry/automate/condition-time/#configuration)Configuration

There are two ways to configure the time condition: in the [user interface](https://www.palantir.com/docs/foundry/automate/condition-time/#user-interface) or as a [cron expression](https://www.palantir.com/docs/foundry/automate/condition-time/#cron-expression).

### [](https://www.palantir.com/docs/foundry/automate/condition-time/#user-interface)User interface
...
### [](https://www.palantir.com/docs/foundry/automate/condition-time/#cron-expression)Cron expression
...
![Image 6: Configure time condition via cron expression](https://www.palantir.com/docs/resources/foundry/automate/condition-time-cron-configuration.png)
...
[← PREVIOUS Getting started](https://www.palantir.com/docs/foundry/automate/getting-started/)

[NEXT Object set conditions →](https://www.palantir.com/docs/foundry/automate/condition-objects/)
