...
URL Source: https://www.palantir.com/docs/foundry/automate/notification-settings/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/notification-settings/#notification-settings)Notification settings
...
![Image 1: Configure notification settings](https://www.palantir.com/docs/resources/foundry/automate/automate-notification-user-settings.png)

| Category | [Event types](https://www.palantir.com/docs/foundry/automate/history/#event-types) |
| --- | --- |
...
[← PREVIOUS Muting, pausing, and expiration](https://www.palantir.com/docs/foundry/automate/muting-pausing-expiration/)

[NEXT Security and permissions / Security →](https://www.palantir.com/docs/foundry/automate/security/)
