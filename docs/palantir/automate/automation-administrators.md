...
URL Source: https://www.palantir.com/docs/foundry/automate/automation-administrators/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/automation-administrators/#automation-administrators)Automation administrators
...
*   **Automation information notifications**, including notifications about: 
    ...
    *   Auto-pausing an automation because of cycles or [limits](https://www.palantir.com/docs/foundry/automate/limits/)
    *   Evaluation errors
...
![Image 2: Ontology Management App - automations for object type](https://www.palantir.com/docs/resources/foundry/automate/settings-automation-administrators.png)

[← PREVIOUS Manual executions](https://www.palantir.com/docs/foundry/automate/manual-execution/)

[NEXT Execution settings →](https://www.palantir.com/docs/foundry/automate/execution-settings/)
