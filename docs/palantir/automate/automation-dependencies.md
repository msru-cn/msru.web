...
URL Source: https://www.palantir.com/docs/foundry/automate/automation-dependencies/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/automation-dependencies/#automation-dependencies)Automation dependencies
...
*   **With an object set condition:** Pair an object set condition ([**Objects added to set**](https://www.palantir.com/docs/foundry/automate/condition-objects/#objects-added-to-set), [**Objects removed from set**](https://www.palantir.com/docs/foundry/automate/condition-objects/#objects-removed-from-set), or [**Run on all objects**](https://www.palantir.com/docs/foundry/automate/condition-objects/#run-on-all-objects)) with the parent dependency. The condition is evaluated each time the parent automation completes. This behaves like [scheduled monitoring](https://www.palantir.com/docs/foundry/automate/evaluation-frequency/#scheduled-monitoring), except that each [automation-dependent](https://www.palantir.com/docs/foundry/automate/evaluation-frequency/#automation-dependent) evaluation happens when the parent automation completes rather than on a fixed schedule.
...
## [](https://www.palantir.com/docs/foundry/automate/automation-dependencies/#set-up-an-automation-dependency)Set up an automation dependency

![Image 2: Automation dependencies](https://www.palantir.com/docs/resources/foundry/automate/automation-dependencies.png?width=600)
...
## [](https://www.palantir.com/docs/foundry/automate/automation-dependencies/#always-trigger-effects-when-automation-completes)Always trigger effects when automation completes
...
## [](https://www.palantir.com/docs/foundry/automate/automation-dependencies/#known-limitations)Known limitations
...
[← PREVIOUS Condition settings](https://www.palantir.com/docs/foundry/automate/condition-settings/)

[NEXT Streaming →](https://www.palantir.com/docs/foundry/automate/streaming/)
