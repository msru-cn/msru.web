...
URL Source: https://www.palantir.com/docs/foundry/automate/security/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/security/#security)Security
...
## [](https://www.palantir.com/docs/foundry/automate/security/#key-security-concepts)Key security concepts
...
### [](https://www.palantir.com/docs/foundry/automate/security/#execution-permissions)Execution permissions
...
Learn more about how permissions work for different effect types in our Automate [permissions](https://www.palantir.com/docs/foundry/automate/permissions/) documentation.

### [](https://www.palantir.com/docs/foundry/automate/security/#automation-scoping)Automation scoping
...
Learn more about scoping options in our [history visibility and scope](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/) documentation.

### [](https://www.palantir.com/docs/foundry/automate/security/#history-and-activity-tracking)History and activity tracking
...
Learn more about execution events and retention in our [Automation history](https://www.palantir.com/docs/foundry/automate/history/) documentation.

[← PREVIOUS Settings / Notification settings](https://www.palantir.com/docs/foundry/automate/notification-settings/)

[NEXT Automation history →](https://www.palantir.com/docs/foundry/automate/history/)
