...
URL Source: https://www.palantir.com/docs/foundry/automate/performance-best-practices/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#performance-best-practices)Performance best practices
...
For general information about resource consumption in Foundry, see the [resource management documentation](https://www.palantir.com/docs/foundry/resource-management/usage-types/).

## [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#overview)Overview
...
### [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#before-creating-an-automation)Before creating an automation
...
*   **You do not need Automate** if you are manually changing object properties to hardcoded or computed values. In this case, create an [Action type](https://www.palantir.com/docs/foundry/action-types/overview/) and invoke it directly from Workshop or Object Explorer on your target object set. This is more efficient and gives you direct control over when the action runs.

### [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#understanding-automates-cost-levers)Understanding Automate's cost levers
...
## [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#condition-configuration-lever-1)Condition configuration (Lever 1)
...
Learn more about configuring conditions in the [object set conditions documentation](https://www.palantir.com/docs/foundry/automate/condition-objects/), [time condition documentation](https://www.palantir.com/docs/foundry/automate/condition-time/), and about evaluation frequency options in the [evaluation frequency documentation](https://www.palantir.com/docs/foundry/automate/evaluation-frequency/).

### [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#example-scenario)Example scenario
...
## [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#execution-mode-lever-2)Execution mode (Lever 2)

Execution mode determines whether your automation processes all triggered objects together or creates separate executions for individual objects or batches. Learn more about [execution settings](https://www.palantir.com/docs/foundry/automate/execution-settings/). When configuring your automation's execution mode, prefer **Single execution** (the default) over per-object execution when your use case allows it.
...
Learn more about execution modes in the [object set conditions documentation](https://www.palantir.com/docs/foundry/automate/condition-objects/).
...
## [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#effect-design-lever-3)Effect design (Lever 3)
...
Learn more about configuring action parameters in the [Action types documentation](https://www.palantir.com/docs/foundry/action-types/overview/).
...
When your action is backed by a function, the function should also be designed to handle bulk inputs. For detailed guidance on writing performant functions, see [Optimize function performance](https://www.palantir.com/docs/foundry/functions/optimize-performance/).
...
## [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#monitoring-your-automations)Monitoring your automations
...
If you notice any of these patterns, see [Troubleshooting automation performance](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/) for detailed diagnosis and solutions.

### [](https://www.palantir.com/docs/foundry/automate/performance-best-practices/#tools-for-monitoring)Tools for monitoring
...
*   **[Autopilot](https://www.palantir.com/docs/foundry/autopilot/overview/):** Helps understand how automations chain together and their dependencies
*   **[Workflow lineage](https://www.palantir.com/docs/foundry/workflow-lineage/overview/):** Traces automation dependencies across the platform

You can access Autopilot and Workflow Lineage through the **Actions** menu on your automation's **Overview** page.

Learn more about automation dependencies in the [automation dependencies documentation](https://www.palantir.com/docs/foundry/automate/automation-dependencies/).

[← PREVIOUS Security and permissions / Third-party application ownership](https://www.palantir.com/docs/foundry/automate/third-party-app-ownership/)

[NEXT Troubleshooting performance →](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/)
