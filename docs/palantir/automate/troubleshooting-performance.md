...
URL Source: https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#troubleshooting-automation-performance)Troubleshooting automation performance
...
For proactive guidance on designing efficient automations, see [Performance best practices](https://www.palantir.com/docs/foundry/automate/performance-best-practices/).

## [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#common-performance-spike-patterns)Common performance spike patterns

Below are common patterns to help identify and diagnose performance issues with automations.

### [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#pattern-1-active-automation-on-frequently-updating-objects)Pattern 1: Active automation on frequently updating objects
...
### [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#pattern-2-chained-automations-snowball)Pattern 2: Chained automations snowball
...
### [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#pattern-3-inefficient-function-operations)Pattern 3: Inefficient function operations
...
For comprehensive function optimization guidance, see [Optimize function performance](https://www.palantir.com/docs/foundry/functions/optimize-performance/).

### [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#pattern-4-function-self-calling-loop)Pattern 4: Function self-calling loop
...
## [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#diagnostic-process)Diagnostic process
...
3.   **Trace automation chains:** Use [Autopilot](https://www.palantir.com/docs/foundry/autopilot/overview/) or [Workflow Lineage](https://www.palantir.com/docs/foundry/workflow-lineage/overview/) to understand dependencies. Key questions to consider:
...
## [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#immediate-mitigation-steps)Immediate mitigation steps
...
## [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#tools-and-resources)Tools and resources

Below are several resources for diagnostic information.

### [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#for-execution-history-and-cost-breakdowns)For execution history and cost breakdowns

*   **[Automate execution history](https://www.palantir.com/docs/foundry/automate/history/):** Shows run counts, timing, and success or failure status
*   **[Function logs](https://www.palantir.com/docs/foundry/aip-observability/service-logs-and-debugging/):** Contains error messages and execution timing details
*   **[Ontology Manager](https://www.palantir.com/docs/foundry/ontology-manager/overview/):** Shows query costs, though this is less useful for immediate troubleshooting
*   **[Resource Management](https://www.palantir.com/docs/foundry/resource-management/overview/):** Provides overall cost breakdown by service and resource type

### [](https://www.palantir.com/docs/foundry/automate/troubleshooting-performance/#automation-workflow-overview)Automation workflow overview

*   **[Autopilot](https://www.palantir.com/docs/foundry/autopilot/overview/):** Control center for managing and monitoring automation workflows at scale
*   **[Workflow Lineage](https://www.palantir.com/docs/foundry/workflow-lineage/overview/):** Visualizes automation dependencies and chains

[← PREVIOUS Performance best practices](https://www.palantir.com/docs/foundry/automate/performance-best-practices/)

[NEXT Integrations →](https://www.palantir.com/docs/foundry/automate/integrations/)
