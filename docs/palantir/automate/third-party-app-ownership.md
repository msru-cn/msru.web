...
URL Source: https://www.palantir.com/docs/foundry/automate/third-party-app-ownership/
...
You can assign ownership to third-party applications when you create an automation, or you can [transfer ownership for an existing automation](https://www.palantir.com/docs/foundry/automate/third-party-app-ownership/#transfer-ownership-to-a-service-user).

## Understanding third-party application ownership

Third-party applications in Foundry are OAuth2-based integrations that enable external applications or services to securely interact with Foundry resources. Refer to the [third-party application overview](https://www.palantir.com/docs/foundry/platform-security-third-party/third-party-apps-overview/) for more information. For automation ownership, third-party apps provide a service user that can own automations independently from individual users, with several benefits:
...
*   **Persistent history**: Execution history remains accessible for debugging and auditing for [project-scoped automations](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/).
*   **Simplified access control**: Share execution history across teams using [project-scoped automations](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/), and centralize permission management by using the same third-party application client for multiple automations.
...
*   **Execution history** is visible to team members based on their permissions. [See history visibility settings](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/) for more information.
...
Before transferring automation ownership, create and configure an OAuth2 client by registering an application in Control Panel or Developer Console. See [Registering third-party applications](https://www.palantir.com/docs/foundry/platform-security-third-party/register-3pa/) for complete guidance.
...
![Image 1: Setting an application to "Unrestricted" in Developer Console.](https://www.palantir.com/docs/resources/foundry/automate/third-party-app-unscoped-application.png)
...
Store the client secret securely. If lost, you will need to [rotate it](https://www.palantir.com/docs/foundry/platform-security-third-party/danger-zone-actions/#rotate-a-client-secret). Note that rotating a secret will **not** break existing automations owned by that third-party application.

For complete step-by-step instructions on registering applications and obtaining credentials, see [Registering third-party applications](https://www.palantir.com/docs/foundry/platform-security-third-party/register-3pa/) and the [Developer Console overview](https://www.palantir.com/docs/foundry/developer-console/overview/).
...
If you do not have a client ID and client secret, see [Creating a new application and obtaining credentials](https://www.palantir.com/docs/foundry/developer-console/create-application/).
...
![Image 2: Select manage ownership to transfer ownership to a service user.](https://www.palantir.com/docs/resources/foundry/automate/third-party-app-add-3pa-for-new-automation.png)
...
![Image 3: Select Manage ownership to transfer ownership to a service user](https://www.palantir.com/docs/resources/foundry/automate/third-party-app-manage-automation-ownership.png)
...
![Image 4: Transfer ownership from a third-party application to yourself.](https://www.palantir.com/docs/resources/foundry/automate/third-party-apps-transfer-from-3pa.png)
...
*   [Foundry third-party application & API guidance](https://www.palantir.com/docs/foundry/platform-security-third-party/3pa-api-guidance/)
*   [Client credentials applications](https://www.palantir.com/docs/foundry/consumer-mode/client-credentials-setup/)
*   [Unrestricted applications](https://www.palantir.com/docs/foundry/developer-console/application-restrictions/#unrestricted-applications)
*   [Create a new Developer Console application](https://www.palantir.com/docs/foundry/developer-console/create-application/)
