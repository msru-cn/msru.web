...
URL Source: https://www.palantir.com/docs/foundry/automate/effect-notification/
...
Notifications can be sent in two ways: directly in the platform and as email. The content can be statically defined or dynamically determined via a function. Notifications can also include PDF attachments. This page contains information about options for notification [recipients](https://www.palantir.com/docs/foundry/automate/effect-notification/#recipients), [content](https://www.palantir.com/docs/foundry/automate/effect-notification/#content), and [attachments](https://www.palantir.com/docs/foundry/automate/effect-notification/#attachments).

![Image 1: Notification effect with object-property backed recipients](https://www.palantir.com/docs/resources/foundry/automate/effect-notifications-effect-configuration-ui.png)
...
*   [Objects added to set](https://www.palantir.com/docs/foundry/automate/condition-objects/#objects-added-to-set)
*   [Objects removed from set](https://www.palantir.com/docs/foundry/automate/condition-objects/#objects-removed-from-set)
...
![Image 2: Execution mode batched](https://www.palantir.com/docs/resources/foundry/automate/condition-objects-execution-mode-batched.png)
...
In the example shown below, three different `Support Ticket` objects simultaneously trigger the automation. Two objects belong to the category _Billing_ and one belongs to _Technical Support_.

*   Since _Category_ was selected as the grouping property, there will be two notifications: one for the _Billing_ group and one for the _Technical Support_ group.
*   For the first notification, function-backed notifications will have access to an object set containing both _Billing_ Support Ticket objects.
*   For the second notification, function-backed notifications will have access to an object set containing the _Technical Support_ object.

![Image 3: Execution mode grouped](https://www.palantir.com/docs/resources/foundry/automate/condition-objects-execution-mode-grouped.png)
...
![Image 4: Execution mode per-object](https://www.palantir.com/docs/resources/foundry/automate/condition-objects-execution-mode-per-object.png)

## Recipients

When configuring a notification, you must first define who should receive the notification. Recipients can be Foundry users or groups, defined either in a [static recipient list](https://www.palantir.com/docs/foundry/automate/effect-notification/#static-recipient-list) or [dynamically via object properties](https://www.palantir.com/docs/foundry/automate/effect-notification/#dynamic-recipient-definition-via-object-properties).
...
*   **Viewer** permission on all the properties of the object instances if the triggering object type is a [multi-datasource object type](https://www.palantir.com/docs/foundry/object-permissioning/multi-datasource-objects/).
...
The dynamic recipient definition allows you to specify object properties that contain [user IDs](https://www.palantir.com/docs/foundry/platform-security-management/manage-users/) or [group IDs](https://www.palantir.com/docs/foundry/platform-security-management/manage-groups/) to determine the notification recipients at runtime. Therefore, object property types must be either `String` or `Array of String`.
...
![Image 5: Notification effect with object-property backed recipients](https://www.palantir.com/docs/resources/foundry/automate/effect-notifications-effect-object-backed-recipients.png)

## Content

There are two ways to define the content of a notification: as a [plain notification](https://www.palantir.com/docs/foundry/automate/effect-notification/#plain-notification) or as a [function-generated notification](https://www.palantir.com/docs/foundry/automate/effect-notification/#function-generated-notification).
...
![Image 6: Template notification](https://www.palantir.com/docs/resources/foundry/automate/template-notifications-example.png)

All changes you make will be live-previewed to the right of the configuration components.

Finally, you can define an [attachment](https://www.palantir.com/docs/foundry/automate/effect-notification/#attachments) for the notification.
...
![Image 7: Function-backed notification](https://www.palantir.com/docs/resources/foundry/automate/effect-notifications-function-backed-base.png)
...
![Image 8: Function-backed notification](https://www.palantir.com/docs/resources/foundry/automate/effect-notifications-function-backed-complex.png)

## Attachments

You can configure your notification effect to include attached PDFs from [Notepad documents](https://www.palantir.com/docs/foundry/notepad/getting-started/#create-a-notepad-document) or [Notepad template documents](https://www.palantir.com/docs/foundry/notepad/templates-create/) in the notification email. A PDF will be generated automatically during runtime for each recipient.
...
![Image 9: Function-backed notification](https://www.palantir.com/docs/resources/foundry/automate/effect-notifications-attachment-notepad-template.png)
