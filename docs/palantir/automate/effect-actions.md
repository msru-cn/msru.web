...
URL Source: https://www.palantir.com/docs/foundry/automate/effect-actions/

Markdown Content:
## Action effects

The action effect allows you to automatically run [actions](https://www.palantir.com/docs/foundry/action-types/overview/) when an automation triggers or recovers.
...
![Image 1: Action effect using effect input](https://www.palantir.com/docs/resources/foundry/automate/effect-actions-effect-configuration.png)
...
![Image 2: Action effect using effect input](https://www.palantir.com/docs/resources/foundry/automate/effect-actions-effect-configuration-with-effect-input.png?width=450)
...
![Image 3: Action effect parallelization setting](https://www.palantir.com/docs/resources/foundry/automate/effect-actions-per-object.png?width=450)
...
![Image 4: Action effect execution mode setting](https://www.palantir.com/docs/resources/foundry/automate/effect-actions-multiple-objects-execution-mode.png?width=450)
...
You can also configure the amount of _jitter_, which is a variation in delay time between retries to prevent simultaneous retries. Jitter can be specified as:
...
For information about action effect execution guarantees and how to handle potential duplicate executions, see [execution guarantees](https://www.palantir.com/docs/foundry/automate/effect-settings/#execution-guarantees) in the execution settings documentation.
...
![Image 5: Disable action for Foundry Automate in Ontology Manager](https://www.palantir.com/docs/resources/foundry/automate/effect-actions-submittable-by-automate.png)

## Permissions

Actions are associated with the owner of an automation. This means that the action will be run on behalf of the owner of the automation. That requires that the owner configuring an action must pass the [submission criteria](https://www.palantir.com/docs/foundry/action-types/submission-criteria/) for that action.
