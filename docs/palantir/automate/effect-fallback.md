...
URL Source: https://www.palantir.com/docs/foundry/automate/effect-fallback/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#fallback-effect)Fallback effect
...
## [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#configuration)Configuration
...
![Image 3: Fallback effect configuration](https://www.palantir.com/docs/resources/foundry/automate/effect-fallback-configuration.png)
...
### [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#access-error-information)Access error information
...
### [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#fallback-action)Fallback action
...
![Image 4: Action fallback configuration](https://www.palantir.com/docs/resources/foundry/automate/effect-fallback-error-info.png)

### [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#use-condition-effect-inputs)Use condition effect inputs
...
Note that fallback effects are triggered on a per-object basis, so if a subset of objects to the parent action fail, only that subset will be included in the fallback effect's execution. The rest of the objects will continue on to any [sequential effects](https://www.palantir.com/docs/foundry/automate/effect-settings/#concurrency).
...
## [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#error-handling)Error handling
...
## [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#use-cases)Use cases

### [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#error-reporting-and-logging)Error reporting and logging
...
### [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#graceful-degradation)Graceful degradation
...
### [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#multi-stage-retry-with-different-parameters)Multi-stage retry with different parameters
...
## [](https://www.palantir.com/docs/foundry/automate/effect-fallback/#permissions)Permissions
...
[← PREVIOUS Notification effects](https://www.palantir.com/docs/foundry/automate/effect-notification/)

[NEXT Effect settings →](https://www.palantir.com/docs/foundry/automate/effect-settings/)
