...
URL Source: https://www.palantir.com/docs/foundry/automate/manual-execution/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/manual-execution/#manual-execution)Manual execution
...
To manually execute an automation, first [create a new automation](https://www.palantir.com/docs/foundry/automate/getting-started/) with the desired effects. Then, open the automation and navigate to the **Execute** tab.

![Image 4: The Execute page in Automation where you can configure and run a manual execution.](https://www.palantir.com/docs/resources/foundry/automate/manual-execution.png)
...
## [](https://www.palantir.com/docs/foundry/automate/manual-execution/#example-remediate-with-manual-execution)Example: Remediate with manual execution
...
## [](https://www.palantir.com/docs/foundry/automate/manual-execution/#execution-settings)Execution settings

Execution settings expose a number of configurable parameters:

![Image 5: Manual execution configuration](https://www.palantir.com/docs/resources/foundry/automate/manual-execution-settings.png)

*   **Specify object set:** For [object set conditions](https://www.palantir.com/docs/foundry/automate/condition-objects/), you can specify an input object set. See documentation on [limits](https://www.palantir.com/docs/foundry/automate/limits/) for object set size restrictions. This object set must contain objects of the same type as configured in the automation condition. All objects in this set will trigger the automation and be passed into any effect using `New object` parameters. Three object set types are currently supported:
...
![Image 6: Manual execution recipients](https://www.palantir.com/docs/resources/foundry/automate/manual-execution-recipients.png?width=600)
...
[← PREVIOUS Effects / Effect settings](https://www.palantir.com/docs/foundry/automate/effect-settings/)

[NEXT Settings / Automation administrators →](https://www.palantir.com/docs/foundry/automate/automation-administrators/)
