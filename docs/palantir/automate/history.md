...
URL Source: https://www.palantir.com/docs/foundry/automate/history/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/automate/history/#automation-history)Automation history
...
History based on the automation condition (such as `Automation triggered` and `Automation recovered`) is saved at the user level. You can only see whether an automation triggered for you, not for other users (even if you created the automation). You can learn more about [history visibility](https://www.palantir.com/docs/foundry/automate/history/#history-visibility) below.

The history for a single automation is displayed under the **History** tab in the individual automation view.

![Image 3: History of a single automation.](https://www.palantir.com/docs/resources/foundry/automate/activity-single-automation-activity.png)

## [](https://www.palantir.com/docs/foundry/automate/history/#view-event-details)View event details
...
![Image 4: Detailed view of events and effects for an automation.](https://www.palantir.com/docs/resources/foundry/automate/activity-single-automation-activity-effect-log.png)

## [](https://www.palantir.com/docs/foundry/automate/history/#history-visibility)History visibility

History visibility depends on the automation's [scope mode](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/):

*   [**Project-scoped automations:**](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/#project-scoped-automations-recommended) History is viewable to all users who satisfy the markings on a run, enabling team collaboration.
*   [**User-scoped automations:**](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/#user-scoped-automations) By default, history is visible only to the owner. Enable shared history to make trigger events visible to other users, while keeping effect execution details private. 
...
## [](https://www.palantir.com/docs/foundry/automate/history/#event-types)Event types
...
## [](https://www.palantir.com/docs/foundry/automate/history/#retention)Retention

Automation history is retained for six months, then permanently deleted. To store history beyond six months, use an action to save data in a long-lived object that is managed and controlled like any other object type in the [Ontology](https://www.palantir.com/docs/foundry/ontology/overview/).

When data is deleted, it is removed from the automation's **History** tab.

You can use [fallback effects](https://www.palantir.com/docs/foundry/automate/effect-fallback/) to persist failure messages and error information to Ontology objects. This allows you to retain data for both successful executions (through standard action effects) and unsuccessful executions (through fallback effects), with no retention limits.

[← PREVIOUS Security](https://www.palantir.com/docs/foundry/automate/security/)

[NEXT History visibility and scope →](https://www.palantir.com/docs/foundry/automate/history-visibility-and-scope/)
