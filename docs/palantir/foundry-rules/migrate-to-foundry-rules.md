...
URL Source: https://www.palantir.com/docs/foundry/foundry-rules/migrate-to-foundry-rules/
...
*   If you have a complex Taurus use case including any combination of the following, the migration will require some refactoring work, and you should consider the trade-off between the benefits outlined previously and extent of the changes required:
    ...
    *   Your [rule actions](https://www.palantir.com/docs/foundry/foundry-rules/configure-rule-actions/) implement optional visibility, use object locator, object set, or attachment field types.
...
![Image 1: Archetype V1 existing](https://www.palantir.com/docs/resources/foundry/foundry-rules/archetype-v1-existing@2x.png?width=0.50)
...
![Image 2: Archetype V1 existing](https://www.palantir.com/docs/resources/foundry/foundry-rules/archetype-v1-input@2x.png?width=0.50)

5.   The Foundry Rules migration wizard will check whether your existing set up includes [time series](https://www.palantir.com/docs/foundry/foundry-rules/timeseries-concepts/). If so, you will need to configure the link types and time series syncs. Select **Save Rules workflow** once you have completed the additional configuration.

![Image 3: Foundry Rules upgrade wizard](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-wizard3.png?width=800)
...
![Image 4: Foundry Rules upgrade wizard](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-wizard5.png?width=800)![Image 5: Foundry Rules upgrade wizard](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-wizard6.png?width=800)
7.   Select **Upgrade rules application**.

![Image 6: Foundry Rules upgrade wizard](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-wizard7.png?width=800)
8.   If requested, select **Unlink old application**.

![Image 7: Foundry Rules upgrade wizard](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-wizard8.png?width=800)
...
![Image 8: Foundry Rules upgrade wizard](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-wizard9.png?width=800)
    *   My Foundry Rules outputs directly feed into Ontology object types. 
        *   If your Outputs feed into Ontology object types (for example, without any additional transformations), then you need to replace the [objects' backing datasets](https://www.palantir.com/docs/foundry/object-link-types/create-object-type/#add-a-backing-datasource-to-a-new-object-type) of this object type so that alerts will come from the new version of Foundry Rules.

*   I apply additional transformations on my Foundry Rules outputs. 
    *   You should use the new output datasets to replace the previous rule outputs in your transformations. For advanced use cases, you can register a [custom repository to compute the rule outputs](https://www.palantir.com/docs/foundry/foundry-rules/customize-foundry-rules-pipeline/).
...
1.   Once the steps have been completed, select **Mark migration completed**. Your use case is now operational on the new Foundry Rules setup.
...
![Image 9: Transformations](https://www.palantir.com/docs/resources/foundry/foundry-rules/foundry-rules-migration-build.jpg?width=800)
...
![Image 10: Rule action](https://www.palantir.com/docs/resources/foundry/foundry-rules/migration-rule-action.png?width=800)
