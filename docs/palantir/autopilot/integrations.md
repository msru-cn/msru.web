...
URL Source: https://www.palantir.com/docs/foundry/autopilot/integrations/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/autopilot/integrations/#integrations)Integrations
...
## [](https://www.palantir.com/docs/foundry/autopilot/integrations/#automate)Automate
...
## [](https://www.palantir.com/docs/foundry/autopilot/integrations/#pro-code-agents-osdk-applications-and-compute-modules)Pro-code agents, OSDK applications, and Compute modules
...
## [](https://www.palantir.com/docs/foundry/autopilot/integrations/#workshop)Workshop

Autopilot integrates with [Workshop](https://www.palantir.com/docs/foundry/workshop/overview/) to show human-driven components of your workflow alongside automated processes.

### [](https://www.palantir.com/docs/foundry/autopilot/integrations/#human-in-the-loop-visualization-in-autopilot)Human-in-the-loop visualization in Autopilot
...
### [](https://www.palantir.com/docs/foundry/autopilot/integrations/#embed-autopilot-in-workshop)Embed Autopilot in Workshop
...
## [](https://www.palantir.com/docs/foundry/autopilot/integrations/#ontology-manager)Ontology Manager

Autopilot uses the following configurations from [Ontology Manager](https://www.palantir.com/docs/foundry/ontology/overview/) to customize object displays and enable rich object interactions:
...
[← PREVIOUS Automation events](https://www.palantir.com/docs/foundry/autopilot/automation-events/)

[NEXT Carbon / Overview →](https://www.palantir.com/docs/foundry/carbon/overview/)
