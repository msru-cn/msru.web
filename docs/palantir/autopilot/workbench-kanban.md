...
URL Source: https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#kanban-board-view)Kanban board view
...
![Image 2: A Kanban board view in Autopilot.](https://www.palantir.com/docs/resources/foundry/autopilot/autopilot_overview_ia.png)

## [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#states-and-columns)States and columns
...
### [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#configure-states)Configure states

Choose a state in the **States** sidebar or select the cog button in the top right corner of a column. [Learn more about configuring states.](https://www.palantir.com/docs/foundry/autopilot/workbench/#configure-each-state)

## [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#object-views)Object views
...
### [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#inspect-objects-in-the-side-panel)Inspect objects in the side panel
...
*   **History:** View the complete edit history for the object, including:
    ...
    *   Links to [automation events](https://www.palantir.com/docs/foundry/autopilot/automation-events/) for automation-driven changes

*   **Object preview:** Full object preview and metadata.

### [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#customize-visible-properties-on-your-workbench)Customize visible properties on your workbench

The visible properties editor allows you to control which object properties appear on Kanban cards in the Autopilot workbench. By default, cards display the [prominent properties](https://www.palantir.com/docs/foundry/object-link-types/property-metadata/) defined in Ontology Manager. The editor lets you override that default per state, allowing you to control what information is surfaced at each stage of a workflow.
...
Changes are saved as part of the workbench configuration and persist across sessions. Selecting **Use prominent properties** restores the Ontology Manager defaults for that state.

### [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#take-action-on-objects)Take action on objects
...
## [](https://www.palantir.com/docs/foundry/autopilot/workbench-kanban/#liveness-indicators)Liveness indicators
...
[← PREVIOUS Workbench](https://www.palantir.com/docs/foundry/autopilot/workbench/)

[NEXT Dependency graph view →](https://www.palantir.com/docs/foundry/autopilot/workbench-graph/)
