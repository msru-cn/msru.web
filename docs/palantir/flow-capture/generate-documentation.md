...
URL Source: https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#generate-documentation-from-a-workflow)Generate documentation from a workflow

![Image 4: Flow Capture prompt bar](https://www.palantir.com/docs/resources/foundry/flow-capture/flow-capture-prompt-bar.png)

After [recording a workflow](https://www.palantir.com/docs/foundry/flow-capture/record-a-workflow/), you can use the prompt bar at the bottom of the edit mode view in Flow Capture to provide additional context and generate documentation. Consider adding a target audience, required format, style guide, or specific instructions for content organization to improve generated content.

## [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#choose-a-model)Choose a model
...
## [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#include-assets-in-llm-context)Include assets in LLM context
...
## [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#start-generation)Start generation
...
## [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#edit-generated-markdown)Edit generated Markdown
...
![Image 5: Flow Capture resource opened in edit mode.](https://www.palantir.com/docs/resources/foundry/flow-capture/flow-capture-edit-mode.png)

### [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#generation-mode)Generation mode
...
## [](https://www.palantir.com/docs/foundry/flow-capture/generate-documentation/#export-generated-documentation)Export generated documentation

![Image 6: The Flow Capture export menu.](https://www.palantir.com/docs/resources/foundry/flow-capture/flow-capture-export-menu.png)

Flow Capture allows you to export generated content in various ways:

*   **Export as Walkthrough:** Converts the content to a [Walkthrough](https://www.palantir.com/docs/foundry/walkthroughs/overview/). Walkthroughs enforce a step-by-step structure, so Walkthrough content may differ after export from Flow Capture.
*   **Export as Notepad:** Converts the content to a [Notepad](https://www.palantir.com/docs/foundry/notepad/overview/) document.
...
[← PREVIOUS Record a workflow](https://www.palantir.com/docs/foundry/flow-capture/record-a-workflow/)

[NEXT Walkthroughs / Overview →](https://www.palantir.com/docs/foundry/walkthroughs/overview/)
