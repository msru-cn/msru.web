...
URL Source: https://www.palantir.com/docs/foundry/flow-capture/record-a-workflow/
...
![Image 1: Create a new flow capture.](https://www.palantir.com/docs/resources/foundry/flow-capture/create-new-flow-capture.png)

1.   Choose a file name and location to save your resource in Compass.
2.   Select **Save** to create the new flow capture resource.
