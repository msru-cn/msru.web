...
To begin managing users within your enrollment, you must be an `enrollment administrator` or an `authentication administrator`. If you do not have one of these permissions, an existing enrollment administrator can grant you the relevant role. Review the documentation on [granting user permission to manage users of the enrollment](https://www.palantir.com/docs/foundry/authentication/user-directory/#grant-user-permission-to-manage-users-of-the-enrollment) for more information.

To access the **Manage users** page, navigate to **Control Panel > Manage user directory > Manage users**.

![Image 1: The Manage users page within Control Panel.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-manageusers.png?width=600)

## Add a new user

1.   Navigate to the **Manage users** page. Review the [access user management documentation](https://www.palantir.com/docs/foundry/authentication/user-directory/#access-user-management).

![Image 2: The Manage users page within Control Panel, ready to add a new user.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-addnewuser.png?width=600)
...
![Image 3: The add new user option.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-addnewusercloseup.png?width=200)![Image 4: Add new user dialog.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-addnewusermodal.png?width=200)

1.   The new user will receive an email to complete their user account registration and configure a passkey. Review the [authentication documentation](https://www.palantir.com/docs/foundry/getting-started/login/#set-up-and-configure-a-passkey) for more information.
...
![Image 5: Manage user directories user details pane.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-userdetails-activeuser.png?width=200)
...
![Image 6: The Manage passkeys dialog with the Delete passkeys panel expanded and one passkey selected for deletion.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-managepasskeysmodal-deletepasskey.png?width=400)
...
![Image 7: The Manage passkeys dialog with all passkeys selected, showing a warning that removing all passkeys will reset the account.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-managepasskeysmodal-deletepasskeysandresetaccount.png?width=400)
...
![Image 8: The Manage passkeys dialog with the Add passkey panel expanded, showing one of four slots remaining.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-managepasskeysmodal-addpasskey.png?width=400)
...
![Image 9: Manage user directories user details pane.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-userdetails-activeuser.png?width=200)

1.   Review the information in the pop-up window and confirm by selecting **Disable**.

![Image 10: Manage user directories disable user dialog.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-disableusermodal.png?width=400)
...
![Image 11: Manage user directories user details pane.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-userdetails-disableduser.png?width=200)

1.   Review the information in the pop-up window and confirm by selecting **Enable**.

![Image 12: Manage user directories enable user dialog.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-enableusermodal.png?width=400)
...
![Image 13: Manage user directories user details pane.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-userdetails-activeuser.png?width=200)

1.   Review the information in the pop-up window and confirm by selecting **Delete**.

![Image 14: Manage user directories delete user dialog.](https://www.palantir.com/docs/resources/foundry/authentication/authentication-userdirectories-deleteusermodal.png?width=400)

## Grant user permission to manage users of the enrollment

To give other users the ability to manage users within your enrollment, you must grant these users either the `enrollment administrator` and/or `authentication administrator` role. For more information on enrollment permissions [review Levels of permissions](https://www.palantir.com/docs/foundry/administration/enrollments-and-organizations-permissions/).

![Image 15: Manage user directories user details pane.](https://www.palantir.com/docs/resources/foundry/authentication/enrollmentperms-authenticationadministrator.png?width=600)
