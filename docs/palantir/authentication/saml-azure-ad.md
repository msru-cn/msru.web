...
# [](https://www.palantir.com/docs/foundry/authentication/saml-azure-ad/#configure-saml-20-integration-for-entra-id-azure-ad)Configure SAML 2.0 integration for Entra ID (Azure AD)

This section contains steps specific to Entra ID (formerly known as Azure AD) for configuring the SAML 2.0 integration as part of the broader [end-to-end authentication via SAML 2.0 tutorial](https://www.palantir.com/docs/foundry/authentication/saml-getting-started/).
...
![Image 9: New application](https://www.palantir.com/docs/resources/foundry/authentication/authentication-azure-new-application.png)

Once created, select the **Getting Started** box for **2. Set up single sign on**.

![Image 10: Single sign on](https://www.palantir.com/docs/resources/foundry/authentication/authentication-azure-new-application-sso.png)
...
## [](https://www.palantir.com/docs/foundry/authentication/saml-azure-ad/#saml-integration-metadata)SAML integration metadata

In Foundry, download the **SAML integration metadata XML**, upload the XML to Azure using **Upload metadata file**, and then **Save**.

![Image 12: SAML integration metadata](https://www.palantir.com/docs/resources/foundry/authentication/authentication-azure-saml-integration-metadata.png)

## [](https://www.palantir.com/docs/foundry/authentication/saml-azure-ad/#attribute-mapping)Attribute mapping
...
![Image 13: Attribute mapping](https://www.palantir.com/docs/resources/foundry/authentication/authentication-azure-attribute-mapping.png)
...
## [](https://www.palantir.com/docs/foundry/authentication/saml-azure-ad/#identity-provider-metadata)Identity provider metadata
...
![Image 14: Identity provider metadata](https://www.palantir.com/docs/resources/foundry/authentication/authentication-azure-idp-metadata.png)

## [](https://www.palantir.com/docs/foundry/authentication/saml-azure-ad/#finishing-and-saving)Finishing and saving

In Foundry, add email domains associated with this SAML 2.0 integration under **Email domains**.

Finish by saving your SAML 2.0 integration and proceed to [multi-factor authentication](https://www.palantir.com/docs/foundry/authentication/multi-factor-auth/).
