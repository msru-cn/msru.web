...
Users with permissions to manage an authentication provider integration (`Organization administrators`, by default) can create, edit, and delete an intake form in [Control Panel](https://www.palantir.com/docs/foundry/authentication/overview/). Navigate to the **Authentication** tab under **Enrollment settings** and select the authentication integration to associate with the intake form.

![Image 1: Manage intake forms from the Authentication tab in Control Panel.](https://www.palantir.com/docs/resources/foundry/authentication/intake-form-overview.png)
...
![Image 2: Screenshot showing intake form configuration management page.](https://www.palantir.com/docs/resources/foundry/authentication/intake-form-editor.png)
...
![Image 3: A preview of a configured intake form.](https://www.palantir.com/docs/resources/foundry/authentication/intake-form-preview.png)
...
If the attributes collected from a user intake form are used by [Organization assignment rules](https://www.palantir.com/docs/foundry/authentication/org-assignment/), the administrator of the Organization to which the user is assigned can approve the relevant intake form entry.
...
![Image 4: The Settings configuration page for user intake forms in Control Panel.](https://www.palantir.com/docs/resources/foundry/authentication/intake-form-settings.png)
...
![Image 5: An example showing how to resubmit a form after submission. ](https://www.palantir.com/docs/resources/foundry/authentication/intake-form-login.gif)

Once a user’s intake form is approved, users will not need to complete the form at their next login. They may be required to eventually complete the form again depending on the form’s recurrence [settings](https://www.palantir.com/docs/foundry/authentication/intake-forms/#settings) configuration.
...
Eligible users can review submitted intake forms by navigating to the [**Approvals** inbox in Control Panel](https://www.palantir.com/docs/foundry/administration/control-panel-approvals/) and filtering on **User intake requests**.

![Image 6: A review intake form in the Approvals inbox in Control Panel.](https://www.palantir.com/docs/resources/foundry/authentication/intake-form-review.png)

Any intake form entries that result in platform access to an [Organization](https://www.palantir.com/docs/foundry/security/orgs-and-spaces/) are automatically approved if submitted by `Organization administrators`.
