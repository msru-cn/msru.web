...
*   All application variables used for [application state](https://www.palantir.com/docs/foundry/chatbot-studio/application-state/) are added as optional inputs. These variables can be used to override default application state values.
...
*   All application variables used for [application state](https://www.palantir.com/docs/foundry/chatbot-studio/application-state/) are added as optional outputs.
...
![Image 1: The publish settings icon.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/agent-studio-publish-settings.png)
...
![Image 2: The 'Publish function from chatbot' toggle.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/chatbot-studio-publish-function-toggle.png?width=500)
...
![Image 3: The extended publish settings dialog.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/chatbot-studio-publish-settings-dialog.png?width=500)
...
Publishing chatbots as Functions allows them to be evaluated with [AIP Evals](https://www.palantir.com/docs/foundry/aip-evals/overview/) evaluation suites. To create an evaluation suite from Chatbot Studio, ensure that your chatbot has been published as a Function, then open the **Evaluation** tab on the left toolbar. Here, you can select **Create evaluation suite**, which will prompt you to name your suite and choose the same Project as the chatbot.

![Image 4: The option to create an evaluation suite in the "Evaluation" tab.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/agent-studio-create-suite.png)
...
![Image 5: The created suite and the arrow icon that can be selected to open the suite in AIP Evals.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/agent-studio-open-suite.png)
...
![Image 6: The option to set the sessionRid to null in an evaluation suite test case.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/agent-studio-sessionrid.png)

*   Object set variables must be set to `null` or contain a real value. Object set variables cannot be empty.

![Image 7: The option to select an object set in an evaluation suite test case.](https://www.palantir.com/docs/resources/foundry/chatbot-studio/agent-studio-object-set.png)

For more information on evaluation suites, refer to the [AIP Evals documentation](https://www.palantir.com/docs/foundry/aip-evals/overview/).
