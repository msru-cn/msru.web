...
![Image 1: Add webhook](https://www.palantir.com/docs/resources/foundry/action-types/webhooks-add-webhook.png?width=400)
...
When configured as a **writeback**, the webhook will be executed _before_ any other rules are evaluated; if the webhook execution fails, no other changes will be made. If you want to ensure that changes are not made in Foundry before the external system, you should set up your webhook as a writeback.
...
![Image 2: Input parameters](https://www.palantir.com/docs/resources/foundry/action-types/webhooks-input-parameters.png?width=400)
...
![Image 3: Input parameters example](https://www.palantir.com/docs/resources/foundry/action-types/webhooks-input-parameters-example.png?width=400)
...
![Image 4: Mapping Action parameters to the parameters required by a Function](https://www.palantir.com/docs/resources/foundry/action-types/webhooks-input-parameters-define-using-action.png?width=400)
...
![Image 5: Using an output parameters in a Logic Rule](https://www.palantir.com/docs/resources/foundry/action-types/webhooks-output-parameters-in-logic-rule.png?width=400)
