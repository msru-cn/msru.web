...
# [](https://www.palantir.com/docs/foundry/action-types/parameters-default-value/#set-parameter-default-value)Set parameter default value
...
## [](https://www.palantir.com/docs/foundry/action-types/parameters-default-value/#default-value-interaction-with-local-variables)Default value interaction with local variables
...
## [](https://www.palantir.com/docs/foundry/action-types/parameters-default-value/#configuring-default-values)Configuring default values
...
### [](https://www.palantir.com/docs/foundry/action-types/parameters-default-value/#static-default-value)Static default value
...
![Image 6: Configuring a static default value](https://www.palantir.com/docs/resources/foundry/action-types/default_value_static_configuration.png)
...
![Image 7: Static default value example](https://www.palantir.com/docs/resources/foundry/action-types/default_value_static_example.png)

### [](https://www.palantir.com/docs/foundry/action-types/parameters-default-value/#object-property-default-values)Object property default values
...
![Image 8: Configuring a property default value](https://www.palantir.com/docs/resources/foundry/action-types/default_value_object_configuration.png)
...
![Image 9: Object default value](https://www.palantir.com/docs/resources/foundry/action-types/default_value_object_example.png)

### [](https://www.palantir.com/docs/foundry/action-types/parameters-default-value/#type-class-prefills)Type class prefills
...
![Image 10: Configuring a type class prefill](https://www.palantir.com/docs/resources/foundry/action-types/default_value_type_class_configuration.png)
...
[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/action-types/parameter-overview/)

[NEXT Filter results of a parameter dropdown →](https://www.palantir.com/docs/foundry/action-types/parameters-filter/)
