...
# [](https://www.palantir.com/docs/foundry/action-types/upload-attachments/#upload-attachments)Upload attachments
...
## [](https://www.palantir.com/docs/foundry/action-types/upload-attachments/#configuring-action-types)Configuring action types
...
To upload several media files at once, select **Allow multiple values**. Note that support for several media files in one action requires an additional toggle during [object type configuration](https://www.palantir.com/docs/foundry/action-types/upload-attachments/#configuring-object-types) to **Allow multiple**, as described below.

## [](https://www.palantir.com/docs/foundry/action-types/upload-attachments/#configuring-object-types)Configuring object types
...
## [](https://www.palantir.com/docs/foundry/action-types/upload-attachments/#architecture-and-limits)Architecture and limits
...
[← PREVIOUS Upload media](https://www.palantir.com/docs/foundry/action-types/upload-media/)

[NEXT Scale and property limits →](https://www.palantir.com/docs/foundry/action-types/scale-property-limits/)
