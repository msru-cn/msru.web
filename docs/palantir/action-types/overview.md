...
[← PREVIOUS Object and link types / Add Ontology types to a Marketplace product](https://www.palantir.com/docs/foundry/object-link-types/marketplace-ontology-types/)

[NEXT Getting started →](https://www.palantir.com/docs/foundry/action-types/getting-started/)
