...
# [](https://www.palantir.com/docs/foundry/action-types/action-reverts/#revert-or-undo-actions)Revert or undo actions
...
## [](https://www.palantir.com/docs/foundry/action-types/action-reverts/#configure-a-revertible-action)Configure a revertible action
...
![Image 4: Screenshot of action reverts in the Form section](https://www.palantir.com/docs/resources/foundry/action-types/action-reverts-form-button.png)
...
## [](https://www.palantir.com/docs/foundry/action-types/action-reverts/#revert-an-action)Revert an action
...
![Image 5: Toast notification stating: "Edits successfully reverted".](https://www.palantir.com/docs/resources/foundry/action-types/action-reverts-revert-action.png)

Edits reverted:

![Image 6: Toast notification stating: "Edits successfully applied".](https://www.palantir.com/docs/resources/foundry/action-types/action-reverts-edits-reverted.png)

## [](https://www.palantir.com/docs/foundry/action-types/action-reverts/#caveats)Caveats
...
### [](https://www.palantir.com/docs/foundry/action-types/action-reverts/#undoing-a-delete-action-without-the-revert-action-toast)Undoing a delete action without the revert action toast
...
[← PREVIOUS Monitoring](https://www.palantir.com/docs/foundry/action-types/monitoring/)

[NEXT Branching action types →](https://www.palantir.com/docs/foundry/action-types/branching-action-types/)
