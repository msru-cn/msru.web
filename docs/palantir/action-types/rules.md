...
### [](https://www.palantir.com/docs/foundry/action-types/rules/#values-and-parameters)Values and parameters
...
### [](https://www.palantir.com/docs/foundry/action-types/rules/#creating-an-object--many-to-many-link)Creating an object & many-to-many link
...
### [](https://www.palantir.com/docs/foundry/action-types/rules/#invalid-combinations)Invalid combinations
...
## [](https://www.palantir.com/docs/foundry/action-types/rules/#other-rules)Other rules
...
[← PREVIOUS Use actions in the platform](https://www.palantir.com/docs/foundry/action-types/use-actions/)

[NEXT Parameters / Overview →](https://www.palantir.com/docs/foundry/action-types/parameter-overview/)
