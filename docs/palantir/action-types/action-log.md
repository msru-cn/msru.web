...
## [](https://www.palantir.com/docs/foundry/action-types/action-log/#action-log-on-function-backed-action-types)Action log on function-backed action types
...
## [](https://www.palantir.com/docs/foundry/action-types/action-log/#action-log-timeline)Action log timeline
...
[← PREVIOUS Action metrics](https://www.palantir.com/docs/foundry/action-types/action-metrics/)

[NEXT Add action types to a Marketplace product →](https://www.palantir.com/docs/foundry/action-types/marketplace-action-types/)
