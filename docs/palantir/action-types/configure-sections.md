...
URL Source: https://www.palantir.com/docs/foundry/action-types/configure-sections/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/action-types/configure-sections/#configure-sections)Configure sections
...
![Image 3: form overview](https://www.palantir.com/docs/resources/foundry/action-types/form-overview.png?width=500)
## [](https://www.palantir.com/docs/foundry/action-types/configure-sections/#adding-a-section-to-an-action-form)Adding a section to an action form
...
![Image 4: section inside a form](https://www.palantir.com/docs/resources/foundry/action-types/section-config.png?width=500)
...
## [](https://www.palantir.com/docs/foundry/action-types/configure-sections/#adding-parameters-to-a-section)Adding parameters to a section
...
[← PREVIOUS Trigger schedule build](https://www.palantir.com/docs/foundry/action-types/trigger-schedule-build/)

[NEXT Upload media →](https://www.palantir.com/docs/foundry/action-types/upload-media/)
