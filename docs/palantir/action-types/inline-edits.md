...
### [](https://www.palantir.com/docs/foundry/action-types/inline-edits/#configuration)Configuration

![Image 2: Inline edit action configuration](https://www.palantir.com/docs/resources/foundry/action-types/inline-action-configuration.png)
...
#### [](https://www.palantir.com/docs/foundry/action-types/inline-edits/#action-type-requirements-for-inline-edits)Action type requirements for inline edits
...
### [](https://www.palantir.com/docs/foundry/action-types/inline-edits/#background)Background
...
### [](https://www.palantir.com/docs/foundry/action-types/inline-edits/#valid-inline-actions)Valid inline Actions
...
### [](https://www.palantir.com/docs/foundry/action-types/inline-edits/#invalid-inline-actions)Invalid inline Actions
...
#### [](https://www.palantir.com/docs/foundry/action-types/inline-edits/#example-invalid-inline-actions)Example: Invalid inline Actions
...
[← PREVIOUS Scale and property limits](https://www.palantir.com/docs/foundry/action-types/scale-property-limits/)

[NEXT Permissions →](https://www.palantir.com/docs/foundry/action-types/permissions/)
