...
![Image 2: Screenshot of action metrics in the overview section.](https://www.palantir.com/docs/resources/foundry/action-types/action-metrics-failures.png)
...
## [](https://www.palantir.com/docs/foundry/action-types/action-metrics/#action-failure-types)Action failure types
...
## [](https://www.palantir.com/docs/foundry/action-types/action-metrics/#permissions)Permissions

To view action metrics, you must be a `viewer` on the action.

[← PREVIOUS Branching action types](https://www.palantir.com/docs/foundry/action-types/branching-action-types/)

[NEXT Action log →](https://www.palantir.com/docs/foundry/action-types/action-log/)
