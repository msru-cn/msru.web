...
*   For real-time processes, you may need to _notify_ users about changes that are happening in the system so they can take action in response.
*   In cases when a system besides Foundry is the source of truth for your organization, you may need to _integrate_ with the other system to support the existing business process. This pattern is sometimes referred to as "decision orchestration."
...
*   [Set up notifications](https://www.palantir.com/docs/foundry/action-types/set-up-notification/)
*   [Set up a webhook](https://www.palantir.com/docs/foundry/action-types/set-up-webhook/)

[← PREVIOUS Function-backed actions / Batched execution](https://www.palantir.com/docs/foundry/action-types/function-actions-batched-execution/)

[NEXT Notifications →](https://www.palantir.com/docs/foundry/action-types/notifications/)
