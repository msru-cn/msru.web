...
![Image 1: Dropdown menu for Add new rule](https://www.palantir.com/docs/resources/foundry/action-types/side_effects_notification_tutorial_edit_action_rules.png?width=500)

Configuring a notification requires specification of [recipients](https://www.palantir.com/docs/foundry/action-types/notifications/#recipients) and [content](https://www.palantir.com/docs/foundry/action-types/notifications/#content). The following sections provide more detail on these options.
...
![Image 2: Recipients Dropdown](https://www.palantir.com/docs/resources/foundry/action-types/side_effects_recipients_selector.png?width=400)
...
There are a number of options for customizing the content of notifications. Content may be configured via _Template_ or provided via a custom _function_. Selecting template content will allow you to configure the full content directly in the configuration dialog. Function content will require you to have a published function, which returns the appropriate notification type.

![Image 3: Content Type Dropdown](https://www.palantir.com/docs/resources/foundry/action-types/side_effects_content_selection_dropdown.png)
...
![Image 4: Example notification Configuration Labelled](https://www.palantir.com/docs/resources/foundry/action-types/side_effects_numbered_example_configuration.png?width=400)
...
![Image 5: Function-rendered Content max-recipients warning](https://www.palantir.com/docs/resources/foundry/action-types/side_effects_function_content_max_recipients.png)
...
![Image 6: Strict redaction email content default](https://www.palantir.com/docs/resources/foundry/action-types/side_effects_redacted_email_content.png)
...
![Image 7: Notifications settings with disable notification redaction option.](https://www.palantir.com/docs/resources/foundry/action-types/notification_settings.png)
