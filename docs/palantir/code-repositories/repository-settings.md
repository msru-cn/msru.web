...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/repository-settings/

Published Time: Thu, 09 Jul 2026 17:47:53 GMT

# [](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#repository-settings)Repository settings
...
*   [Repository settings](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#repository-settings)
    *   [Commit message settings](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#commit-message-settings)
    *   [Repository upgrades](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#repository-upgrades)
    *   [Dataset aliases](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#dataset-aliases)
    *   [External systems](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#external-systems)

## [](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#commit-message-settings)Commit message settings
...
## [](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#repository-upgrades)Repository upgrades

See [repository upgrades](https://www.palantir.com/docs/foundry/code-repositories/repository-upgrades/) to learn more.

## [](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/#dataset-aliases)Dataset aliases
