...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/aip-features/

Published Time: Thu, 09 Jul 2026 17:47:52 GMT

# [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#aip-features-in-code-repositories)AIP features in Code Repositories

The following is a list of AIP-powered features in Code Repositories.

## [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#aip-assist)AIP Assist
...
### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#code-explanation)Code explanation

You can now use AIP in Code Repositories to explain the purpose of code snippets or entire files.

![Image 7: Animated screenshots showing Code Explanation in action in Code Repositories](https://www.palantir.com/docs/resources/foundry/code-repositories/code-explanation.gif)

### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#find-bugs)Find bugs

Use AIP in Code Repositories to check and debug your code.

![Image 8: Animated screenshots showing Find bugs in action in Code Repositories](https://www.palantir.com/docs/resources/foundry/code-repositories/code-find-bugs.gif)

### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#translate)Translate

AIP in Code Repositories can convert your code to various languages such as Python, SQL, Mesa, or Java.

![Image 9: Animated screenshots showing Translate in action in Code Repositories](https://www.palantir.com/docs/resources/foundry/code-repositories/code-translation.gif)

### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#context-aware-attachments)Context-aware attachments
...
### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#inline-code-assistance-beta)Inline code assistance [Beta]

Beta

Inline code assistance is in the [beta](https://www.palantir.com/docs/foundry/platform-overview/development-life-cycle/) phase of development and may not be available on your enrollment. Functionality may change during active development.
...
## [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#ai-error-enhancer)AI error enhancer
...
### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#code-repositories)Code Repositories

In Code Repositories, the feature is shown in the **Checks** and **Preview** section.

![Image 10: Animated screenshot showing AI error enhancer in action in Code Repositories](https://www.palantir.com/docs/resources/foundry/code-repositories/error-enhancer-in-authoring.gif)

### [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#builds)Builds

In Builds, this feature is found in the **Job status menu**.

![Image 11: Animated screenshot showing AI error enhancer in Job tracker](https://www.palantir.com/docs/resources/foundry/code-repositories/error-enhancer-in-job-tracker.gif)

## [](https://www.palantir.com/docs/foundry/code-repositories/aip-features/#code-autocomplete)Code autocomplete
...
![Image 12: Code completion](https://www.palantir.com/docs/resources/foundry/code-repositories/code-completion.gif)

* * *

Note: AIP feature availability is subject to change and may differ between customers.

[← PREVIOUS Documentation](https://www.palantir.com/docs/foundry/code-repositories/readme/)

[NEXT Add dataset transformation to a Marketplace product →](https://www.palantir.com/docs/foundry/code-repositories/marketplace-dataset-transformation/)
