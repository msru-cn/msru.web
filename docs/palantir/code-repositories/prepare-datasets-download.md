...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/#prepare-datasets-for-download)Prepare datasets for download

The following export process is an advanced workflow and should only be performed if you are unable to download data directly from the Foundry interface using the **Actions** menu or [export data from another Foundry application](https://www.palantir.com/docs/foundry/analytics/exporting-outputs/#data-export).

This guide explains how to prepare a CSV for download using transforms in [Code Repositories](https://www.palantir.com/docs/foundry/code-repositories/overview/) or [Pipeline Builder](https://www.palantir.com/docs/foundry/pipeline-builder/overview/).

## [](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/#prepare-data)Prepare data
...
## [](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/#reduce-to-one-partition-and-set-output-format)Reduce to one partition and set output format
...
### [](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/#pipeline-builder)Pipeline Builder

First, use the **Repartition data** transform to reduce your data to one partition.

![Image 4: Repartition data to one partition in Pipeline Builder](https://www.palantir.com/docs/resources/foundry/code-repositories/pipeline-builder-repartition.png)

Then, in the pipeline output configuration, configure the write format to CSV (or any other supported format).

![Image 5: Set output format to CSV in Pipeline Builder](https://www.palantir.com/docs/resources/foundry/code-repositories/pipeline-builder-csv-write-format.png)

### [](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/#python)Python
...
7     output.write_dataframe(my_input.dataframe().repartition(1), output_format="csv", options={"header": "true"})
```

### [](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/#sql)SQL
...
![Image 6: CSV available for download](https://www.palantir.com/docs/resources/foundry/code-repositories/csv_download.png)

[← PREVIOUS Create custom checks](https://www.palantir.com/docs/foundry/code-repositories/create-custom-checks/)

[NEXT Administer repositories / Overview →](https://www.palantir.com/docs/foundry/code-repositories/admin-overview/)
