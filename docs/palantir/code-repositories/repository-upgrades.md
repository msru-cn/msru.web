...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/repository-upgrades/

Published Time: Thu, 09 Jul 2026 17:47:53 GMT

# [](https://www.palantir.com/docs/foundry/code-repositories/repository-upgrades/#repository-upgrades)Repository upgrades
...
## [](https://www.palantir.com/docs/foundry/code-repositories/repository-upgrades/#automatic-upgrades)Automatic upgrades
...
*   The upgrade PR overwrites any files that contain user-authored changes (see [file overwrites](https://www.palantir.com/docs/foundry/code-repositories/repository-upgrades/#file-overwrites)).
*   Some datasets directly affected by this pull request have not been built with the latest version of the code (see [impact analysis](https://www.palantir.com/docs/foundry/code-repositories/analyze-impact/)).
*   Jobs produced by this repository have not yet been built with the runtime Spark module version introduced in the upgrade pull request (see [impact analysis](https://www.palantir.com/docs/foundry/code-repositories/analyze-impact/)).
*   The template version the repository is currently on is too old to support automatic upgrades.

## [](https://www.palantir.com/docs/foundry/code-repositories/repository-upgrades/#file-overwrites)File overwrites
...
![Image 2: upgrade-branch](https://www.palantir.com/docs/resources/foundry/code-repositories/upgrade-branch.png)
...
[← PREVIOUS Repository settings](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/)

[NEXT Spark profiles →](https://www.palantir.com/docs/foundry/code-repositories/spark-profiles/)
