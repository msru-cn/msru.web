...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/manage-permissions/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-repositories/manage-permissions/#manage-permissions)Manage permissions
...
It is not possible to [delete an Artifact](https://www.palantir.com/docs/foundry/code-repositories/recall-artifact/#delete).

Learn more about [permissions and Project access](https://www.palantir.com/docs/foundry/security/checking-permissions/).

[← PREVIOUS Recall an Artifact](https://www.palantir.com/docs/foundry/code-repositories/recall-artifact/)

[NEXT Advanced workflows / Create custom checks →](https://www.palantir.com/docs/foundry/code-repositories/create-custom-checks/)
