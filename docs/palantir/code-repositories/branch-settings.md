...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/branch-settings/

Published Time: Thu, 09 Jul 2026 17:47:52 GMT

# [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#branch-settings)Branch settings

This page will walk you through the various branch settings in Code Repositories:

*   [Setting the default branch](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#default-branch)
*   [Selecting pull-request merge modes](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#merge-modes)
*   [Protecting branches](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#protected-branches)
*   [Configuring branch fallbacks](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#fallback-branches)

## [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#default-branch)Default branch
...
## [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#merge-modes)Merge modes
...
## [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#protected-branches)Protected branches
...
*   [Require ci/foundry-publish to run successfully](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-cifoundry-publish-to-run-successfully)
*   [Require code reviews](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-code-reviews)
*   [Require specific reviewers](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-specific-reviewers)
*   [Require security approval](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-security-approval)
*   [Restrict stable version tags (Functions repositories only)](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#restrict-stable-version-tags)

### [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-cifoundry-publish-to-run-successfully)Require ci/foundry-publish to run successfully
...
### [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-code-reviews)Require code reviews
...
### [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-specific-reviewers)Require specific reviewers
...
### [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#configure-advanced-approval-policies)Configure advanced approval policies
...
![Image 3: The advanced approval policy editor.](https://www.palantir.com/docs/resources/foundry/code-repositories/advanced-approval-policy-editor.png)
...
### [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#require-security-approval)Require security approval

To stop propagating [security Markings](https://www.palantir.com/docs/foundry/security/markings/) on a branch, the branch must be protected. Once security changes are enabled on a repository, it will automatically and immutably require security checks and approval (if necessary) before merging a pull request. Read more about [removing inherited Markings](https://www.palantir.com/docs/foundry/building-pipelines/remove-inherited-markings/).

### [](https://www.palantir.com/docs/foundry/code-repositories/branch-settings/#restrict-stable-version-tags)Restrict stable version tags
...
![Image 4: Only allow stable versions to be tagged from protected branches](https://www.palantir.com/docs/resources/foundry/code-repositories/protect-tagging-stable-versions.png?width=400)
...
Applications that invoke your Functions may be configured to reference a _version range_; for example, a Workshop module might call a Function `foo` at versions `>=1.2.3 <2.0.0`, so if you release version `1.3.0`, the Workshop module will now invoke this version (`1.3.0`).
...
You can also configure a [Pipeline Builder](https://www.palantir.com/docs/foundry/pipeline-builder/branches-overview/) branch with the same name as a Code Repositories branch so that Pipeline Builder transforms read input datasets from that matching branch. Pipeline Builder supports [fallback branch configuration](https://www.palantir.com/docs/foundry/pipeline-builder/branches-fallback-branches/) as well, allowing you to control which branch is used when an input dataset has not been built on the current branch.

[← PREVIOUS Overview](https://www.palantir.com/docs/foundry/code-repositories/admin-overview/)

[NEXT Repository settings →](https://www.palantir.com/docs/foundry/code-repositories/repository-settings/)
