...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#debug-transforms)Debug transforms
...
![Image 13: Debugger overview panel](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-overview.png)

The debugger is only available for [Python](https://www.palantir.com/docs/foundry/transforms-python/debugging/).

## [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#setting-breakpoints)Setting breakpoints

To use the debugger, you need to set _breakpoints_. Breakpoints signal to the debugger the points where it should pause the execution of the code and allow you to interact with variables and dataframes.
...
![Image 14: debugger breakpoints](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-breakpoint.png)

## [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#running-the-debugger)Running the debugger
...
![Image 15: debugger layout](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-layout.png)
...
![Image 16: debugger internal libraries](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-internal-libraries-enable.png)
...
![Image 17: debugger controls](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-controls.png)
...
## [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#previewing-dataframes)Previewing dataframes
...
![Image 18: debugger preview dataframe](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-preview-df.png)

Selecting **Preview** will open a debugger preview panel for the selected dataframe:

![Image 19: debugger preview dataframe result](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-preview-df-result.png)

To return to the debugger, select **Back to debugger**:

![Image 20: debugger return](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-return.png)

## [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#examining-variables)Examining variables

While the debugger is running you can examine the variables and data at the exact point of code execution.

### [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#frames)Frames
...
### [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#variables)Variables

The _variables_ section shows the values stored in both local and global variables while the transform is executed.
...
![Image 21: debugger variables](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-variables.png)

### [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#console)Console
...
![Image 22: debugger console](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-console.png)

## [](https://www.palantir.com/docs/foundry/code-repositories/debug-transforms/#configuring-the-debugger)Configuring the debugger
...
![Image 23: Debugger functionality cog](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-configuration-1.png)

You can also configure the debugger in the **Settings** tab under **Preferences**>**Debugger**.

![Image 24: Debugger configuration in Settings](https://www.palantir.com/docs/resources/foundry/code-repositories/debugger-configuration-2.png)

[← PREVIOUS Preview transforms](https://www.palantir.com/docs/foundry/code-repositories/preview-transforms/)

[NEXT Use project references →](https://www.palantir.com/docs/foundry/code-repositories/use-project-references/)
