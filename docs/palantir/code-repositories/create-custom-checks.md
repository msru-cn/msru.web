...
URL Source: https://www.palantir.com/docs/foundry/code-repositories/create-custom-checks/

Markdown Content:

# [](https://www.palantir.com/docs/foundry/code-repositories/create-custom-checks/#create-custom-checks)Create custom checks
...
[← PREVIOUS Artifact repositories / Manage permissions](https://www.palantir.com/docs/foundry/code-repositories/manage-permissions/)

[NEXT Prepare datasets for download →](https://www.palantir.com/docs/foundry/code-repositories/prepare-datasets-download/)
