...
URL Source: https://www.palantir.com/docs/foundry/ontology-manager/save-changes/

Published Time: Thu, 09 Jul 2026 17:47:57 GMT

# [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#save-changes-to-the-ontology)Save changes to the Ontology

## [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#save-your-changes)Save your changes
...
![Image 11: Save button](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-button-header.png?width=400)
1.   Open the **Review edits** dialog to review all your changes.
2.   Finally, select **Save** to update the Ontology.

![Image 12: Save button in review dialog](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-button-review.png?width=600)
## [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#handle-errors-and-warnings)Handle errors and warnings
...
![Image 13: Review errors](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-error.png?width=600)
If you receive an error, you can use the open shortcut to navigate to a resource you need to edit before saving.

![Image 14: Navigate to a resource to edit](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-error-navigate.png?width=600)
...
## [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#handle-updates-and-merge-conflicts)Handle updates and merge conflicts
...
![Image 15: Update Ontology with other edits](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-update-merge.png?width=600)
...
![Image 16: Merge conflict in Ontology edits](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-merge-conflict.png?width=600)
## [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#discard-your-changes)Discard your changes
...
![Image 17: Discard edits](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-discard.png?width=600)
...
![Image 18: Discard all edits](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-discard-all.png?width=600)
## [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#respond-to-a-warning-message)Respond to a warning message
...
For a full description of which changes can be destructive, read more about [potential breaking changes](https://www.palantir.com/docs/foundry/object-link-types/edit-object-type/).
...
![Image 19: Warning message for edits](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-review-edits-warning.png?width=600)
## [](https://www.palantir.com/docs/foundry/ontology-manager/save-changes/#troubleshooting-when-a-save-fails)Troubleshooting when a save fails
...
![Image 20: Error message](https://www.palantir.com/docs/resources/foundry/ontology-manager/save-error-message.png?width=500)
...
[← PREVIOUS Ontology roles migration [Legacy]](https://www.palantir.com/docs/foundry/ontology-manager/ontology-roles-migration/)

[NEXT Review and restore changes →](https://www.palantir.com/docs/foundry/ontology-manager/restore-changes/)
