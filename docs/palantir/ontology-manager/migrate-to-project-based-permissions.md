...
URL Source: https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/

Published Time: Thu, 09 Jul 2026 17:47:57 GMT

# [](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/#migrate-to-project-based-permissions)Migrate to project-based permissions

Ontology resources, including object types, action types, link types, interfaces, and shared properties, can be saved within specific projects and automatically inherit permissions from those projects. Object and link instance permissions remain dependent on the backing datasource location. Once migrated permissions to view, edit, and manage ontology resources are managed through [Compass](https://www.palantir.com/docs/foundry/compass/overview/), the Palantir platform's filesystem. [Project-based permissions](https://www.palantir.com/docs/foundry/object-permissioning/ontology-permissions/) replaces the previous ontology roles and datasource-derived permissions models. This is the same permission model used for all other resource types.

You can migrate your existing ontology resources to [project-based permissions](https://www.palantir.com/docs/foundry/object-permissioning/ontology-permissions/) using our migration tool. This tool suggests the placement of ontology resources into appropriate projects while ensuring they receive the correct permissions.
...
## [](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/#limitations)Limitations
...
## [](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/#approaches-to-migration)Approaches to migration
...
### [](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/#how-migration-changes-marketplace-installs)How migration changes Marketplace installs
...
![Image 9: A Marketplace install places ontology resources in the Ontology service project on the target environment, while non-ontology files are placed in the target project.](https://www.palantir.com/docs/resources/foundry/ontology-manager/marketplace-setup-prior-to-ontology-in-projects-migration.png)
...
![Image 10: A Marketplace install places ontology resources in the chosen target project after migration.](https://www.palantir.com/docs/resources/foundry/ontology-manager/marketplace-setup-after-migration-to-ontology-in-projects.png)
...
![Image 11: A Marketplace product split into two linked products so that ontology resources and non-ontology files can install into projects with different visibility.](https://www.palantir.com/docs/resources/foundry/ontology-manager/splitting-marketplace-product-into-two-products.png)

## [](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/#use-the-migration-assistant-recommended)Use the migration assistant (recommended)
...
![Image 12: Navigate to the Ontology configuration page, then use the "Proceed to migration" option.](https://www.palantir.com/docs/resources/foundry/ontology-manager/proceed-to-migration.png)
...
![Image 13: The migration assistant preselects strong recommendations for your review.](https://www.palantir.com/docs/resources/foundry/ontology-manager/migration-assistant-recommendations.png)
...
![Image 14: Manually select locations to migrate individual resources.](https://www.palantir.com/docs/resources/foundry/ontology-manager/migration-assistant-individual-resources.png)

## [](https://www.palantir.com/docs/foundry/ontology-manager/migrate-to-project-based-permissions/#migrate-resources-directly)Migrate resources directly
...
![Image 15: Migrate resources in bulk by selecting the resources and then using the option in the dropdown menu.](https://www.palantir.com/docs/resources/foundry/ontology-manager/project-based-perm-bulk-res-migration.png)
...
![Image 16: Migrate an individual resource using the dropdown menu.](https://www.palantir.com/docs/resources/foundry/ontology-manager/project-based-perm-individual-res-migration.png)

[← PREVIOUS Viewing usage](https://www.palantir.com/docs/foundry/ontology-manager/view-usage/)

[NEXT Ontology roles migration [Legacy] →](https://www.palantir.com/docs/foundry/ontology-manager/ontology-roles-migration/)
