    ...
    <div className="flex flex-col w-full min-h-screen">
      <section className="relative pt-32 pb-16 bg-zinc-950">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tighter">隐私策略</h1>
            <p className="text-zinc-400">最后更新：2026 年 1 月 1 日 · 生效日期：2026 年 1 月 15 日</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-zinc-950">
        <div className="container mx-auto px-6 max-w-3xl prose dark:prose-invert prose-zinc prose-headings:tracking-tight">
          ...
          <h2>3. 数据使用目的</h2>
          <p>
            我们将收集的数据用于：提供和维护服务、改善用户体验、安全防护、法律合规义务、以及经您明确同意的营销通信。
          </p>
