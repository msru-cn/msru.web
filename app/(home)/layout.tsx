...
type MegaMenuProps = {
  ...
  image?: string;
  className?: string; // 控制 Grid 布局排版
};

// ==========================================
// 1. 产品与工程技术 (Product, Engineering & Tech)
// ==========================================
const productsMegaMenu: MegaMenuProps[] = [
  {
    href: "/products",
    title: "探索产品与技术架构",
...
// ==========================================
const solutionsMegaMenu: MegaMenuProps[] = [
  {
    href: "/solutions",
    title: "行业解决方案",
...
// ==========================================
const ecosystemMegaMenu: MegaMenuProps[] = [
  {
    href: "/services",
    title: "生态与客户成功",
...
// ==========================================
const trustMegaMenu: MegaMenuProps[] = [
  {
    href: "/trust",
    title: "企业级信任中心",
...
// ==========================================
const companyMegaMenu: MegaMenuProps[] = [
  {
    href: "/company",
    title: "公司与企业治理",
...
// 6. 文档中心 (Docs)
// ==========================================
const docsMegaMenu: MegaMenuProps[] = [
  {
    href: "/docs",
    title: "文档中心",
...
// 巨型菜单渲染组件 (保持您的原逻辑结构，因为您原本针对图片的 CSS 已经写得非常完美)
function NavMegaMenu({ title, items }: { title: string; items: MegaMenuProps[] }) {
  return (
    <NavbarMenu>
